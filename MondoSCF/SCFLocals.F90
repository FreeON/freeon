...
!  Thresholds (Loose,Good,Tight,VeryTight):
   ...
   REAL(DOUBLE),DIMENSION(4) :: TrixNeglect=(/1.D-4, 5.D-5, 1.D-5, 5.D-6 /)
   REAL(DOUBLE),DIMENSION(4) :: TwoENeglect=(/1.D-5, 1.D-6, 1.D-7, 1.D-8/)
   REAL(DOUBLE),DIMENSION(4) :: DistNeglect=(/1.D-7, 1.D-8, 1.D-9, 1.D-10/)
   REAL(DOUBLE),DIMENSION(4) :: ETol       =(/1.D-7, 1.D-8, 1.D-9, 1.D-10/)
   REAL(DOUBLE),DIMENSION(4) :: DTol       =(/1.D-4, 1.D-5, 1.D-6, 1.D-7/)


!   REAL(DOUBLE),DIMENSION(4) :: TrixNeglect=(/1.D-10, 1.D-10, 1.D-10, 1.D-10/)
!   REAL(DOUBLE),DIMENSION(4) :: TwoENeglect=(/1.D-14, 1.D-14, 1.D-14, 1.D-14/)
!   REAL(DOUBLE),DIMENSION(4) :: DistNeglect=(/1.D-16, 1.D-16, 1.D-16, 1.D-16/)
