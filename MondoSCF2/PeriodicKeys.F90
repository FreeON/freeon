...
!
   ...
   CHARACTER(LEN=3),  PARAMETER :: PBCWRAP      ='PBC'
!
...
!
   CHARACTER(LEN=1),  PARAMETER :: PBC_TRUE     ='T'
   CHARACTER(LEN=1),  PARAMETER :: PBC_FALSE    ='F'
!
...
!
   ...
   CHARACTER(LEN=11), PARAMETER :: PFFOVRDE     ='PFFOverRide'
!
