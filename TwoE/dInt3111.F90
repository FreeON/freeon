...
! ---------------------------------------------------------- 
   SUBROUTINE dInt3111(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      dI(OffSet,CrtSet4)=Ib5Bar1+V(2)
      dI(OffSet,CrtSet7)=Ic2Bar2
      W1=I1Bar1-Ia5Bar1
      W2=-Ib5Bar1-Ic2Bar2-V(2)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia6Bar1
      dI(OffSet,CrtSet5)=Ib6Bar1+V(3)
      dI(OffSet,CrtSet8)=Ic2Bar3
      dI(OffSet,CrtSet11)=-Ic2Bar3-V(3)+V(4)+V(5)
      dI(OffSet,CrtSet3)=Ia8Bar1
      dI(OffSet,CrtSet6)=Ib8Bar1+V(6)
      dI(OffSet,CrtSet9)=Ic2Bar4
      dI(OffSet,CrtSet12)=-Ic2Bar4-V(6)+V(7)+V(8)
      OffSet=(OA+1)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia6Bar1
      dI(OffSet,CrtSet4)=Ib6Bar1+V(9)
      dI(OffSet,CrtSet7)=Ic3Bar2
      dI(OffSet,CrtSet10)=-Ic3Bar2+V(4)+V(5)-V(9)
      dI(OffSet,CrtSet2)=Ia7Bar1+V(1)
      dI(OffSet,CrtSet5)=Ib7Bar1+V(10)
      dI(OffSet,CrtSet8)=Ic3Bar3
      W1=I1Bar1-Ia7Bar1
      W2=-Ib7Bar1-Ic3Bar3-V(10)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia9Bar1
      dI(OffSet,CrtSet6)=Ib9Bar1+V(11)
      dI(OffSet,CrtSet9)=Ic3Bar4
      dI(OffSet,CrtSet12)=-Ic3Bar4-V(11)+V(12)+V(13)
      OffSet=(OA+2)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia8Bar1
      dI(OffSet,CrtSet4)=Ib8Bar1+V(14)
      dI(OffSet,CrtSet7)=Ic4Bar2
      dI(OffSet,CrtSet10)=-Ic4Bar2+V(7)+V(8)-V(14)
      dI(OffSet,CrtSet2)=Ia9Bar1
      dI(OffSet,CrtSet5)=Ib9Bar1+V(15)
      dI(OffSet,CrtSet8)=Ic4Bar3
      dI(OffSet,CrtSet11)=-Ic4Bar3+V(12)+V(13)-V(15)
      dI(OffSet,CrtSet3)=Ia10Bar1+V(1)
      dI(OffSet,CrtSet6)=Ib10Bar1+V(16)
      dI(OffSet,CrtSet9)=Ic4Bar4
      W1=I1Bar1-Ia10Bar1
      W2=-Ib10Bar1-Ic4Bar4-V(16)
