...
!------------------------------------------------------------------------------
! ----------------------------------------------------------
! COMPUTES THE INTEGRAL CLASS (f f|f s)
! ----------------------------------------------------------
   SUBROUTINE IntB10101001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! No need to generate (f,0|f,s)^(0)
      ! Generating (f,f|f,s)^(0)
      DO L=1,1
         DO K=11,20
