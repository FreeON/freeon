...
! ----------------------------------------------------------
   SUBROUTINE IntB10021002(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT102102(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|f,sp)^(0)
      CALL KetHRR102(45,HRR)
      ! Generating (f,sp|f,sp)^(0)
      DO L=1,4
         DO K=11,20
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10021002
    SUBROUTINE CNTRCT102102(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,35,0:8)
      REAL(DOUBLE)  :: HRR(45,45,4)
