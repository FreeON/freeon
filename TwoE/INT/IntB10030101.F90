...
! ---------------------------------------------------------- 
   SUBROUTINE IntB10030101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCT10311(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|s,s)^(0) 
      CALL KetHRR11(35,HRR) 
      ! Generating (f,p|s,s)^(0) 
      DO L=1,1
         DO K=1,1
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB10030101
    SUBROUTINE CNTRCT10311(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,1,0:4)
      REAL(DOUBLE)  :: HRR(35,1,1)
