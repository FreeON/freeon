! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f d|f s) 
! ---------------------------------------------------------- 
   SUBROUTINE IntB10061001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      REAL(DOUBLE)  :: VRR(56,20,0:8)
      REAL(DOUBLE)  :: HRR(56,20,1)
      INTEGER       :: OffSet,OA,LDA,OB,LDB,OC,LDC,OD,LDD,I,J,K,L
      EXTERNAL InitDbl
      CALL InitDbl(56*20,HRR(1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Generating (f0|s0)^(5)
            CALL VRRf0s0(56,20,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|s0)^(4)
            ...
            ! Generating (g0|s0)^(4)
            CALL VRRg0s0(56,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|s0)^(3)
            ...
            ! Generating (h0|s0)^(3)
            CALL VRRh0s0(56,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|s0)^(2)
            ...
            ! Generating (d0|p0)^(5)
            CALL VRRd0p0(56,20,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|p0)^(4)
            ...
            ! Generating (f0|p0)^(4)
            CALL VRRf0p0(56,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|p0)^(3)
            ...
            ! Generating (g0|p0)^(3)
            CALL VRRg0p0(56,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|p0)^(2)
            ...
            ! Generating (h0|p0)^(2)
            CALL VRRh0p0(56,20,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|p0)^(1)
            CALL VRRh0p0(56,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|p0)^(0)
            CALL VRRh0p0(56,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|d0)^(6)
            CALL VRRs0d0(56,20,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|d0)^(5)
            CALL VRRs0d0(56,20,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|d0)^(4)
            CALL VRRs0d0(56,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|d0)^(3)
            CALL VRRs0d0(56,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|d0)^(2)
            CALL VRRs0d0(56,20,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|d0)^(1)
            CALL VRRs0d0(56,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|d0)^(0)
            CALL VRRs0d0(56,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|d0)^(5)
            CALL VRRp0d0(56,20,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|d0)^(4)
            ...
            ! Generating (d0|d0)^(4)
            CALL VRRd0d0(56,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|d0)^(3)
            ...
            ! Generating (f0|d0)^(3)
            CALL VRRf0d0(56,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|d0)^(2)
            ...
            ! Generating (g0|d0)^(2)
            CALL VRRg0d0(56,20,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|d0)^(1)
            CALL VRRg0d0(56,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|d0)^(0)
            CALL VRRg0d0(56,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|d0)^(1)
            CALL VRRh0d0(56,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|d0)^(0)
            CALL VRRh0d0(56,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|f0)^(5)
            CALL VRRs0f0(56,20,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|f0)^(4)
            ...
            ! Generating (p0|f0)^(4)
            CALL VRRp0f0(56,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|f0)^(3)
            ...
            ! Generating (d0|f0)^(3)
            CALL VRRd0f0(56,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|f0)^(2)
            ...
            ! Generating (f0|f0)^(2)
            CALL VRRf0f0(56,20,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|f0)^(1)
            CALL VRRf0f0(56,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|f0)^(0)
            CALL VRRf0f0(56,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|f0)^(1)
            CALL VRRg0f0(56,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|f0)^(0)
            CALL VRRg0f0(56,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|f0)^(0)
            CALL VRRh0f0(56,20,VRR(1,1,0),VRR(1,1,1))
            ! Contracting ... 
            CALL DBLAXPY(1120,HRR(1,1,1),VRR(1,1,0)) 
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|f,s)^(0) 
      CALL KetHRR101(56,HRR) 
      ! Generating (f,d|f,s)^(0) 
      DO L=1,1
         DO K=11,20
