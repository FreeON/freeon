...
! ----------------------------------------------------------
   SUBROUTINE IntB3020202(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT3222(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (p,0|sp,sp)^(0)
      CALL KetHRR22(13,HRR)
      ! Generating (p,sp|sp,sp)^(0)
      DO L=1,4
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB3020202
    SUBROUTINE CNTRCT3222(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(10,10,0:4)
      REAL(DOUBLE)  :: HRR(13,18,4)
      ...
      HRR(11,11,1)=HRR(11,11,1)+FnSpB*SpSpK*VRR(2,1,0)
      HRR(11,15,1)=HRR(11,15,1)+FnSpB*SpFnK*VRR(2,1,0)
      ...
      HRR(11,12,1)=HRR(11,12,1)+FnSpB*FnSpK*VRR(2,2,0)
      HRR(11,16,1)=HRR(11,16,1)+FnSpB*SpFnK*VRR(2,2,0)
      ...
      HRR(11,13,1)=HRR(11,13,1)+FnSpB*FnSpK*VRR(2,3,0)
      HRR(11,17,1)=HRR(11,17,1)+FnSpB*SpFnK*VRR(2,3,0)
      ...
      HRR(11,14,1)=HRR(11,14,1)+FnSpB*FnSpK*VRR(2,4,0)
      HRR(11,18,1)=HRR(11,18,1)+FnSpB*SpFnK*VRR(2,4,0)
      ...
      HRR(12,11,1)=HRR(12,11,1)+FnSpB*SpSpK*VRR(3,1,0)
      HRR(12,15,1)=HRR(12,15,1)+FnSpB*SpFnK*VRR(3,1,0)
      ...
      HRR(12,12,1)=HRR(12,12,1)+FnSpB*FnSpK*VRR(3,2,0)
      HRR(12,16,1)=HRR(12,16,1)+FnSpB*SpFnK*VRR(3,2,0)
      ...
      HRR(12,13,1)=HRR(12,13,1)+FnSpB*FnSpK*VRR(3,3,0)
      HRR(12,17,1)=HRR(12,17,1)+FnSpB*SpFnK*VRR(3,3,0)
      ...
      HRR(12,14,1)=HRR(12,14,1)+FnSpB*FnSpK*VRR(3,4,0)
      HRR(12,18,1)=HRR(12,18,1)+FnSpB*SpFnK*VRR(3,4,0)
      ...
      HRR(13,11,1)=HRR(13,11,1)+FnSpB*SpSpK*VRR(4,1,0)
      HRR(13,15,1)=HRR(13,15,1)+FnSpB*SpFnK*VRR(4,1,0)
      ...
      HRR(13,12,1)=HRR(13,12,1)+FnSpB*FnSpK*VRR(4,2,0)
      HRR(13,16,1)=HRR(13,16,1)+FnSpB*SpFnK*VRR(4,2,0)
      ...
      HRR(13,13,1)=HRR(13,13,1)+FnSpB*FnSpK*VRR(4,3,0)
      HRR(13,17,1)=HRR(13,17,1)+FnSpB*SpFnK*VRR(4,3,0)
      ...
      HRR(13,14,1)=HRR(13,14,1)+FnSpB*FnSpK*VRR(4,4,0)
      HRR(13,18,1)=HRR(13,18,1)+FnSpB*SpFnK*VRR(4,4,0)
