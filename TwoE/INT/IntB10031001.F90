! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f p|f s) 
! ---------------------------------------------------------- 
   SUBROUTINE IntB10031001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      REAL(DOUBLE)  :: VRR(35,20,0:7)
      REAL(DOUBLE)  :: HRR(35,20,1)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Generating (f0|s0)^(4)
            CALL VRRf0s0(35,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|s0)^(3)
            ...
            ! Generating (g0|s0)^(3)
            CALL VRRg0s0(35,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|s0)^(2)
            ...
            ! Generating (d0|p0)^(4)
            CALL VRRd0p0(35,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|p0)^(3)
            ...
            ! Generating (f0|p0)^(3)
            CALL VRRf0p0(35,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|p0)^(2)
            ...
            ! Generating (g0|p0)^(2)
            CALL VRRg0p0(35,20,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|p0)^(1)
            CALL VRRg0p0(35,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|p0)^(0)
            CALL VRRg0p0(35,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|d0)^(5)
            CALL VRRs0d0(35,20,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|d0)^(4)
            CALL VRRs0d0(35,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|d0)^(3)
            CALL VRRs0d0(35,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|d0)^(2)
            CALL VRRs0d0(35,20,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|d0)^(1)
            CALL VRRs0d0(35,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|d0)^(0)
            CALL VRRs0d0(35,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|d0)^(4)
            CALL VRRp0d0(35,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|d0)^(3)
            ...
            ! Generating (d0|d0)^(3)
            CALL VRRd0d0(35,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|d0)^(2)
            ...
            ! Generating (f0|d0)^(2)
            CALL VRRf0d0(35,20,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|d0)^(1)
            CALL VRRf0d0(35,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|d0)^(0)
            CALL VRRf0d0(35,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|d0)^(1)
            CALL VRRg0d0(35,20,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|d0)^(0)
            CALL VRRg0d0(35,20,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|f0)^(4)
            CALL VRRs0f0(35,20,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|f0)^(3)
            ...
            ! Generating (p0|f0)^(3)
            CALL VRRp0f0(35,20,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|f0)^(2)
