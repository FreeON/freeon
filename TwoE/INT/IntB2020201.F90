...
! ----------------------------------------------------------
   SUBROUTINE IntB2020201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT2221(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (sp,0|sp,s)^(0)
      CALL KetHRR21(18,HRR)
      ! Generating (sp,sp|sp,s)^(0)
      DO L=1,1
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB2020201
    SUBROUTINE CNTRCT2221(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(10,4,0:3)
      REAL(DOUBLE)  :: HRR(18,5,1)
      ...
      HRR(15,5,1)=HRR(15,5,1)+SpFnB*SpFnK*VRR(1,1,0)
      HRR(11,5,1)=HRR(11,5,1)+SpSpB*SpFnK*VRR(1,1,0)
      ...
      HRR(16,5,1)=HRR(16,5,1)+SpFnB*SpFnK*VRR(2,1,0)
      HRR(12,5,1)=HRR(12,5,1)+FnSpB*SpFnK*VRR(2,1,0)
      ...
      HRR(17,5,1)=HRR(17,5,1)+SpFnB*SpFnK*VRR(3,1,0)
      HRR(13,5,1)=HRR(13,5,1)+FnSpB*SpFnK*VRR(3,1,0)
      ...
      HRR(18,5,1)=HRR(18,5,1)+SpFnB*SpFnK*VRR(4,1,0)
      HRR(14,5,1)=HRR(14,5,1)+FnSpB*SpFnK*VRR(4,1,0)
