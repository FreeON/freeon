...
! ---------------------------------------------------------- 
   SUBROUTINE IntB10020601(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCT10261(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|d,s)^(0) 
      CALL KetHRR61(45,HRR) 
      ! Generating (f,sp|d,s)^(0) 
      DO L=1,1
         DO K=5,10
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB10020601
    SUBROUTINE CNTRCT10261(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,10,0:6)
      REAL(DOUBLE)  :: HRR(45,10,1)
