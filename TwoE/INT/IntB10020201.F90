...
!------------------------------------------------------------------------------
! ----------------------------------------------------------
! COMPUTES THE INTEGRAL CLASS (f sp|sp s)
! ----------------------------------------------------------
   SUBROUTINE IntB10020201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT10221(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|sp,s)^(0)
      CALL KetHRR21(45,HRR)
      ! Generating (f,sp|sp,s)^(0)
      DO L=1,1
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10020201
    SUBROUTINE CNTRCT10221(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,4,0:5)
      REAL(DOUBLE)  :: HRR(45,5,1)
      ...
      HRR(36,5,1)=HRR(36,5,1)+FnSpB*SpFnK*VRR(11,1,0)
      ...
      HRR(37,5,1)=HRR(37,5,1)+FnSpB*SpFnK*VRR(12,1,0)
      ...
      HRR(38,5,1)=HRR(38,5,1)+FnSpB*SpFnK*VRR(13,1,0)
      ...
      HRR(39,5,1)=HRR(39,5,1)+FnSpB*SpFnK*VRR(14,1,0)
      ...
      HRR(40,5,1)=HRR(40,5,1)+FnSpB*SpFnK*VRR(15,1,0)
      ...
      HRR(41,5,1)=HRR(41,5,1)+FnSpB*SpFnK*VRR(16,1,0)
      ...
      HRR(42,5,1)=HRR(42,5,1)+FnSpB*SpFnK*VRR(17,1,0)
      ...
      HRR(43,5,1)=HRR(43,5,1)+FnSpB*SpFnK*VRR(18,1,0)
      ...
      HRR(44,5,1)=HRR(44,5,1)+FnSpB*SpFnK*VRR(19,1,0)
      ...
      HRR(45,5,1)=HRR(45,5,1)+FnSpB*SpFnK*VRR(20,1,0)
