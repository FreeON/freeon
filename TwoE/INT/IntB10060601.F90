! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f d|d s) 
! ---------------------------------------------------------- 
   SUBROUTINE IntB10060601(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      CALL KetHRR61(56,HRR) 
      ! Generating (f,d|d,s)^(0) 
      DO L=1,1
         DO K=5,10
