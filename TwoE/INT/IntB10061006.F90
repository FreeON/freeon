...
! ----------------------------------------------------------
   SUBROUTINE IntB10061006(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      REAL(DOUBLE)  :: VRR(56,56,0:10)
      REAL(DOUBLE)  :: HRR(56,56,10)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Generating (f0|s0)^(7)
            CALL VRRf0s0(56,56,VRR(1,1,7),VRR(1,1,8))
            ! Generating (f0|s0)^(6)
            ...
            ! Generating (g0|s0)^(6)
            CALL VRRg0s0(56,56,VRR(1,1,6),VRR(1,1,7))
            ! Generating (g0|s0)^(5)
            ...
            ! Generating (h0|s0)^(5)
            CALL VRRh0s0(56,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (h0|s0)^(4)
            ...
            ! Generating (d0|p0)^(7)
            CALL VRRd0p0(56,56,VRR(1,1,7),VRR(1,1,8))
            ! Generating (d0|p0)^(6)
            ...
            ! Generating (f0|p0)^(6)
            CALL VRRf0p0(56,56,VRR(1,1,6),VRR(1,1,7))
            ! Generating (f0|p0)^(5)
            ...
            ! Generating (g0|p0)^(5)
            CALL VRRg0p0(56,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (g0|p0)^(4)
            ...
            ! Generating (h0|p0)^(4)
            CALL VRRh0p0(56,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (h0|p0)^(3)
            ...
            ! Generating (s0|d0)^(8)
            CALL VRRs0d0(56,56,VRR(1,1,8),VRR(1,1,9))
            ! Generating (s0|d0)^(7)
            CALL VRRs0d0(56,56,VRR(1,1,7),VRR(1,1,8))
            ! Generating (s0|d0)^(6)
            CALL VRRs0d0(56,56,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|d0)^(5)
            CALL VRRs0d0(56,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|d0)^(4)
            CALL VRRs0d0(56,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|d0)^(3)
            CALL VRRs0d0(56,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|d0)^(2)
            CALL VRRs0d0(56,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|d0)^(1)
            CALL VRRs0d0(56,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|d0)^(0)
            CALL VRRs0d0(56,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|d0)^(7)
            CALL VRRp0d0(56,56,VRR(1,1,7),VRR(1,1,8))
            ! Generating (p0|d0)^(6)
            ...
            ! Generating (d0|d0)^(6)
            CALL VRRd0d0(56,56,VRR(1,1,6),VRR(1,1,7))
            ! Generating (d0|d0)^(5)
            ...
            ! Generating (f0|d0)^(5)
            CALL VRRf0d0(56,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|d0)^(4)
            ...
            ! Generating (g0|d0)^(4)
            CALL VRRg0d0(56,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|d0)^(3)
            ...
            ! Generating (h0|d0)^(3)
            CALL VRRh0d0(56,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|d0)^(2)
            ...
            ! Generating (s0|f0)^(7)
            CALL VRRs0f0(56,56,VRR(1,1,7),VRR(1,1,8))
            ! Generating (s0|f0)^(6)
            ...
            ! Generating (p0|f0)^(6)
            CALL VRRp0f0(56,56,VRR(1,1,6),VRR(1,1,7))
            ! Generating (p0|f0)^(5)
            ...
            ! Generating (d0|f0)^(5)
            CALL VRRd0f0(56,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|f0)^(4)
            ...
            ! Generating (f0|f0)^(4)
            CALL VRRf0f0(56,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|f0)^(3)
            ...
            ! Generating (g0|f0)^(3)
            CALL VRRg0f0(56,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|f0)^(2)
            ...
            ! Generating (h0|f0)^(2)
            CALL VRRh0f0(56,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|f0)^(1)
            CALL VRRh0f0(56,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|f0)^(0)
            CALL VRRh0f0(56,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|g0)^(6)
            CALL VRRs0g0(56,56,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|g0)^(5)
            ...
            ! Generating (p0|g0)^(5)
            CALL VRRp0g0(56,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|g0)^(4)
            ...
            ! Generating (d0|g0)^(4)
            CALL VRRd0g0(56,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|g0)^(3)
            ...
            ! Generating (f0|g0)^(3)
            CALL VRRf0g0(56,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|g0)^(2)
            ...
            ! Generating (g0|g0)^(2)
            CALL VRRg0g0(56,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|g0)^(1)
            CALL VRRg0g0(56,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|g0)^(0)
            CALL VRRg0g0(56,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|g0)^(1)
            CALL VRRh0g0(56,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|g0)^(0)
            CALL VRRh0g0(56,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|h0)^(5)
            CALL VRRs0h0(56,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|h0)^(4)
            ...
            ! Generating (p0|h0)^(4)
            CALL VRRp0h0(56,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|h0)^(3)
            ...
            ! Generating (d0|h0)^(3)
            CALL VRRd0h0(56,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|h0)^(2)
            ...
            ! Generating (f0|h0)^(2)
            CALL VRRf0h0(56,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|h0)^(1)
            CALL VRRf0h0(56,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|h0)^(0)
            CALL VRRf0h0(56,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|h0)^(1)
            CALL VRRg0h0(56,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|h0)^(0)
            CALL VRRg0h0(56,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|h0)^(0)
            CALL VRRh0h0(56,56,VRR(1,1,0),VRR(1,1,1))
            ! Contracting ...
            CALL DBLAXPY(3136,HRR(1,1,1),VRR(1,1,0))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|f,d)^(0)
      CALL KetHRR106(56,HRR)
      ! Generating (f,d|f,d)^(0)
      DO L=5,10
         DO K=11,20
