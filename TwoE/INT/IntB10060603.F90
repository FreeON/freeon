...
!------------------------------------------------------------------------------
! ----------------------------------------------------------
! COMPUTES THE INTEGRAL CLASS (f d|d p)
! ----------------------------------------------------------
   SUBROUTINE IntB10060603(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      CALL KetHRR63(56,HRR)
      ! Generating (f,d|d,p)^(0)
      DO L=2,4
         DO K=5,10
