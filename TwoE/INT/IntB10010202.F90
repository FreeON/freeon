...
! ----------------------------------------------------------
   SUBROUTINE IntB10010202(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT10122(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|sp,sp)^(0)
      CALL KetHRR22(20,HRR)
      ! Generating (f,s|sp,sp)^(0)
      DO L=1,4
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10010202
    SUBROUTINE CNTRCT10122(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(20,10,0:5)
      REAL(DOUBLE)  :: HRR(20,18,4)
