...
!------------------------------------------------------------------------------
! ----------------------------------------------------------
! COMPUTES THE INTEGRAL CLASS (f p|d p)
! ----------------------------------------------------------
   SUBROUTINE IntB10030603(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      CALL KetHRR63(35,HRR)
      ! Generating (f,p|d,p)^(0)
      DO L=2,4
         DO K=5,10
