...
!------------------------------------------------------------------------------
! ----------------------------------------------------------
! COMPUTES THE INTEGRAL CLASS (f d|f sp)
! ----------------------------------------------------------
   SUBROUTINE IntB10061002(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      REAL(DOUBLE)  :: HRR(56,45,4)
      INTEGER       :: OffSet,OA,LDA,OB,LDB,OC,LDC,OD,LDD,I,J,K,L
      EXTERNAL InitDbl
      CALL InitDbl(56*45,HRR(1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT106102(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|f,sp)^(0)
      CALL KetHRR102(56,HRR)
      ! Generating (f,d|f,sp)^(0)
      DO L=1,4
         DO K=11,20
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10061002
    SUBROUTINE CNTRCT106102(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(56,35,0:9)
      REAL(DOUBLE)  :: HRR(56,45,4)
