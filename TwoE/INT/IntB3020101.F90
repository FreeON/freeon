...
! ---------------------------------------------------------- 
   SUBROUTINE IntB3020101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCT3211(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (p,0|s,s)^(0) 
      CALL KetHRR11(13,HRR) 
      ! Generating (p,sp|s,s)^(0) 
      DO L=1,1
         DO K=1,1
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB3020101
    SUBROUTINE CNTRCT3211(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(10,1,0:2)
      REAL(DOUBLE)  :: HRR(13,1,1)
