...
! ----------------------------------------------------------
   SUBROUTINE IntB10060101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      REAL(DOUBLE)  :: VRR(56,1,0:5)
      REAL(DOUBLE)  :: HRR(56,1,1)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Generating (f0|s0)^(2)
            CALL VRRf0s0(56,1,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|s0)^(1)
            CALL VRRf0s0(56,1,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|s0)^(0)
            CALL VRRf0s0(56,1,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|s0)^(1)
            CALL VRRg0s0(56,1,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|s0)^(0)
            CALL VRRg0s0(56,1,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|s0)^(0)
            CALL VRRh0s0(56,1,VRR(1,1,0),VRR(1,1,1))
            ! Contracting ...
      ...
      DO L=1,1
         DO K=1,1
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10060101
    SUBROUTINE CNTRCT10611(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(56,1,0:5)
      REAL(DOUBLE)  :: HRR(56,1,1)
