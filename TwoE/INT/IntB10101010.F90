...
! ----------------------------------------------------------
   SUBROUTINE IntB10101010(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      REAL(DOUBLE)  :: VRR(84,84,0:12)
      REAL(DOUBLE)  :: HRR(84,84,20)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Generating (f0|s0)^(9)
            CALL VRRf0s0(84,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (f0|s0)^(8)
            ...
            ! Generating (g0|s0)^(8)
            CALL VRRg0s0(84,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (g0|s0)^(7)
            ...
            ! Generating (h0|s0)^(7)
            CALL VRRh0s0(84,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (h0|s0)^(6)
            ...
            ! Generating (i0|s0)^(6)
            CALL VRRi0s0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (i0|s0)^(5)
            ...
            ! Generating (d0|p0)^(9)
            CALL VRRd0p0(84,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (d0|p0)^(8)
            ...
            ! Generating (f0|p0)^(8)
            CALL VRRf0p0(84,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (f0|p0)^(7)
            ...
            ! Generating (g0|p0)^(7)
            CALL VRRg0p0(84,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (g0|p0)^(6)
            ...
            ! Generating (h0|p0)^(6)
            CALL VRRh0p0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (h0|p0)^(5)
            ...
            ! Generating (i0|p0)^(5)
            CALL VRRi0p0(84,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (i0|p0)^(4)
            ...
            ! Generating (s0|d0)^(10)
            CALL VRRs0d0(84,84,VRR(1,1,10),VRR(1,1,11))
            ! Generating (s0|d0)^(9)
            CALL VRRs0d0(84,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (s0|d0)^(8)
            CALL VRRs0d0(84,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (s0|d0)^(7)
            CALL VRRs0d0(84,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (s0|d0)^(6)
            CALL VRRs0d0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|d0)^(5)
            CALL VRRs0d0(84,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|d0)^(4)
            CALL VRRs0d0(84,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|d0)^(3)
            CALL VRRs0d0(84,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|d0)^(2)
            CALL VRRs0d0(84,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|d0)^(1)
            CALL VRRs0d0(84,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|d0)^(0)
            CALL VRRs0d0(84,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|d0)^(9)
            CALL VRRp0d0(84,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (p0|d0)^(8)
            ...
            ! Generating (d0|d0)^(8)
            CALL VRRd0d0(84,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (d0|d0)^(7)
            ...
            ! Generating (f0|d0)^(7)
            CALL VRRf0d0(84,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (f0|d0)^(6)
            ...
            ! Generating (g0|d0)^(6)
            CALL VRRg0d0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (g0|d0)^(5)
            ...
            ! Generating (h0|d0)^(5)
            CALL VRRh0d0(84,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (h0|d0)^(4)
            ...
            ! Generating (i0|d0)^(4)
            CALL VRRi0d0(84,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (i0|d0)^(3)
            ...
            ! Generating (s0|f0)^(9)
            CALL VRRs0f0(84,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (s0|f0)^(8)
            ...
            ! Generating (p0|f0)^(8)
            CALL VRRp0f0(84,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (p0|f0)^(7)
            ...
            ! Generating (d0|f0)^(7)
            CALL VRRd0f0(84,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (d0|f0)^(6)
            ...
            ! Generating (f0|f0)^(6)
            CALL VRRf0f0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (f0|f0)^(5)
            ...
            ! Generating (g0|f0)^(5)
            CALL VRRg0f0(84,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (g0|f0)^(4)
            ...
            ! Generating (h0|f0)^(4)
            CALL VRRh0f0(84,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (h0|f0)^(3)
            ...
            ! Generating (i0|f0)^(3)
            CALL VRRi0f0(84,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (i0|f0)^(2)
            ...
            ! Generating (s0|g0)^(8)
            CALL VRRs0g0(84,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (s0|g0)^(7)
            ...
            ! Generating (p0|g0)^(7)
            CALL VRRp0g0(84,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (p0|g0)^(6)
            ...
            ! Generating (d0|g0)^(6)
            CALL VRRd0g0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (d0|g0)^(5)
            ...
            ! Generating (f0|g0)^(5)
            CALL VRRf0g0(84,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|g0)^(4)
            ...
            ! Generating (g0|g0)^(4)
            CALL VRRg0g0(84,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|g0)^(3)
            ...
            ! Generating (h0|g0)^(3)
            CALL VRRh0g0(84,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|g0)^(2)
            ...
            ! Generating (i0|g0)^(2)
            CALL VRRi0g0(84,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (i0|g0)^(1)
            CALL VRRi0g0(84,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|g0)^(0)
            CALL VRRi0g0(84,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|h0)^(7)
            CALL VRRs0h0(84,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (s0|h0)^(6)
            ...
            ! Generating (p0|h0)^(6)
            CALL VRRp0h0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (p0|h0)^(5)
            ...
            ! Generating (d0|h0)^(5)
            CALL VRRd0h0(84,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|h0)^(4)
            ...
            ! Generating (f0|h0)^(4)
            CALL VRRf0h0(84,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|h0)^(3)
            ...
            ! Generating (g0|h0)^(3)
            CALL VRRg0h0(84,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|h0)^(2)
            ...
            ! Generating (h0|h0)^(2)
            CALL VRRh0h0(84,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|h0)^(1)
            CALL VRRh0h0(84,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|h0)^(0)
            CALL VRRh0h0(84,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|h0)^(1)
            CALL VRRi0h0(84,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|h0)^(0)
            CALL VRRi0h0(84,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|i0)^(6)
            CALL VRRs0i0(84,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|i0)^(5)
            ...
            ! Generating (p0|i0)^(5)
            CALL VRRp0i0(84,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|i0)^(4)
            ...
            ! Generating (d0|i0)^(4)
            CALL VRRd0i0(84,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|i0)^(3)
            ...
            ! Generating (f0|i0)^(3)
            CALL VRRf0i0(84,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|i0)^(2)
            ...
            ! Generating (g0|i0)^(2)
            CALL VRRg0i0(84,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|i0)^(1)
            CALL VRRg0i0(84,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|i0)^(0)
            CALL VRRg0i0(84,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|i0)^(1)
            CALL VRRh0i0(84,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|i0)^(0)
            CALL VRRh0i0(84,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|i0)^(0)
            CALL VRRi0i0(84,84,VRR(1,1,0),VRR(1,1,1))
            ! Contracting ...
            CALL DBLAXPY(7056,HRR(1,1,1),VRR(1,1,0))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|f,f)^(0)
      CALL KetHRR1010(84,HRR)
      ! Generating (f,f|f,f)^(0)
      DO L=11,20
         DO K=11,20
