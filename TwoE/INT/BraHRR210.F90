   SUBROUTINE BraHRR210(OA,OB,LDA,LDB,CDOffSet,HRR,INTGRL) 
      ...
      INTGRL(OffSet)=2.23606797749979D0*ABy*HRR(40)+  & 
        ABx*(4.47213595499958D0*ABy*HRR(37)+  & 
        ABx*(2.23606797749979D0*ABy*HRR(36)+  & 
        2.23606797749979D0*HRR(38))+  & 
        4.47213595499958D0*HRR(41))+  & 
        2.23606797749979D0*HRR(47)
      OffSet=(OA+0)*LDA+(OB+2)*LDB+CDOffSet !=(1,13|
      INTGRL(OffSet)=ABy*(2.23606797749979D0*ABy*HRR(37)+  & 
        4.47213595499958D0*HRR(41))+  & 
        ABx*(ABy*(2.23606797749979D0*ABy*HRR(36)+  & 
        4.47213595499958D0*HRR(38))+  & 
      ...
      INTGRL(OffSet)=2.23606797749979D0*ABz*HRR(40)+  & 
        ABx*(4.47213595499958D0*ABz*HRR(37)+  & 
        ABx*(2.23606797749979D0*ABz*HRR(36)+  & 
        2.23606797749979D0*HRR(39))+  & 
        4.47213595499958D0*HRR(43))+  & 
        2.23606797749979D0*HRR(50)
      OffSet=(OA+0)*LDA+(OB+5)*LDB+CDOffSet !=(1,16|
      INTGRL(OffSet)=3.87298334620742D0*ABz*HRR(41)+  & 
        ABy*(3.87298334620742D0*ABz*HRR(37)+  & 
        3.87298334620742D0*HRR(43))+  & 
        ABx*(3.87298334620742D0*ABz*HRR(38)+  & 
        ABy*(3.87298334620742D0*ABz*HRR(36)+  & 
        3.87298334620742D0*HRR(39))+  & 
        3.87298334620742D0*HRR(44))+  & 
        3.87298334620742D0*HRR(51)
      OffSet=(OA+0)*LDA+(OB+6)*LDB+CDOffSet !=(1,17|
      INTGRL(OffSet)=2.23606797749979D0*ABz*HRR(42)+  & 
        ABy*(4.47213595499958D0*ABz*HRR(38)+  & 
        ABy*(2.23606797749979D0*ABz*HRR(36)+  & 
        2.23606797749979D0*HRR(39))+  & 
        4.47213595499958D0*HRR(44))+  & 
        2.23606797749979D0*HRR(52)
      OffSet=(OA+0)*LDA+(OB+7)*LDB+CDOffSet !=(1,18|
      INTGRL(OffSet)=ABz*(2.23606797749979D0*ABz*HRR(37)+  & 
        4.47213595499958D0*HRR(43))+  & 
        ABx*(ABz*(2.23606797749979D0*ABz*HRR(36)+  & 
        4.47213595499958D0*HRR(39))+  & 
        2.23606797749979D0*HRR(45))+  & 
        2.23606797749979D0*HRR(53)
      OffSet=(OA+0)*LDA+(OB+8)*LDB+CDOffSet !=(1,19|
      INTGRL(OffSet)=ABz*(2.23606797749979D0*ABz*HRR(38)+  & 
        4.47213595499958D0*HRR(44))+  & 
        ABy*(ABz*(2.23606797749979D0*ABz*HRR(36)+  & 
        4.47213595499958D0*HRR(39))+  & 
        2.23606797749979D0*HRR(45))+  & 
