...
! ---------------------------------------------------------- 
   SUBROUTINE IntB10011001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      CALL KetHRR101(20,HRR) 
      ! Generating (f,s|f,s)^(0) 
      DO L=1,1
         DO K=11,20
