...
! ----------------------------------------------------------
   SUBROUTINE IntB10020303(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT10233(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|p,p)^(0)
      CALL KetHRR33(45,HRR)
      ! Generating (f,sp|p,p)^(0)
      DO L=2,4
         DO K=2,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10020303
    SUBROUTINE CNTRCT10233(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,10,0:6)
      REAL(DOUBLE)  :: HRR(45,10,4)
