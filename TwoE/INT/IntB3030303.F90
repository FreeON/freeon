...
! ----------------------------------------------------------
   SUBROUTINE IntB3030303(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT3333(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (p,0|p,p)^(0)
      CALL KetHRR33(10,HRR)
      ! Generating (p,p|p,p)^(0)
      DO L=2,4
         DO K=2,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB3030303
    SUBROUTINE CNTRCT3333(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(10,10,0:4)
      REAL(DOUBLE)  :: HRR(10,10,4)
