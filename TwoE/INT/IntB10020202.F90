...
! ----------------------------------------------------------
   SUBROUTINE IntB10020202(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT10222(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|sp,sp)^(0)
      CALL KetHRR22(45,HRR)
      ! Generating (f,sp|sp,sp)^(0)
      DO L=1,4
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10020202
    SUBROUTINE CNTRCT10222(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,10,0:6)
      REAL(DOUBLE)  :: HRR(45,18,4)
