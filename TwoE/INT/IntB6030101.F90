...
! ---------------------------------------------------------- 
   SUBROUTINE IntB6030101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCT6311(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (d,0|s,s)^(0) 
      CALL KetHRR11(20,HRR) 
      ! Generating (d,p|s,s)^(0) 
      DO L=1,1
         DO K=1,1
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB6030101
    SUBROUTINE CNTRCT6311(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(20,1,0:3)
      REAL(DOUBLE)  :: HRR(20,1,1)
