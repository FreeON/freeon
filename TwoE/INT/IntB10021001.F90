...
! ---------------------------------------------------------- 
   SUBROUTINE IntB10021001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCT102101(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|f,s)^(0) 
      CALL KetHRR101(45,HRR) 
      ! Generating (f,sp|f,s)^(0) 
      DO L=1,1
         DO K=11,20
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB10021001
    SUBROUTINE CNTRCT102101(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,20,0:7)
      REAL(DOUBLE)  :: HRR(45,20,1)
