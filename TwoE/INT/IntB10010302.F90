...
! ----------------------------------------------------------
   SUBROUTINE IntB10010302(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT10132(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|p,sp)^(0)
      CALL KetHRR32(20,HRR)
      ! Generating (f,s|p,sp)^(0)
      DO L=1,4
         DO K=2,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10010302
    SUBROUTINE CNTRCT10132(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(20,10,0:5)
      REAL(DOUBLE)  :: HRR(20,13,4)
