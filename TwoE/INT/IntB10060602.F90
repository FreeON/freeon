...
! ----------------------------------------------------------
   SUBROUTINE IntB10060602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT10662(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|d,sp)^(0)
      CALL KetHRR62(56,HRR)
      ! Generating (f,d|d,sp)^(0)
      DO L=1,4
         DO K=5,10
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10060602
    SUBROUTINE CNTRCT10662(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(56,20,0:8)
      REAL(DOUBLE)  :: HRR(56,26,4)
