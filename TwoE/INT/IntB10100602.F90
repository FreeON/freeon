...
! ----------------------------------------------------------
   SUBROUTINE IntB10100602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT101062(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|d,sp)^(0)
      CALL KetHRR62(84,HRR)
      ! Generating (f,f|d,sp)^(0)
      DO L=1,4
         DO K=5,10
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10100602
    SUBROUTINE CNTRCT101062(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(84,20,0:9)
      REAL(DOUBLE)  :: HRR(84,26,4)
