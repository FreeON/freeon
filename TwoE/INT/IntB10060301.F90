...
! ---------------------------------------------------------- 
   SUBROUTINE IntB10060301(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL DBLAXPY(224,HRR(1,1,1),VRR(1,1,0)) 
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|p,s)^(0) 
      CALL KetHRR31(56,HRR) 
      ! Generating (f,d|p,s)^(0) 
      DO L=1,1
         DO K=2,4
