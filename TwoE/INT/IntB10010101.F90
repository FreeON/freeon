...
! ---------------------------------------------------------- 
   SUBROUTINE IntB10010101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCT10111(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|s,s)^(0) 
      CALL KetHRR11(20,HRR) 
      ! Generating (f,s|s,s)^(0) 
      DO L=1,1
         DO K=1,1
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB10010101
    SUBROUTINE CNTRCT10111(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(20,1,0:3)
      REAL(DOUBLE)  :: HRR(20,1,1)
