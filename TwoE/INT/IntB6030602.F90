...
! ----------------------------------------------------------
   SUBROUTINE IntB6030602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT6362(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (d,0|d,sp)^(0)
      CALL KetHRR62(20,HRR)
      ! Generating (d,p|d,sp)^(0)
      DO L=1,4
         DO K=5,10
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB6030602
    SUBROUTINE CNTRCT6362(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(20,20,0:6)
      REAL(DOUBLE)  :: HRR(20,26,4)
