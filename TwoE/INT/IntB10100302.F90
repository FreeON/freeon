...
! ----------------------------------------------------------
   SUBROUTINE IntB10100302(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT101032(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|p,sp)^(0)
      CALL KetHRR32(84,HRR)
      ! Generating (f,f|p,sp)^(0)
      DO L=1,4
         DO K=2,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10100302
    SUBROUTINE CNTRCT101032(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(84,10,0:8)
      REAL(DOUBLE)  :: HRR(84,13,4)
