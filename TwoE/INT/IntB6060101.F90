...
! ---------------------------------------------------------- 
   SUBROUTINE IntB6060101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCT6611(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (d,0|s,s)^(0) 
      CALL KetHRR11(35,HRR) 
      ! Generating (d,d|s,s)^(0) 
      DO L=1,1
         DO K=1,1
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB6060101
    SUBROUTINE CNTRCT6611(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,1,0:4)
      REAL(DOUBLE)  :: HRR(35,1,1)
