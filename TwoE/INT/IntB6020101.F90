...
! ---------------------------------------------------------- 
   SUBROUTINE IntB6020101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      REAL(DOUBLE)  :: VRR(20,1,0:3)
      REAL(DOUBLE)  :: HRR(26,1,1)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Generating (f0|s0)^(0)
            CALL VRRf0s0(20,1,VRR(1,1,0),VRR(1,1,1))
            ! Contracting ... 
            CALL CNTRCT6211(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (d,0|s,s)^(0) 
      CALL KetHRR11(26,HRR) 
      ! Generating (d,sp|s,s)^(0) 
      DO L=1,1
         DO K=1,1
          ...
          ENDDO 
      ENDDO 
    END SUBROUTINE IntB6020101
    SUBROUTINE CNTRCT6211(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(20,1,0:3)
      REAL(DOUBLE)  :: HRR(26,1,1)
