...
! ----------------------------------------------------------
   SUBROUTINE IntB6060202(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT6622(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (d,0|sp,sp)^(0)
      CALL KetHRR22(35,HRR)
      ! Generating (d,d|sp,sp)^(0)
      DO L=1,4
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB6060202
    SUBROUTINE CNTRCT6622(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,10,0:6)
      REAL(DOUBLE)  :: HRR(35,18,4)
