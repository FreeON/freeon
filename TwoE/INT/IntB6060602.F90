...
! ----------------------------------------------------------
   SUBROUTINE IntB6060602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT6662(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (d,0|d,sp)^(0)
      CALL KetHRR62(35,HRR)
      ! Generating (d,d|d,sp)^(0)
      DO L=1,4
         DO K=5,10
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB6060602
    SUBROUTINE CNTRCT6662(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(35,20,0:7)
      REAL(DOUBLE)  :: HRR(35,26,4)
