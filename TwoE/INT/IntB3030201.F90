...
! ----------------------------------------------------------
   SUBROUTINE IntB3030201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT3321(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (p,0|sp,s)^(0)
      CALL KetHRR21(10,HRR)
      ! Generating (p,p|sp,s)^(0)
      DO L=1,1
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB3030201
    SUBROUTINE CNTRCT3321(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(10,4,0:3)
      REAL(DOUBLE)  :: HRR(10,5,1)
