! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f p|d s) 
! ---------------------------------------------------------- 
   SUBROUTINE IntB10030601(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      CALL KetHRR61(35,HRR) 
      ! Generating (f,p|d,s)^(0) 
      DO L=1,1
         DO K=5,10
