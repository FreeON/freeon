...
! ----------------------------------------------------------
   SUBROUTINE IntB6020201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT6221(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (d,0|sp,s)^(0)
      CALL KetHRR21(26,HRR)
      ! Generating (d,sp|sp,s)^(0)
      DO L=1,1
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB6020201
    SUBROUTINE CNTRCT6221(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(20,4,0:4)
      REAL(DOUBLE)  :: HRR(26,5,1)
      ...
      HRR(21,5,1)=HRR(21,5,1)+FnSpB*SpFnK*VRR(5,1,0)
      ...
      HRR(22,5,1)=HRR(22,5,1)+FnSpB*SpFnK*VRR(6,1,0)
      ...
      HRR(23,5,1)=HRR(23,5,1)+FnSpB*SpFnK*VRR(7,1,0)
      ...
      HRR(24,5,1)=HRR(24,5,1)+FnSpB*SpFnK*VRR(8,1,0)
      ...
      HRR(25,5,1)=HRR(25,5,1)+FnSpB*SpFnK*VRR(9,1,0)
      ...
      HRR(26,5,1)=HRR(26,5,1)+FnSpB*SpFnK*VRR(10,1,0)
