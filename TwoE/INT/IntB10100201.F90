...
! ----------------------------------------------------------
   SUBROUTINE IntB10100201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Contracting ...
            CALL CNTRCT101021(VRR,HRR)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|sp,s)^(0)
      CALL KetHRR21(84,HRR)
      ! Generating (f,f|sp,s)^(0)
      DO L=1,1
         DO K=1,4
          ...
          ENDDO
      ENDDO
    END SUBROUTINE IntB10100201
    SUBROUTINE CNTRCT101021(VRR,HRR)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: VRR(84,4,0:7)
      REAL(DOUBLE)  :: HRR(84,5,1)
