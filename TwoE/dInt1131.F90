...
! ---------------------------------------------------------- 
   SUBROUTINE dInt1131(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      dI(OffSet,CrtSet1)=Ia2Bar2
      dI(OffSet,CrtSet4)=Ib2Bar2+V(1)
      dI(OffSet,CrtSet7)=Ic1Bar5+V(2)
      W1=I1Bar1-Ia2Bar2
      W2=-Ib2Bar2-Ic1Bar5-V(1)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia3Bar2
      dI(OffSet,CrtSet5)=Ib3Bar2+V(3)
      dI(OffSet,CrtSet8)=Ic1Bar6
      W1=-Ia3Bar2-Ib3Bar2
      W2=-V(3)+V(4)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia4Bar2
      dI(OffSet,CrtSet6)=Ib4Bar2+V(5)
      dI(OffSet,CrtSet9)=Ic1Bar8
      W1=-Ia4Bar2-Ib4Bar2
      W2=-V(5)+V(6)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+0)*LDA+(OB+0)*LDB+(OC+1)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia2Bar3
      dI(OffSet,CrtSet4)=Ib2Bar3+V(7)
      dI(OffSet,CrtSet7)=Ic1Bar6
      W1=-Ia2Bar3-Ib2Bar3
      W2=V(4)-V(7)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia3Bar3
      dI(OffSet,CrtSet5)=Ib3Bar3+V(8)
      dI(OffSet,CrtSet8)=Ic1Bar7+V(2)
      W1=I1Bar1-Ia3Bar3
      W2=-Ib3Bar3-Ic1Bar7-V(8)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia4Bar3
      dI(OffSet,CrtSet6)=Ib4Bar3+V(9)
      dI(OffSet,CrtSet9)=Ic1Bar9
      W1=-Ia4Bar3-Ib4Bar3
      W2=-V(9)+V(10)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+0)*LDA+(OB+0)*LDB+(OC+2)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia2Bar4
      dI(OffSet,CrtSet4)=Ib2Bar4+V(11)
      dI(OffSet,CrtSet7)=Ic1Bar8
      W1=-Ia2Bar4-Ib2Bar4
      W2=V(6)-V(11)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia3Bar4
      dI(OffSet,CrtSet5)=Ib3Bar4+V(12)
      dI(OffSet,CrtSet8)=Ic1Bar9
      W1=-Ia3Bar4-Ib3Bar4
      W2=V(10)-V(12)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia4Bar4
      dI(OffSet,CrtSet6)=Ib4Bar4+V(13)
      dI(OffSet,CrtSet9)=Ic1Bar10+V(2)
      W1=I1Bar1-Ia4Bar4
      W2=-Ib4Bar4-Ic1Bar10-V(13)
      dI(OffSet,CrtSet12)=W1+W2
