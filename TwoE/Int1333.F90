...
! ---------------------------------------------------------- 
   SUBROUTINE Int1333(Ax,Ay,Az,Bx,By,Bz,Cx,Cy,Cz, &  
      ...
      V17=MBarN(1,4)*CDz
      V18=MBarN(1,10)+V17
      I(1,2,2,2)=MBarN(2,5)+MBarN(2,2)*CDx+V2*ABx+I(1,2,2,2)
      I(1,3,2,2)=MBarN(3,5)+MBarN(3,2)*CDx+V2*ABy+I(1,3,2,2)
      I(1,4,2,2)=MBarN(4,5)+MBarN(4,2)*CDx+V2*ABz+I(1,4,2,2)
      I(1,2,3,2)=MBarN(2,6)+MBarN(2,3)*CDx+V4*ABx+I(1,2,3,2)
      I(1,3,3,2)=MBarN(3,6)+MBarN(3,3)*CDx+V4*ABy+I(1,3,3,2)
      I(1,4,3,2)=MBarN(4,6)+MBarN(4,3)*CDx+V4*ABz+I(1,4,3,2)
      I(1,2,4,2)=MBarN(2,8)+MBarN(2,4)*CDx+V6*ABx+I(1,2,4,2)
      I(1,3,4,2)=MBarN(3,8)+MBarN(3,4)*CDx+V6*ABy+I(1,3,4,2)
      I(1,4,4,2)=MBarN(4,8)+MBarN(4,4)*CDx+V6*ABz+I(1,4,4,2)
      I(1,2,2,3)=MBarN(2,6)+V8*ABx+MBarN(2,2)*CDy+I(1,2,2,3)
      I(1,3,2,3)=MBarN(3,6)+MBarN(3,2)*CDy+V8*ABy+I(1,3,2,3)
      I(1,4,2,3)=MBarN(4,6)+MBarN(4,2)*CDy+V8*ABz+I(1,4,2,3)
      I(1,2,3,3)=MBarN(2,7)+V10*ABx+MBarN(2,3)*CDy+I(1,2,3,3)
      I(1,3,3,3)=MBarN(3,7)+MBarN(3,3)*CDy+V10*ABy+I(1,3,3,3)
      I(1,4,3,3)=MBarN(4,7)+MBarN(4,3)*CDy+V10*ABz+I(1,4,3,3)
      I(1,2,4,3)=MBarN(2,9)+V12*ABx+MBarN(2,4)*CDy+I(1,2,4,3)
      I(1,3,4,3)=MBarN(3,9)+MBarN(3,4)*CDy+V12*ABy+I(1,3,4,3)
      I(1,4,4,3)=MBarN(4,9)+MBarN(4,4)*CDy+V12*ABz+I(1,4,4,3)
      I(1,2,2,4)=MBarN(2,8)+V14*ABx+MBarN(2,2)*CDz+I(1,2,2,4)
      I(1,3,2,4)=MBarN(3,8)+V14*ABy+MBarN(3,2)*CDz+I(1,3,2,4)
      I(1,4,2,4)=MBarN(4,8)+MBarN(4,2)*CDz+V14*ABz+I(1,4,2,4)
      I(1,2,3,4)=MBarN(2,9)+V16*ABx+MBarN(2,3)*CDz+I(1,2,3,4)
      I(1,3,3,4)=MBarN(3,9)+V16*ABy+MBarN(3,3)*CDz+I(1,3,3,4)
      I(1,4,3,4)=MBarN(4,9)+MBarN(4,3)*CDz+V16*ABz+I(1,4,3,4)
      I(1,2,4,4)=MBarN(2,10)+V18*ABx+MBarN(2,4)*CDz+I(1,2,4,4)
      I(1,3,4,4)=MBarN(3,10)+V18*ABy+MBarN(3,4)*CDz+I(1,3,4,4)
      I(1,4,4,4)=MBarN(4,10)+MBarN(4,4)*CDz+V18*ABz+I(1,4,4,4)
