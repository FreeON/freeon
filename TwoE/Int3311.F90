...
! ---------------------------------------------------------- 
   SUBROUTINE Int3311(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo,I) 
      ...
      ENDDO ! |N0) loop
      ! HRR 
      I(2,2,1,1)=ABx*I2Bar1+I5Bar1
      I(3,2,1,1)=ABx*I3Bar1+I6Bar1
      I(4,2,1,1)=ABx*I4Bar1+I8Bar1
      I(2,3,1,1)=ABy*I2Bar1+I6Bar1
      I(3,3,1,1)=ABy*I3Bar1+I7Bar1
      I(4,3,1,1)=ABy*I4Bar1+I9Bar1
      I(2,4,1,1)=ABz*I2Bar1+I8Bar1
      I(3,4,1,1)=ABz*I3Bar1+I9Bar1
      I(4,4,1,1)=I10Bar1+ABz*I4Bar1
