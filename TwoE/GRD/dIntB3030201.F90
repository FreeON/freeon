...
SUBROUTINE dIntB3030201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      ENDDO ! |N0) loop
      ! Generating (d,0|sp,s)
      CALL KetHRR21(10,HRR) 
      ! Generating (f,0|sp,s)^a
      CALL KetHRR21(10,HRRA) 
      ! Generating (f,0|sp,s)^b
      CALL KetHRR21(10,HRRB) 
      ! Generating (d,0|spd,s)^c
