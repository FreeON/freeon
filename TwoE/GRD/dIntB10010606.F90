...
! ----------------------------------------------------------
SUBROUTINE dIntB10010606(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(20,35,10) :: HRR
      REAL(DOUBLE), DIMENSION(35,35,10) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(20,56,10) :: HRRC
      REAL(DOUBLE)  :: VRR(35,56,0:8)
      REAL(DOUBLE)  :: VRRS(20,35,0:7,3)
      REAL(DOUBLE)  :: HRRS(20,35,10,9)
      ...
      CALL InitDbl(35*35,HRRA(1,1,1))
      CALL InitDbl(35*35,HRRB(1,1,1))
      CALL InitDbl(20*56,HRRC(1,1,1))
      CALL InitDbl(9*10*20*35,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ! Generating (f0|s0)^(5)
            CALL VRRf0s0(35,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|s0)^(4)
            CALL VRRf0s0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|s0)^(3)
            CALL VRRf0s0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|s0)^(2)
            CALL VRRf0s0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|s0)^(1)
            CALL VRRf0s0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|s0)^(0)
            CALL VRRf0s0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|s0)^(4)
            CALL VRRg0s0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|s0)^(3)
            CALL VRRg0s0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|s0)^(2)
            CALL VRRg0s0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|s0)^(1)
            CALL VRRg0s0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|s0)^(0)
            CALL VRRg0s0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|p0)^(7)
            ...
            ! Generating (d0|p0)^(5)
            CALL VRRd0p0(35,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|p0)^(4)
            CALL VRRd0p0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|p0)^(3)
            CALL VRRd0p0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|p0)^(2)
            CALL VRRd0p0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|p0)^(1)
            CALL VRRd0p0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|p0)^(0)
            CALL VRRd0p0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|p0)^(4)
            CALL VRRf0p0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|p0)^(3)
            CALL VRRf0p0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|p0)^(2)
            CALL VRRf0p0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|p0)^(1)
            CALL VRRf0p0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|p0)^(0)
            CALL VRRf0p0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|p0)^(3)
            CALL VRRg0p0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|p0)^(2)
            CALL VRRg0p0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|p0)^(1)
            CALL VRRg0p0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|p0)^(0)
            CALL VRRg0p0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|d0)^(6)
            ...
            ! Generating (p0|d0)^(5)
            CALL VRRp0d0(35,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|d0)^(4)
            CALL VRRp0d0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|d0)^(3)
            CALL VRRp0d0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|d0)^(2)
            CALL VRRp0d0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|d0)^(1)
            CALL VRRp0d0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|d0)^(0)
            CALL VRRp0d0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|d0)^(4)
            CALL VRRd0d0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|d0)^(3)
            CALL VRRd0d0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|d0)^(2)
            CALL VRRd0d0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|d0)^(1)
            CALL VRRd0d0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|d0)^(0)
            CALL VRRd0d0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|d0)^(3)
            CALL VRRf0d0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|d0)^(2)
            CALL VRRf0d0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|d0)^(1)
            CALL VRRf0d0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|d0)^(0)
            CALL VRRf0d0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|d0)^(2)
            CALL VRRg0d0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|d0)^(1)
            CALL VRRg0d0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|d0)^(0)
            CALL VRRg0d0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|f0)^(5)
            CALL VRRs0f0(35,56,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|f0)^(4)
            CALL VRRs0f0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|f0)^(3)
            CALL VRRs0f0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|f0)^(2)
            CALL VRRs0f0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|f0)^(1)
            CALL VRRs0f0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|f0)^(0)
            CALL VRRs0f0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|f0)^(4)
            CALL VRRp0f0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|f0)^(3)
            CALL VRRp0f0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|f0)^(2)
            CALL VRRp0f0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|f0)^(1)
            CALL VRRp0f0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|f0)^(0)
            CALL VRRp0f0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|f0)^(3)
            CALL VRRd0f0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|f0)^(2)
            CALL VRRd0f0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|f0)^(1)
            CALL VRRd0f0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|f0)^(0)
            CALL VRRd0f0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|f0)^(2)
            CALL VRRf0f0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|f0)^(1)
            CALL VRRf0f0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|f0)^(0)
            CALL VRRf0f0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|f0)^(1)
            CALL VRRg0f0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|f0)^(0)
            CALL VRRg0f0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|g0)^(4)
            CALL VRRs0g0(35,56,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|g0)^(3)
            CALL VRRs0g0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|g0)^(2)
            CALL VRRs0g0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|g0)^(1)
            CALL VRRs0g0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|g0)^(0)
            CALL VRRs0g0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|g0)^(3)
            CALL VRRp0g0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|g0)^(2)
            CALL VRRp0g0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|g0)^(1)
            CALL VRRp0g0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|g0)^(0)
            CALL VRRp0g0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|g0)^(2)
            CALL VRRd0g0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|g0)^(1)
            CALL VRRd0g0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|g0)^(0)
            CALL VRRd0g0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|g0)^(1)
            CALL VRRf0g0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|g0)^(0)
            CALL VRRf0g0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|g0)^(0)
            CALL VRRg0g0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|h0)^(3)
            CALL VRRs0h0(35,56,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|h0)^(2)
            CALL VRRs0h0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|h0)^(1)
            CALL VRRs0h0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|h0)^(0)
            CALL VRRs0h0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|h0)^(2)
            CALL VRRp0h0(35,56,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|h0)^(1)
            CALL VRRp0h0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|h0)^(0)
            CALL VRRp0h0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|h0)^(1)
            CALL VRRd0h0(35,56,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|h0)^(0)
            CALL VRRd0h0(35,56,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|h0)^(0)
            CALL VRRf0h0(35,56,VRR(1,1,0),VRR(1,1,1))
            ...
            CALL MVRRf0s0(1,20,35,VRRS(1,1,4,1),VRRS(1,1,5,1),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ...
            CALL MVRRd0p0(1,20,35,VRRS(1,1,4,1),VRRS(1,1,5,1),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ...
            CALL MVRRp0d0(1,20,35,VRRS(1,1,4,1),VRRS(1,1,5,1),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(1,20,35,VRRS(1,1,4,1),VRRS(1,1,5,1),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|g0]^(3)
            CALL MVRRs0g0(1,20,35,VRRS(1,1,3,1),VRRS(1,1,4,1),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|g0]^(2)
            CALL MVRRs0g0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|g0]^(1)
            CALL MVRRs0g0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|g0]^(0)
            CALL MVRRs0g0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|g0]^(2)
            CALL MVRRp0g0(1,20,35,VRRS(1,1,2,1),VRRS(1,1,3,1),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|g0]^(1)
            CALL MVRRp0g0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|g0]^(0)
            CALL MVRRp0g0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|g0]^(1)
            CALL MVRRd0g0(1,20,35,VRRS(1,1,1,1),VRRS(1,1,2,1),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|g0]^(0)
            CALL MVRRd0g0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|g0]^(0)
            CALL MVRRf0g0(1,20,35,VRRS(1,1,0,1),VRRS(1,1,1,1),35,56,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(2,20,35,VRRS(1,1,4,2),VRRS(1,1,5,2),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(6)
            ...
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(2,20,35,VRRS(1,1,4,2),VRRS(1,1,5,2),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(5)
            ...
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(2,20,35,VRRS(1,1,4,2),VRRS(1,1,5,2),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(2,20,35,VRRS(1,1,4,2),VRRS(1,1,5,2),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|g0]^(3)
            CALL MVRRs0g0(2,20,35,VRRS(1,1,3,2),VRRS(1,1,4,2),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|g0]^(2)
            CALL MVRRs0g0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|g0]^(1)
            CALL MVRRs0g0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|g0]^(0)
            CALL MVRRs0g0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|g0]^(2)
            CALL MVRRp0g0(2,20,35,VRRS(1,1,2,2),VRRS(1,1,3,2),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|g0]^(1)
            CALL MVRRp0g0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|g0]^(0)
            CALL MVRRp0g0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|g0]^(1)
            CALL MVRRd0g0(2,20,35,VRRS(1,1,1,2),VRRS(1,1,2,2),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|g0]^(0)
            CALL MVRRd0g0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|g0]^(0)
            CALL MVRRf0g0(2,20,35,VRRS(1,1,0,2),VRRS(1,1,1,2),35,56,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(3,20,35,VRRS(1,1,4,3),VRRS(1,1,5,3),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(6)
            ...
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(3,20,35,VRRS(1,1,4,3),VRRS(1,1,5,3),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(5)
            ...
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(3,20,35,VRRS(1,1,4,3),VRRS(1,1,5,3),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(3,20,35,VRRS(1,1,4,3),VRRS(1,1,5,3),35,56,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|g0]^(3)
            CALL MVRRs0g0(3,20,35,VRRS(1,1,3,3),VRRS(1,1,4,3),35,56,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|g0]^(2)
            CALL MVRRs0g0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|g0]^(1)
            CALL MVRRs0g0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|g0]^(0)
            CALL MVRRs0g0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|g0]^(2)
            CALL MVRRp0g0(3,20,35,VRRS(1,1,2,3),VRRS(1,1,3,3),35,56,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|g0]^(1)
            CALL MVRRp0g0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|g0]^(0)
            CALL MVRRp0g0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|g0]^(1)
            CALL MVRRd0g0(3,20,35,VRRS(1,1,1,3),VRRS(1,1,2,3),35,56,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|g0]^(0)
            CALL MVRRd0g0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|g0]^(0)
            CALL MVRRf0g0(3,20,35,VRRS(1,1,0,3),VRRS(1,1,1,3),35,56,VRR(1,1,1))
            ENDIF
            ! Contracting ...
            CALL CNTRCTG10166(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|d,d)
      CALL KetHRR66(20,HRR)
      ! Generating (g,0|d,d)^a
      CALL KetHRR66(35,HRRA)
      ! Generating (g,0|d,d)^b
      CALL KetHRR66(35,HRRB)
      ! Generating (f,0|f,d)^c
      CALL KetHRR106(20,HRRC)
      ! Stress: Generating [f,0|d,d]
      DO IJ=1,9
        CALL KetHRR66(20,HRRS(1,1,1,IJ))
      ENDDO
      DO L=5,10
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10010606
    SUBROUTINE CNTRCTG10166(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(35,56,0:8)
      REAL(DOUBLE)  :: VRRS(20,35,0:7,3)
      REAL(DOUBLE)  :: HRRS(20,35,10,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,35
