...
! ----------------------------------------------------------
SUBROUTINE dIntB10060603(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(56,20,4) :: HRR
      REAL(DOUBLE), DIMENSION(84,20,4) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(56,35,4) :: HRRC
      REAL(DOUBLE)  :: VRR(84,35,0:9)
      REAL(DOUBLE)  :: VRRS(56,20,0:8,3)
      REAL(DOUBLE)  :: HRRS(56,20,4,9)
      ...
      CALL InitDbl(84*20,HRRA(1,1,1))
      CALL InitDbl(84*20,HRRB(1,1,1))
      CALL InitDbl(56*35,HRRC(1,1,1))
      CALL InitDbl(9*4*56*20,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ENDIF
            ! Contracting ...
            CALL CNTRCTG10663(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (h,0|d,p)
      CALL KetHRR63(56,HRR)
      ! Generating (i,0|d,p)^a
      CALL KetHRR63(84,HRRA)
      ! Generating (i,0|d,p)^b
      CALL KetHRR63(84,HRRB)
      ! Generating (h,0|f,p)^c
      CALL KetHRR103(56,HRRC)
      ! Stress: Generating [f,0|d,p]
      DO IJ=1,9
        CALL KetHRR63(56,HRRS(1,1,1,IJ))
      ENDDO
      DO L=2,4
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10060603
    SUBROUTINE CNTRCTG10663(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(84,35,0:9)
      REAL(DOUBLE)  :: VRRS(56,20,0:8,3)
      REAL(DOUBLE)  :: HRRS(56,20,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,20
