...
SUBROUTINE dIntB3020101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(13,1,0:2,3)
      REAL(DOUBLE)  :: HRRS(13,1,1,9)
      ...
      CALL InitDbl(9*1*13*1,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
   ...
   END SUBROUTINE dIntB3020101
    SUBROUTINE CNTRCTG3211(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(20,4,0:3)
      REAL(DOUBLE)  :: VRRS(13,1,0:2,3)
      REAL(DOUBLE)  :: HRRS(13,1,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
