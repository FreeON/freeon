...
SUBROUTINE dIntB3030202(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      REAL(DOUBLE), DIMENSION(10,18,4) :: HRR 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Dont need to generate (d,0|sp,sp)
      ! Dont need to generate (f,0|sp,sp)^a
      ! Dont need to generate (f,0|sp,sp)^b
      ! Dont need to generate (d,0|spd,sp)^c
