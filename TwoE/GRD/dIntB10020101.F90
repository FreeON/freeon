...
! ---------------------------------------------------------- 
SUBROUTINE dIntB10020101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(45,1,1) :: HRR 
      REAL(DOUBLE), DIMENSION(56,1,1) :: HRRA,HRRB 
      REAL(DOUBLE), DIMENSION(45,4,1) :: HRRC 
      REAL(DOUBLE)  :: VRR(56,4,0:5)
      REAL(DOUBLE)  :: VRRS(45,1,0:4,3)
      REAL(DOUBLE)  :: HRRS(45,1,1,9)
      ...
      CALL InitDbl(45*4,HRRC(1,1,1))
      CALL InitDbl(9*1*45*1,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ENDIF
            ! Contracting ... 
            CALL CNTRCTG10211(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                     & VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Dont need to generate (<>CType[11]<>,0|s,s)
      ! Dont need to generate (<>CType[16]<>,0|s,s)^a
      ! Dont need to generate (<>CType[16]<>,0|s,s)^b
      ! Dont need to generate (<>CType[11]<>,0|p,s)^c
      ...
      ENDDO 
      ENDDO 
   END SUBROUTINE dIntB10020101
    SUBROUTINE CNTRCTG10211(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,4,0:5)
      REAL(DOUBLE)  :: VRRS(45,1,0:4,3)
      REAL(DOUBLE)  :: HRRS(45,1,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
