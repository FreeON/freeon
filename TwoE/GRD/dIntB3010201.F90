...
SUBROUTINE dIntB3010201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      ! Generating (p,0|sp,s)
      CALL KetHRR21(4,HRR) 
      ! Generating (d,0|sp,s)^a
      CALL KetHRR21(4,HRRA) 
      ! Generating (d,0|sp,s)^b
      CALL KetHRR21(4,HRRB) 
      ! Generating (p,0|spd,s)^c
