...
SUBROUTINE dIntB3010201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(4,5,0:2,3)
      REAL(DOUBLE)  :: HRRS(4,5,1,9)
      ...
      CALL InitDbl(9*1*4*5,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      ! Stress: No need to generate [p,0|sp,s] 
      DO L=1,1
   ...
   END SUBROUTINE dIntB3010201
    SUBROUTINE CNTRCTG3121(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(10,10,0:3)
      REAL(DOUBLE)  :: VRRS(4,5,0:2,3)
      REAL(DOUBLE)  :: HRRS(4,5,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
