 ...
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ENDIF
            ! Generating (p0|s0)^(2)
            CALL VRRp0s0(10,10,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|s0)^(1)
            CALL VRRp0s0(10,10,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|s0)^(0)
            CALL VRRp0s0(10,10,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|s0)^(1)
            CALL VRRd0s0(10,10,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|s0)^(0)
            CALL VRRd0s0(10,10,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|p0)^(2)
            CALL VRRs0p0(10,10,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|p0)^(1)
            CALL VRRs0p0(10,10,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|p0)^(0)
            CALL VRRs0p0(10,10,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|p0)^(1)
            CALL VRRp0p0(10,10,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|p0)^(0)
            CALL VRRp0p0(10,10,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|p0)^(0)
            ...
            CALL DBLAXPZY(40,HRRA(1,1,1),Alpha,VRR(1,1,0)) 
            CALL DBLAXPZY(40,HRRB(1,1,1),Beta, VRR(1,1,0)) 
            CALL DBLAXPZY(100,HRRC(1,1,1),Gamma,VRR(1,1,0)) 
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
