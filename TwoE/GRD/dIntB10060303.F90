...
SUBROUTINE dIntB10060303(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      REAL(DOUBLE), DIMENSION(56,16,4) :: HRR 
      REAL(DOUBLE), DIMENSION(84,16,4) :: HRRA,HRRB 
      ...
      EXTERNAL InitDbl
      CALL InitDbl(56*16,HRR(1,1,1))
      CALL InitDbl(84*16,HRRA(1,1,1))
      CALL InitDbl(84*16,HRRB(1,1,1))
      ...
      ! Generating (h,0|<>CType[5]<>,p)^c
      CALL KetHRR53(56,HRRC) 
      DO L=2,4
    ...
    SUBROUTINE CNTRCTG10633(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC)
      USE DerivedTypes
      USE VScratchB
      INTEGER :: K
      REAL(DOUBLE)  :: Alpha,Beta,Gamma
