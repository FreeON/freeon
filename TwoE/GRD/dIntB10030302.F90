...
SUBROUTINE dIntB10030302(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(35,13,0:6,3)
      REAL(DOUBLE)  :: HRRS(35,13,4,9)
      ...
      CALL InitDbl(9*4*35*13,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO IJ=1,9
        CALL KetHRR32(35,HRRS(1,1,1,IJ)) 
      ENDDO
      DO L=1,4
   ...
   END SUBROUTINE dIntB10030302
    SUBROUTINE CNTRCTG10332(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,20,0:7)
      REAL(DOUBLE)  :: VRRS(35,13,0:6,3)
      REAL(DOUBLE)  :: HRRS(35,13,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,10
