! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f sp|f s) 
! ---------------------------------------------------------- 
SUBROUTINE dIntB10021001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(45,20,0:7,3)
      REAL(DOUBLE)  :: HRRS(45,20,1,9)
      ...
      CALL InitDbl(9*1*45*20,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            CALL MVRRf0s0(1,35,20,VRRS(1,1,4,1),VRRS(1,1,5,1),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ...
            CALL MVRRd0p0(1,35,20,VRRS(1,1,4,1),VRRS(1,1,5,1),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ...
            CALL MVRRp0d0(1,35,20,VRRS(1,1,4,1),VRRS(1,1,5,1),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(1,35,20,VRRS(1,1,4,1),VRRS(1,1,5,1),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(1,35,20,VRRS(1,1,3,1),VRRS(1,1,4,1),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(1,35,20,VRRS(1,1,2,1),VRRS(1,1,3,1),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(1,35,20,VRRS(1,1,1,1),VRRS(1,1,2,1),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(1,35,20,VRRS(1,1,0,1),VRRS(1,1,1,1),56,35,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(2,35,20,VRRS(1,1,4,2),VRRS(1,1,5,2),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(6)
            ...
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(2,35,20,VRRS(1,1,4,2),VRRS(1,1,5,2),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(5)
            ...
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(2,35,20,VRRS(1,1,4,2),VRRS(1,1,5,2),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(2,35,20,VRRS(1,1,4,2),VRRS(1,1,5,2),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(2,35,20,VRRS(1,1,3,2),VRRS(1,1,4,2),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(2,35,20,VRRS(1,1,2,2),VRRS(1,1,3,2),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(2,35,20,VRRS(1,1,1,2),VRRS(1,1,2,2),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(2,35,20,VRRS(1,1,0,2),VRRS(1,1,1,2),56,35,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(3,35,20,VRRS(1,1,4,3),VRRS(1,1,5,3),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(6)
            ...
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(3,35,20,VRRS(1,1,4,3),VRRS(1,1,5,3),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(5)
            ...
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(3,35,20,VRRS(1,1,4,3),VRRS(1,1,5,3),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(3,35,20,VRRS(1,1,4,3),VRRS(1,1,5,3),56,35,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(3,35,20,VRRS(1,1,3,3),VRRS(1,1,4,3),56,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(3,35,20,VRRS(1,1,2,3),VRRS(1,1,3,3),56,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(3,35,20,VRRS(1,1,1,3),VRRS(1,1,2,3),56,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(3,35,20,VRRS(1,1,0,3),VRRS(1,1,1,3),56,35,VRR(1,1,1))
            ENDIF
            ! Contracting ... 
            CALL CNTRCTG102101(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
      ...
      ENDDO 
      ENDDO 
   END SUBROUTINE dIntB10021001
    SUBROUTINE CNTRCTG102101(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,35,0:8)
      REAL(DOUBLE)  :: VRRS(45,20,0:7,3)
      REAL(DOUBLE)  :: HRRS(45,20,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,20
