...
! ---------------------------------------------------------- 
SUBROUTINE dIntB10020302(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      CALL InitDbl(9*4*45*13,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ENDIF
            ! Contracting ... 
            CALL CNTRCTG10232(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                     & VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (<>CType[11]<>,0|p,sp)
      CALL KetHRR32(45,HRR) 
      ! Generating (<>CType[16]<>,0|p,sp)^a
      CALL KetHRR32(56,HRRA) 
      ! Generating (<>CType[16]<>,0|p,sp)^b
      CALL KetHRR32(56,HRRB) 
      ! Generating (<>CType[11]<>,0|d,sp)^c
      CALL KetHRR62(45,HRRC) 
      ! Stress: Generating [f,0|p,sp] 
      DO IJ=1,9
        CALL KetHRR32(45,HRRS(1,1,1,IJ)) 
      ENDDO
      DO L=1,4
      ...
      ENDDO 
      ENDDO 
   END SUBROUTINE dIntB10020302
    SUBROUTINE CNTRCTG10232(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,20,0:7)
      REAL(DOUBLE)  :: VRRS(45,13,0:6,3)
      REAL(DOUBLE)  :: HRRS(45,13,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,10
