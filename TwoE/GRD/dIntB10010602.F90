! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f s|d sp) 
! ---------------------------------------------------------- 
SUBROUTINE dIntB10010602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      REAL(DOUBLE), DIMENSION(20,26,4) :: HRR 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCTG10162(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (f,0|d,sp)
      CALL KetHRR62(20,HRR) 
      ! Generating (g,0|d,sp)^a
      CALL KetHRR62(35,HRRA) 
      ! Generating (g,0|d,sp)^b
      CALL KetHRR62(35,HRRB) 
      ! Generating (f,0|f,sp)^c
      CALL KetHRR102(20,HRRC) 
      DO L=1,4
         ...
         CALL BraHRR101cd(NINT,LDA,LDB,OA,OB,GOA,GOB,GOC,GOD,CDOffSet,2,HRRTmp,GRADIENTS(1,1))
      ENDDO 
    END SUBROUTINE dIntB10010602
    SUBROUTINE CNTRCTG10162(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC)
      USE DerivedTypes
      USE VScratchB
      INTEGER :: K
      REAL(DOUBLE)  :: Alpha,Beta,Gamma
