...
SUBROUTINE dIntB6020601(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(26,10,0:5,3)
      REAL(DOUBLE)  :: HRRS(26,10,1,9)
      ...
      CALL InitDbl(9*1*26*10,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            CALL MVRRf0s0(1,20,10,VRRS(1,1,2,1),VRRS(1,1,3,1),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(1,20,10,VRRS(1,1,1,1),VRRS(1,1,2,1),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(1,20,10,VRRS(1,1,0,1),VRRS(1,1,1,1),35,20,VRR(1,1,1))
            ...
            CALL MVRRd0p0(1,20,10,VRRS(1,1,2,1),VRRS(1,1,3,1),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(1,20,10,VRRS(1,1,1,1),VRRS(1,1,2,1),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(1,20,10,VRRS(1,1,0,1),VRRS(1,1,1,1),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(1,20,10,VRRS(1,1,1,1),VRRS(1,1,2,1),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(1,20,10,VRRS(1,1,0,1),VRRS(1,1,1,1),35,20,VRR(1,1,1))
            ...
            CALL MVRRp0d0(1,20,10,VRRS(1,1,2,1),VRRS(1,1,3,1),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(1,20,10,VRRS(1,1,1,1),VRRS(1,1,2,1),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(1,20,10,VRRS(1,1,0,1),VRRS(1,1,1,1),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(1,20,10,VRRS(1,1,1,1),VRRS(1,1,2,1),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(1,20,10,VRRS(1,1,0,1),VRRS(1,1,1,1),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(1,20,10,VRRS(1,1,0,1),VRRS(1,1,1,1),35,20,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(2,20,10,VRRS(1,1,2,2),VRRS(1,1,3,2),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(2,20,10,VRRS(1,1,1,2),VRRS(1,1,2,2),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(2,20,10,VRRS(1,1,0,2),VRRS(1,1,1,2),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(4)
            ...
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(2,20,10,VRRS(1,1,2,2),VRRS(1,1,3,2),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(2,20,10,VRRS(1,1,1,2),VRRS(1,1,2,2),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(2,20,10,VRRS(1,1,0,2),VRRS(1,1,1,2),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(2,20,10,VRRS(1,1,1,2),VRRS(1,1,2,2),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(2,20,10,VRRS(1,1,0,2),VRRS(1,1,1,2),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(3)
            ...
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(2,20,10,VRRS(1,1,2,2),VRRS(1,1,3,2),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(2,20,10,VRRS(1,1,1,2),VRRS(1,1,2,2),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(2,20,10,VRRS(1,1,0,2),VRRS(1,1,1,2),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(2,20,10,VRRS(1,1,1,2),VRRS(1,1,2,2),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(2,20,10,VRRS(1,1,0,2),VRRS(1,1,1,2),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(2,20,10,VRRS(1,1,0,2),VRRS(1,1,1,2),35,20,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(3,20,10,VRRS(1,1,2,3),VRRS(1,1,3,3),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(3,20,10,VRRS(1,1,1,3),VRRS(1,1,2,3),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(3,20,10,VRRS(1,1,0,3),VRRS(1,1,1,3),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(4)
            ...
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(3,20,10,VRRS(1,1,2,3),VRRS(1,1,3,3),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(3,20,10,VRRS(1,1,1,3),VRRS(1,1,2,3),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(3,20,10,VRRS(1,1,0,3),VRRS(1,1,1,3),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(3,20,10,VRRS(1,1,1,3),VRRS(1,1,2,3),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(3,20,10,VRRS(1,1,0,3),VRRS(1,1,1,3),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(3)
            ...
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(3,20,10,VRRS(1,1,2,3),VRRS(1,1,3,3),35,20,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(3,20,10,VRRS(1,1,1,3),VRRS(1,1,2,3),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(3,20,10,VRRS(1,1,0,3),VRRS(1,1,1,3),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(3,20,10,VRRS(1,1,1,3),VRRS(1,1,2,3),35,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(3,20,10,VRRS(1,1,0,3),VRRS(1,1,1,3),35,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(3,20,10,VRRS(1,1,0,3),VRRS(1,1,1,3),35,20,VRR(1,1,1))
            ENDIF
            ! Contracting ... 
   ...
   END SUBROUTINE dIntB6020601
    SUBROUTINE CNTRCTG6261(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(35,20,0:6)
      REAL(DOUBLE)  :: VRRS(26,10,0:5,3)
      REAL(DOUBLE)  :: HRRS(26,10,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,10
