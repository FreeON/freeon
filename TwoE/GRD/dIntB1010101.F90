 ...
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL DBLAXPY(1,HRR(1,1,1),VRR(1,1,0)) 
            CALL DBLAXPZY(4,HRRA(1,1,1),Alpha,VRR(1,1,0)) 
            CALL DBLAXPZY(4,HRRB(1,1,1),Beta, VRR(1,1,0)) 
      ...
      DO L=1,1
         ...
         CALL BraHRR11cd(NINT,LDA,LDB,OA,OB,GOA,GOB,GOC,GOD,CDOffSet,3,HRRC(1,4,L),GRADIENTS(1,1))
      ENDDO 
