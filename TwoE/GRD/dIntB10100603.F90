...
! ----------------------------------------------------------
SUBROUTINE dIntB10100603(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(84,20,4) :: HRR
      REAL(DOUBLE), DIMENSION(120,20,4) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(84,35,4) :: HRRC
      REAL(DOUBLE)  :: VRR(120,35,0:10)
      REAL(DOUBLE)  :: VRRS(84,20,0:9,3)
      REAL(DOUBLE)  :: HRRS(84,20,4,9)
      ...
      CALL InitDbl(9*4*84*20,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ENDIF
            ! Contracting ...
            CALL CNTRCTG101063(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (i,0|d,p)
      CALL KetHRR63(84,HRR)
      ! Generating (j,0|d,p)^a
      CALL KetHRR63(120,HRRA)
      ! Generating (j,0|d,p)^b
      CALL KetHRR63(120,HRRB)
      ! Generating (i,0|f,p)^c
      CALL KetHRR103(84,HRRC)
      ! Stress: Generating [f,0|d,p]
      DO IJ=1,9
        CALL KetHRR63(84,HRRS(1,1,1,IJ))
      ENDDO
      DO L=2,4
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10100603
    SUBROUTINE CNTRCTG101063(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(120,35,0:10)
      REAL(DOUBLE)  :: VRRS(84,20,0:9,3)
      REAL(DOUBLE)  :: HRRS(84,20,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,20
