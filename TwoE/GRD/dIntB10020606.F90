...
SUBROUTINE dIntB10020606(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(45,35,0:8,3)
      REAL(DOUBLE)  :: HRRS(45,35,10,9)
      ...
      CALL InitDbl(9*10*45*35,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO IJ=1,9
        CALL KetHRR66(45,HRRS(1,1,1,IJ)) 
      ENDDO
      DO L=5,10
   ...
   END SUBROUTINE dIntB10020606
    SUBROUTINE CNTRCTG10266(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,56,0:9)
      REAL(DOUBLE)  :: VRRS(45,35,0:8,3)
      REAL(DOUBLE)  :: HRRS(45,35,10,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,35
