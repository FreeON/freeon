! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (p sp|p s) 
! ---------------------------------------------------------- 
SUBROUTINE dIntB3020301(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      REAL(DOUBLE), DIMENSION(13,4,1) :: HRR 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Dont need to generate (spd,0|p,s)
      ! Dont need to generate (spdf,0|p,s)^a
      ! Dont need to generate (spdf,0|p,s)^b
      ! Dont need to generate (spd,0|d,s)^c
      DO L=1,1
