! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (d sp|p sp) 
! ---------------------------------------------------------- 
SUBROUTINE dIntB6020302(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      REAL(DOUBLE), DIMENSION(26,13,4) :: HRR 
      REAL(DOUBLE), DIMENSION(35,13,4) :: HRRA,HRRB 
      ...
      EXTERNAL InitDbl
      CALL InitDbl(26*13,HRR(1,1,1))
      CALL InitDbl(35*13,HRRA(1,1,1))
      CALL InitDbl(35*13,HRRB(1,1,1))
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCTG6232(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (spdf,0|p,sp)
      CALL KetHRR32(26,HRR) 
      ! Generating (<>CType[11]<>,0|p,sp)^a
      CALL KetHRR32(35,HRRA) 
      ! Generating (<>CType[11]<>,0|p,sp)^b
      CALL KetHRR32(35,HRRB) 
      ! Generating (spdf,0|d,sp)^c
      CALL KetHRR62(26,HRRC) 
      DO L=1,4
      ...
      ENDDO 
    END SUBROUTINE dIntB6020302
    SUBROUTINE CNTRCTG6232(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC)
      USE DerivedTypes
      USE VScratchB
      INTEGER :: K
      REAL(DOUBLE)  :: Alpha,Beta,Gamma
