...
SUBROUTINE dIntB10100602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(84,26,0:9,3)
      REAL(DOUBLE)  :: HRRS(84,26,4,9)
      ...
      CALL InitDbl(9*4*84*26,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      ! Stress: Generating [f,0|d,sp] 
      DO IJ=1,9
        CALL KetHRR62(84,HRRS(1,1,1,IJ)) 
      ENDDO
      DO L=1,4
   ...
   END SUBROUTINE dIntB10100602
    SUBROUTINE CNTRCTG101062(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(120,35,0:10)
      REAL(DOUBLE)  :: VRRS(84,26,0:9,3)
      REAL(DOUBLE)  :: HRRS(84,26,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,20
