...
! ---------------------------------------------------------- 
SUBROUTINE dIntB10020301(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      CALL InitDbl(9*1*45*4,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ENDIF
            ! Contracting ... 
            CALL CNTRCTG10231(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                     & VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Dont need to generate (<>CType[11]<>,0|p,s)
      ! Dont need to generate (<>CType[16]<>,0|p,s)^a
      ! Dont need to generate (<>CType[16]<>,0|p,s)^b
      ! Dont need to generate (<>CType[11]<>,0|d,s)^c
      ...
      ENDDO 
      ENDDO 
   END SUBROUTINE dIntB10020301
    SUBROUTINE CNTRCTG10231(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,10,0:6)
      REAL(DOUBLE)  :: VRRS(45,4,0:5,3)
      REAL(DOUBLE)  :: HRRS(45,4,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
