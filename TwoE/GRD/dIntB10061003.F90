...
! ----------------------------------------------------------
SUBROUTINE dIntB10061003(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(56,35,4) :: HRR
      REAL(DOUBLE), DIMENSION(84,35,4) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(56,56,4) :: HRRC
      REAL(DOUBLE)  :: VRR(84,56,0:10)
      REAL(DOUBLE)  :: VRRS(56,35,0:9,3)
      REAL(DOUBLE)  :: HRRS(56,35,4,9)
      ...
      CALL InitDbl(9*4*56*35,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ENDIF
            ! Contracting ...
            CALL CNTRCTG106103(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (h,0|f,p)
      CALL KetHRR103(56,HRR)
      ! Generating (i,0|f,p)^a
      CALL KetHRR103(84,HRRA)
      ! Generating (i,0|f,p)^b
      CALL KetHRR103(84,HRRB)
      ! Generating (h,0|g,p)^c
      CALL KetHRR153(56,HRRC)
      ! Stress: Generating [f,0|f,p]
      DO IJ=1,9
        CALL KetHRR103(56,HRRS(1,1,1,IJ))
      ENDDO
      DO L=2,4
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10061003
    SUBROUTINE CNTRCTG106103(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(84,56,0:10)
      REAL(DOUBLE)  :: VRRS(56,35,0:9,3)
      REAL(DOUBLE)  :: HRRS(56,35,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,35
