...
!------------------------------------------------------------------------------
! ----------------------------------------------------------
! COMPUTES THE INTEGRAL CLASS (f f|f d)
! ----------------------------------------------------------
SUBROUTINE dIntB10101006(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(84,56,10) :: HRR
      REAL(DOUBLE), DIMENSION(120,56,10) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(84,84,10) :: HRRC
      REAL(DOUBLE)  :: VRR(120,84,0:12)
      REAL(DOUBLE)  :: VRRS(84,56,0:11,3)
      REAL(DOUBLE)  :: HRRS(84,56,10,9)
      REAL(DOUBLE)  :: TOm,PQJ(3),FP(9)
      INTEGER       :: OffSet,OA,LDA,GOA,OB,LDB,GOB,OC,LDC,GOC,OD,LDD,GOD,I,J,K,L,IJ
      EXTERNAL InitDbl
      CALL InitDbl(84*56,HRR(1,1,1))
      CALL InitDbl(120*56,HRRA(1,1,1))
      CALL InitDbl(120*56,HRRB(1,1,1))
      CALL InitDbl(84*84,HRRC(1,1,1))
      CALL InitDbl(9*10*84*56,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            IF(T<Gamma_Switch)THEN
              ...
              ET=EXP(-T)
              TwoT=Two*T
              W12=(F12_0(L)+T*(F12_1(L)+T*(F12_2(L)+T*(F12_3(L)+T*F12_4(L)))))
            ...
            ! Generating (f0|s0)^(9)
            CALL VRRf0s0(120,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (f0|s0)^(8)
            CALL VRRf0s0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (f0|s0)^(7)
            CALL VRRf0s0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (f0|s0)^(6)
            CALL VRRf0s0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (f0|s0)^(5)
            CALL VRRf0s0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|s0)^(4)
            CALL VRRf0s0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|s0)^(3)
            CALL VRRf0s0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|s0)^(2)
            CALL VRRf0s0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|s0)^(1)
            CALL VRRf0s0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|s0)^(0)
            CALL VRRf0s0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|s0)^(8)
            CALL VRRg0s0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (g0|s0)^(7)
            CALL VRRg0s0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (g0|s0)^(6)
            CALL VRRg0s0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (g0|s0)^(5)
            CALL VRRg0s0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (g0|s0)^(4)
            CALL VRRg0s0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|s0)^(3)
            CALL VRRg0s0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|s0)^(2)
            CALL VRRg0s0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|s0)^(1)
            CALL VRRg0s0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|s0)^(0)
            CALL VRRg0s0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|s0)^(7)
            CALL VRRh0s0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (h0|s0)^(6)
            CALL VRRh0s0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (h0|s0)^(5)
            CALL VRRh0s0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (h0|s0)^(4)
            CALL VRRh0s0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (h0|s0)^(3)
            CALL VRRh0s0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|s0)^(2)
            CALL VRRh0s0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|s0)^(1)
            CALL VRRh0s0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|s0)^(0)
            CALL VRRh0s0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|s0)^(6)
            CALL VRRi0s0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (i0|s0)^(5)
            CALL VRRi0s0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (i0|s0)^(4)
            CALL VRRi0s0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (i0|s0)^(3)
            CALL VRRi0s0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (i0|s0)^(2)
            CALL VRRi0s0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (i0|s0)^(1)
            CALL VRRi0s0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|s0)^(0)
            CALL VRRi0s0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (j0|s0)^(5)
            CALL VRRj0s0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (j0|s0)^(4)
            CALL VRRj0s0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (j0|s0)^(3)
            CALL VRRj0s0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (j0|s0)^(2)
            CALL VRRj0s0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (j0|s0)^(1)
            CALL VRRj0s0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (j0|s0)^(0)
            CALL VRRj0s0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|p0)^(11)
            ...
            ! Generating (d0|p0)^(9)
            CALL VRRd0p0(120,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (d0|p0)^(8)
            CALL VRRd0p0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (d0|p0)^(7)
            CALL VRRd0p0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (d0|p0)^(6)
            CALL VRRd0p0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (d0|p0)^(5)
            CALL VRRd0p0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|p0)^(4)
            CALL VRRd0p0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|p0)^(3)
            CALL VRRd0p0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|p0)^(2)
            CALL VRRd0p0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|p0)^(1)
            CALL VRRd0p0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|p0)^(0)
            CALL VRRd0p0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|p0)^(8)
            CALL VRRf0p0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (f0|p0)^(7)
            CALL VRRf0p0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (f0|p0)^(6)
            CALL VRRf0p0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (f0|p0)^(5)
            CALL VRRf0p0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|p0)^(4)
            CALL VRRf0p0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|p0)^(3)
            CALL VRRf0p0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|p0)^(2)
            CALL VRRf0p0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|p0)^(1)
            CALL VRRf0p0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|p0)^(0)
            CALL VRRf0p0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|p0)^(7)
            CALL VRRg0p0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (g0|p0)^(6)
            CALL VRRg0p0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (g0|p0)^(5)
            CALL VRRg0p0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (g0|p0)^(4)
            CALL VRRg0p0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|p0)^(3)
            CALL VRRg0p0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|p0)^(2)
            CALL VRRg0p0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|p0)^(1)
            CALL VRRg0p0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|p0)^(0)
            CALL VRRg0p0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|p0)^(6)
            CALL VRRh0p0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (h0|p0)^(5)
            CALL VRRh0p0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (h0|p0)^(4)
            CALL VRRh0p0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (h0|p0)^(3)
            CALL VRRh0p0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|p0)^(2)
            CALL VRRh0p0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|p0)^(1)
            CALL VRRh0p0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|p0)^(0)
            CALL VRRh0p0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|p0)^(5)
            CALL VRRi0p0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (i0|p0)^(4)
            CALL VRRi0p0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (i0|p0)^(3)
            CALL VRRi0p0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (i0|p0)^(2)
            CALL VRRi0p0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (i0|p0)^(1)
            CALL VRRi0p0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|p0)^(0)
            CALL VRRi0p0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (j0|p0)^(4)
            CALL VRRj0p0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (j0|p0)^(3)
            CALL VRRj0p0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (j0|p0)^(2)
            CALL VRRj0p0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (j0|p0)^(1)
            CALL VRRj0p0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (j0|p0)^(0)
            CALL VRRj0p0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|d0)^(10)
            ...
            ! Generating (p0|d0)^(9)
            CALL VRRp0d0(120,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (p0|d0)^(8)
            CALL VRRp0d0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (p0|d0)^(7)
            CALL VRRp0d0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (p0|d0)^(6)
            CALL VRRp0d0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (p0|d0)^(5)
            CALL VRRp0d0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|d0)^(4)
            CALL VRRp0d0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|d0)^(3)
            CALL VRRp0d0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|d0)^(2)
            CALL VRRp0d0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|d0)^(1)
            CALL VRRp0d0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|d0)^(0)
            CALL VRRp0d0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|d0)^(8)
            CALL VRRd0d0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (d0|d0)^(7)
            CALL VRRd0d0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (d0|d0)^(6)
            CALL VRRd0d0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (d0|d0)^(5)
            CALL VRRd0d0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|d0)^(4)
            CALL VRRd0d0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|d0)^(3)
            CALL VRRd0d0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|d0)^(2)
            CALL VRRd0d0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|d0)^(1)
            CALL VRRd0d0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|d0)^(0)
            CALL VRRd0d0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|d0)^(7)
            CALL VRRf0d0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (f0|d0)^(6)
            CALL VRRf0d0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (f0|d0)^(5)
            CALL VRRf0d0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|d0)^(4)
            CALL VRRf0d0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|d0)^(3)
            CALL VRRf0d0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|d0)^(2)
            CALL VRRf0d0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|d0)^(1)
            CALL VRRf0d0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|d0)^(0)
            CALL VRRf0d0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|d0)^(6)
            CALL VRRg0d0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (g0|d0)^(5)
            CALL VRRg0d0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (g0|d0)^(4)
            CALL VRRg0d0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|d0)^(3)
            CALL VRRg0d0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|d0)^(2)
            CALL VRRg0d0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|d0)^(1)
            CALL VRRg0d0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|d0)^(0)
            CALL VRRg0d0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|d0)^(5)
            CALL VRRh0d0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (h0|d0)^(4)
            CALL VRRh0d0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (h0|d0)^(3)
            CALL VRRh0d0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|d0)^(2)
            CALL VRRh0d0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|d0)^(1)
            CALL VRRh0d0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|d0)^(0)
            CALL VRRh0d0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|d0)^(4)
            CALL VRRi0d0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (i0|d0)^(3)
            CALL VRRi0d0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (i0|d0)^(2)
            CALL VRRi0d0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (i0|d0)^(1)
            CALL VRRi0d0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|d0)^(0)
            CALL VRRi0d0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (j0|d0)^(3)
            CALL VRRj0d0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (j0|d0)^(2)
            CALL VRRj0d0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (j0|d0)^(1)
            CALL VRRj0d0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (j0|d0)^(0)
            CALL VRRj0d0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|f0)^(9)
            CALL VRRs0f0(120,84,VRR(1,1,9),VRR(1,1,10))
            ! Generating (s0|f0)^(8)
            CALL VRRs0f0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (s0|f0)^(7)
            CALL VRRs0f0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (s0|f0)^(6)
            CALL VRRs0f0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|f0)^(5)
            CALL VRRs0f0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|f0)^(4)
            CALL VRRs0f0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|f0)^(3)
            CALL VRRs0f0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|f0)^(2)
            CALL VRRs0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|f0)^(1)
            CALL VRRs0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|f0)^(0)
            CALL VRRs0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|f0)^(8)
            CALL VRRp0f0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (p0|f0)^(7)
            CALL VRRp0f0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (p0|f0)^(6)
            CALL VRRp0f0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (p0|f0)^(5)
            CALL VRRp0f0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|f0)^(4)
            CALL VRRp0f0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|f0)^(3)
            CALL VRRp0f0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|f0)^(2)
            CALL VRRp0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|f0)^(1)
            CALL VRRp0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|f0)^(0)
            CALL VRRp0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|f0)^(7)
            CALL VRRd0f0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (d0|f0)^(6)
            CALL VRRd0f0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (d0|f0)^(5)
            CALL VRRd0f0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|f0)^(4)
            CALL VRRd0f0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|f0)^(3)
            CALL VRRd0f0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|f0)^(2)
            CALL VRRd0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|f0)^(1)
            CALL VRRd0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|f0)^(0)
            CALL VRRd0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|f0)^(6)
            CALL VRRf0f0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (f0|f0)^(5)
            CALL VRRf0f0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|f0)^(4)
            CALL VRRf0f0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|f0)^(3)
            CALL VRRf0f0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|f0)^(2)
            CALL VRRf0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|f0)^(1)
            CALL VRRf0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|f0)^(0)
            CALL VRRf0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|f0)^(5)
            CALL VRRg0f0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (g0|f0)^(4)
            CALL VRRg0f0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|f0)^(3)
            CALL VRRg0f0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|f0)^(2)
            CALL VRRg0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|f0)^(1)
            CALL VRRg0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|f0)^(0)
            CALL VRRg0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|f0)^(4)
            CALL VRRh0f0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (h0|f0)^(3)
            CALL VRRh0f0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|f0)^(2)
            CALL VRRh0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|f0)^(1)
            CALL VRRh0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|f0)^(0)
            CALL VRRh0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|f0)^(3)
            CALL VRRi0f0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (i0|f0)^(2)
            CALL VRRi0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (i0|f0)^(1)
            CALL VRRi0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|f0)^(0)
            CALL VRRi0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (j0|f0)^(2)
            CALL VRRj0f0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (j0|f0)^(1)
            CALL VRRj0f0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (j0|f0)^(0)
            CALL VRRj0f0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|g0)^(8)
            CALL VRRs0g0(120,84,VRR(1,1,8),VRR(1,1,9))
            ! Generating (s0|g0)^(7)
            CALL VRRs0g0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (s0|g0)^(6)
            CALL VRRs0g0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|g0)^(5)
            CALL VRRs0g0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|g0)^(4)
            CALL VRRs0g0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|g0)^(3)
            CALL VRRs0g0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|g0)^(2)
            CALL VRRs0g0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|g0)^(1)
            CALL VRRs0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|g0)^(0)
            CALL VRRs0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|g0)^(7)
            CALL VRRp0g0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (p0|g0)^(6)
            CALL VRRp0g0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (p0|g0)^(5)
            CALL VRRp0g0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|g0)^(4)
            CALL VRRp0g0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|g0)^(3)
            CALL VRRp0g0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|g0)^(2)
            CALL VRRp0g0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|g0)^(1)
            CALL VRRp0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|g0)^(0)
            CALL VRRp0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|g0)^(6)
            CALL VRRd0g0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (d0|g0)^(5)
            CALL VRRd0g0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|g0)^(4)
            CALL VRRd0g0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|g0)^(3)
            CALL VRRd0g0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|g0)^(2)
            CALL VRRd0g0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|g0)^(1)
            CALL VRRd0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|g0)^(0)
            CALL VRRd0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|g0)^(5)
            CALL VRRf0g0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (f0|g0)^(4)
            CALL VRRf0g0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|g0)^(3)
            CALL VRRf0g0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|g0)^(2)
            CALL VRRf0g0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|g0)^(1)
            CALL VRRf0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|g0)^(0)
            CALL VRRf0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|g0)^(4)
            CALL VRRg0g0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (g0|g0)^(3)
            CALL VRRg0g0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|g0)^(2)
            CALL VRRg0g0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|g0)^(1)
            CALL VRRg0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|g0)^(0)
            CALL VRRg0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|g0)^(3)
            CALL VRRh0g0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (h0|g0)^(2)
            CALL VRRh0g0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|g0)^(1)
            CALL VRRh0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|g0)^(0)
            CALL VRRh0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|g0)^(2)
            CALL VRRi0g0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (i0|g0)^(1)
            CALL VRRi0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|g0)^(0)
            CALL VRRi0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (j0|g0)^(1)
            CALL VRRj0g0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (j0|g0)^(0)
            CALL VRRj0g0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|h0)^(7)
            CALL VRRs0h0(120,84,VRR(1,1,7),VRR(1,1,8))
            ! Generating (s0|h0)^(6)
            CALL VRRs0h0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|h0)^(5)
            CALL VRRs0h0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|h0)^(4)
            CALL VRRs0h0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|h0)^(3)
            CALL VRRs0h0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|h0)^(2)
            CALL VRRs0h0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|h0)^(1)
            CALL VRRs0h0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|h0)^(0)
            CALL VRRs0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|h0)^(6)
            CALL VRRp0h0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (p0|h0)^(5)
            CALL VRRp0h0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|h0)^(4)
            CALL VRRp0h0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|h0)^(3)
            CALL VRRp0h0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|h0)^(2)
            CALL VRRp0h0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|h0)^(1)
            CALL VRRp0h0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|h0)^(0)
            CALL VRRp0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|h0)^(5)
            CALL VRRd0h0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (d0|h0)^(4)
            CALL VRRd0h0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|h0)^(3)
            CALL VRRd0h0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|h0)^(2)
            CALL VRRd0h0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|h0)^(1)
            CALL VRRd0h0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|h0)^(0)
            CALL VRRd0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|h0)^(4)
            CALL VRRf0h0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (f0|h0)^(3)
            CALL VRRf0h0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|h0)^(2)
            CALL VRRf0h0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|h0)^(1)
            CALL VRRf0h0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|h0)^(0)
            CALL VRRf0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|h0)^(3)
            CALL VRRg0h0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (g0|h0)^(2)
            CALL VRRg0h0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|h0)^(1)
            CALL VRRg0h0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|h0)^(0)
            CALL VRRg0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|h0)^(2)
            CALL VRRh0h0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (h0|h0)^(1)
            CALL VRRh0h0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|h0)^(0)
            CALL VRRh0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|h0)^(1)
            CALL VRRi0h0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (i0|h0)^(0)
            CALL VRRi0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (j0|h0)^(0)
            CALL VRRj0h0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (s0|i0)^(6)
            CALL VRRs0i0(120,84,VRR(1,1,6),VRR(1,1,7))
            ! Generating (s0|i0)^(5)
            CALL VRRs0i0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (s0|i0)^(4)
            CALL VRRs0i0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (s0|i0)^(3)
            CALL VRRs0i0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (s0|i0)^(2)
            CALL VRRs0i0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (s0|i0)^(1)
            CALL VRRs0i0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (s0|i0)^(0)
            CALL VRRs0i0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (p0|i0)^(5)
            CALL VRRp0i0(120,84,VRR(1,1,5),VRR(1,1,6))
            ! Generating (p0|i0)^(4)
            CALL VRRp0i0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (p0|i0)^(3)
            CALL VRRp0i0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (p0|i0)^(2)
            CALL VRRp0i0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (p0|i0)^(1)
            CALL VRRp0i0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (p0|i0)^(0)
            CALL VRRp0i0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (d0|i0)^(4)
            CALL VRRd0i0(120,84,VRR(1,1,4),VRR(1,1,5))
            ! Generating (d0|i0)^(3)
            CALL VRRd0i0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (d0|i0)^(2)
            CALL VRRd0i0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (d0|i0)^(1)
            CALL VRRd0i0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (d0|i0)^(0)
            CALL VRRd0i0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (f0|i0)^(3)
            CALL VRRf0i0(120,84,VRR(1,1,3),VRR(1,1,4))
            ! Generating (f0|i0)^(2)
            CALL VRRf0i0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (f0|i0)^(1)
            CALL VRRf0i0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (f0|i0)^(0)
            CALL VRRf0i0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (g0|i0)^(2)
            CALL VRRg0i0(120,84,VRR(1,1,2),VRR(1,1,3))
            ! Generating (g0|i0)^(1)
            CALL VRRg0i0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (g0|i0)^(0)
            CALL VRRg0i0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (h0|i0)^(1)
            CALL VRRh0i0(120,84,VRR(1,1,1),VRR(1,1,2))
            ! Generating (h0|i0)^(0)
            CALL VRRh0i0(120,84,VRR(1,1,0),VRR(1,1,1))
            ! Generating (i0|i0)^(0)
            CALL VRRi0i0(120,84,VRR(1,1,0),VRR(1,1,1))
            ...
            CALL MVRRf0s0(1,84,56,VRRS(1,1,8,1),VRRS(1,1,9,1),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [f0|s0]^(7)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [f0|s0]^(6)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|s0]^(5)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(7)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [g0|s0]^(6)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [g0|s0]^(5)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|s0]^(4)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|s0]^(6)
            CALL MVRRh0s0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [h0|s0]^(5)
            CALL MVRRh0s0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [h0|s0]^(4)
            CALL MVRRh0s0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|s0]^(3)
            CALL MVRRh0s0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|s0]^(2)
            CALL MVRRh0s0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|s0]^(1)
            CALL MVRRh0s0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|s0]^(0)
            CALL MVRRh0s0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|s0]^(5)
            CALL MVRRi0s0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [i0|s0]^(4)
            CALL MVRRi0s0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [i0|s0]^(3)
            CALL MVRRi0s0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|s0]^(2)
            CALL MVRRi0s0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|s0]^(1)
            CALL MVRRi0s0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|s0]^(0)
            CALL MVRRi0s0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ...
            CALL MVRRd0p0(1,84,56,VRRS(1,1,8,1),VRRS(1,1,9,1),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [d0|p0]^(7)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [d0|p0]^(6)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|p0]^(5)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(7)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [f0|p0]^(6)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|p0]^(5)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|p0]^(4)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(6)
            CALL MVRRg0p0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [g0|p0]^(5)
            CALL MVRRg0p0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|p0]^(4)
            CALL MVRRg0p0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|p0]^(3)
            CALL MVRRg0p0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|p0]^(5)
            CALL MVRRh0p0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [h0|p0]^(4)
            CALL MVRRh0p0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|p0]^(3)
            CALL MVRRh0p0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|p0]^(2)
            CALL MVRRh0p0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|p0]^(1)
            CALL MVRRh0p0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|p0]^(0)
            CALL MVRRh0p0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|p0]^(4)
            CALL MVRRi0p0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [i0|p0]^(3)
            CALL MVRRi0p0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|p0]^(2)
            CALL MVRRi0p0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|p0]^(1)
            CALL MVRRi0p0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|p0]^(0)
            CALL MVRRi0p0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ...
            CALL MVRRp0d0(1,84,56,VRRS(1,1,8,1),VRRS(1,1,9,1),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [p0|d0]^(7)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [p0|d0]^(6)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|d0]^(5)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(7)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [d0|d0]^(6)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|d0]^(5)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|d0]^(4)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(6)
            CALL MVRRf0d0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|d0]^(5)
            CALL MVRRf0d0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|d0]^(4)
            CALL MVRRf0d0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|d0]^(3)
            CALL MVRRf0d0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(5)
            CALL MVRRg0d0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|d0]^(4)
            CALL MVRRg0d0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|d0]^(3)
            CALL MVRRg0d0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|d0]^(2)
            CALL MVRRg0d0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|d0]^(4)
            CALL MVRRh0d0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|d0]^(3)
            CALL MVRRh0d0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|d0]^(2)
            CALL MVRRh0d0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|d0]^(1)
            CALL MVRRh0d0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|d0]^(0)
            CALL MVRRh0d0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|d0]^(3)
            CALL MVRRi0d0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|d0]^(2)
            CALL MVRRi0d0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|d0]^(1)
            CALL MVRRi0d0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|d0]^(0)
            CALL MVRRi0d0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(8)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,8,1),VRRS(1,1,9,1),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [s0|f0]^(7)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [s0|f0]^(6)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|f0]^(5)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(7)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [p0|f0]^(6)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|f0]^(5)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|f0]^(4)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(6)
            CALL MVRRd0f0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|f0]^(5)
            CALL MVRRd0f0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|f0]^(4)
            CALL MVRRd0f0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|f0]^(3)
            CALL MVRRd0f0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(5)
            CALL MVRRf0f0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|f0]^(4)
            CALL MVRRf0f0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|f0]^(3)
            CALL MVRRf0f0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|f0]^(2)
            CALL MVRRf0f0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(4)
            CALL MVRRg0f0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|f0]^(3)
            CALL MVRRg0f0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|f0]^(2)
            CALL MVRRg0f0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|f0]^(1)
            CALL MVRRg0f0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|f0]^(3)
            CALL MVRRh0f0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|f0]^(2)
            CALL MVRRh0f0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|f0]^(1)
            CALL MVRRh0f0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|f0]^(0)
            CALL MVRRh0f0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|f0]^(2)
            CALL MVRRi0f0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|f0]^(1)
            CALL MVRRi0f0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|f0]^(0)
            CALL MVRRi0f0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|g0]^(7)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,7,1),VRRS(1,1,8,1),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [s0|g0]^(6)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|g0]^(5)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|g0]^(4)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|g0]^(3)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|g0]^(2)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|g0]^(1)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|g0]^(0)
            CALL MVRRs0g0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|g0]^(6)
            CALL MVRRp0g0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|g0]^(5)
            CALL MVRRp0g0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|g0]^(4)
            CALL MVRRp0g0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|g0]^(3)
            CALL MVRRp0g0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|g0]^(2)
            CALL MVRRp0g0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|g0]^(1)
            CALL MVRRp0g0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|g0]^(0)
            CALL MVRRp0g0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|g0]^(5)
            CALL MVRRd0g0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|g0]^(4)
            CALL MVRRd0g0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|g0]^(3)
            CALL MVRRd0g0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|g0]^(2)
            CALL MVRRd0g0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|g0]^(1)
            CALL MVRRd0g0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|g0]^(0)
            CALL MVRRd0g0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|g0]^(4)
            CALL MVRRf0g0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|g0]^(3)
            CALL MVRRf0g0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|g0]^(2)
            CALL MVRRf0g0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|g0]^(1)
            CALL MVRRf0g0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|g0]^(0)
            CALL MVRRf0g0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|g0]^(3)
            CALL MVRRg0g0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|g0]^(2)
            CALL MVRRg0g0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|g0]^(1)
            CALL MVRRg0g0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|g0]^(0)
            CALL MVRRg0g0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|g0]^(2)
            CALL MVRRh0g0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|g0]^(1)
            CALL MVRRh0g0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|g0]^(0)
            CALL MVRRh0g0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|g0]^(1)
            CALL MVRRi0g0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|g0]^(0)
            CALL MVRRi0g0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|h0]^(6)
            CALL MVRRs0h0(1,84,56,VRRS(1,1,6,1),VRRS(1,1,7,1),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|h0]^(5)
            CALL MVRRs0h0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|h0]^(4)
            CALL MVRRs0h0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|h0]^(3)
            CALL MVRRs0h0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|h0]^(2)
            CALL MVRRs0h0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|h0]^(1)
            CALL MVRRs0h0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|h0]^(0)
            CALL MVRRs0h0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|h0]^(5)
            CALL MVRRp0h0(1,84,56,VRRS(1,1,5,1),VRRS(1,1,6,1),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|h0]^(4)
            CALL MVRRp0h0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|h0]^(3)
            CALL MVRRp0h0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|h0]^(2)
            CALL MVRRp0h0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|h0]^(1)
            CALL MVRRp0h0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|h0]^(0)
            CALL MVRRp0h0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|h0]^(4)
            CALL MVRRd0h0(1,84,56,VRRS(1,1,4,1),VRRS(1,1,5,1),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|h0]^(3)
            CALL MVRRd0h0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|h0]^(2)
            CALL MVRRd0h0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|h0]^(1)
            CALL MVRRd0h0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|h0]^(0)
            CALL MVRRd0h0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|h0]^(3)
            CALL MVRRf0h0(1,84,56,VRRS(1,1,3,1),VRRS(1,1,4,1),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|h0]^(2)
            CALL MVRRf0h0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|h0]^(1)
            CALL MVRRf0h0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|h0]^(0)
            CALL MVRRf0h0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|h0]^(2)
            CALL MVRRg0h0(1,84,56,VRRS(1,1,2,1),VRRS(1,1,3,1),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|h0]^(1)
            CALL MVRRg0h0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|h0]^(0)
            CALL MVRRg0h0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|h0]^(1)
            CALL MVRRh0h0(1,84,56,VRRS(1,1,1,1),VRRS(1,1,2,1),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|h0]^(0)
            CALL MVRRh0h0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|h0]^(0)
            CALL MVRRi0h0(1,84,56,VRRS(1,1,0,1),VRRS(1,1,1,1),120,84,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(8)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,8,2),VRRS(1,1,9,2),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [f0|s0]^(7)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [f0|s0]^(6)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|s0]^(5)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(7)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [g0|s0]^(6)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [g0|s0]^(5)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|s0]^(4)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|s0]^(6)
            CALL MVRRh0s0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [h0|s0]^(5)
            CALL MVRRh0s0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [h0|s0]^(4)
            CALL MVRRh0s0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|s0]^(3)
            CALL MVRRh0s0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|s0]^(2)
            CALL MVRRh0s0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|s0]^(1)
            CALL MVRRh0s0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|s0]^(0)
            CALL MVRRh0s0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|s0]^(5)
            CALL MVRRi0s0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [i0|s0]^(4)
            CALL MVRRi0s0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [i0|s0]^(3)
            CALL MVRRi0s0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|s0]^(2)
            CALL MVRRi0s0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|s0]^(1)
            CALL MVRRi0s0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|s0]^(0)
            CALL MVRRi0s0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(10)
            ...
            ! MIC-VRR: Generating [d0|p0]^(8)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,8,2),VRRS(1,1,9,2),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [d0|p0]^(7)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [d0|p0]^(6)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|p0]^(5)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(7)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [f0|p0]^(6)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|p0]^(5)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|p0]^(4)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(6)
            CALL MVRRg0p0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [g0|p0]^(5)
            CALL MVRRg0p0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|p0]^(4)
            CALL MVRRg0p0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|p0]^(3)
            CALL MVRRg0p0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|p0]^(5)
            CALL MVRRh0p0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [h0|p0]^(4)
            CALL MVRRh0p0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|p0]^(3)
            CALL MVRRh0p0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|p0]^(2)
            CALL MVRRh0p0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|p0]^(1)
            CALL MVRRh0p0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|p0]^(0)
            CALL MVRRh0p0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|p0]^(4)
            CALL MVRRi0p0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [i0|p0]^(3)
            CALL MVRRi0p0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|p0]^(2)
            CALL MVRRi0p0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|p0]^(1)
            CALL MVRRi0p0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|p0]^(0)
            CALL MVRRi0p0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(9)
            ...
            ! MIC-VRR: Generating [p0|d0]^(8)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,8,2),VRRS(1,1,9,2),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [p0|d0]^(7)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [p0|d0]^(6)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|d0]^(5)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(7)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [d0|d0]^(6)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|d0]^(5)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|d0]^(4)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(6)
            CALL MVRRf0d0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|d0]^(5)
            CALL MVRRf0d0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|d0]^(4)
            CALL MVRRf0d0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|d0]^(3)
            CALL MVRRf0d0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(5)
            CALL MVRRg0d0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|d0]^(4)
            CALL MVRRg0d0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|d0]^(3)
            CALL MVRRg0d0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|d0]^(2)
            CALL MVRRg0d0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|d0]^(4)
            CALL MVRRh0d0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|d0]^(3)
            CALL MVRRh0d0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|d0]^(2)
            CALL MVRRh0d0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|d0]^(1)
            CALL MVRRh0d0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|d0]^(0)
            CALL MVRRh0d0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|d0]^(3)
            CALL MVRRi0d0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|d0]^(2)
            CALL MVRRi0d0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|d0]^(1)
            CALL MVRRi0d0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|d0]^(0)
            CALL MVRRi0d0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(8)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,8,2),VRRS(1,1,9,2),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [s0|f0]^(7)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [s0|f0]^(6)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|f0]^(5)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(7)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [p0|f0]^(6)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|f0]^(5)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|f0]^(4)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(6)
            CALL MVRRd0f0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|f0]^(5)
            CALL MVRRd0f0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|f0]^(4)
            CALL MVRRd0f0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|f0]^(3)
            CALL MVRRd0f0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(5)
            CALL MVRRf0f0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|f0]^(4)
            CALL MVRRf0f0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|f0]^(3)
            CALL MVRRf0f0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|f0]^(2)
            CALL MVRRf0f0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(4)
            CALL MVRRg0f0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|f0]^(3)
            CALL MVRRg0f0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|f0]^(2)
            CALL MVRRg0f0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|f0]^(1)
            CALL MVRRg0f0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|f0]^(3)
            CALL MVRRh0f0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|f0]^(2)
            CALL MVRRh0f0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|f0]^(1)
            CALL MVRRh0f0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|f0]^(0)
            CALL MVRRh0f0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|f0]^(2)
            CALL MVRRi0f0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|f0]^(1)
            CALL MVRRi0f0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|f0]^(0)
            CALL MVRRi0f0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|g0]^(7)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,7,2),VRRS(1,1,8,2),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [s0|g0]^(6)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|g0]^(5)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|g0]^(4)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|g0]^(3)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|g0]^(2)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|g0]^(1)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|g0]^(0)
            CALL MVRRs0g0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|g0]^(6)
            CALL MVRRp0g0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|g0]^(5)
            CALL MVRRp0g0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|g0]^(4)
            CALL MVRRp0g0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|g0]^(3)
            CALL MVRRp0g0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|g0]^(2)
            CALL MVRRp0g0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|g0]^(1)
            CALL MVRRp0g0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|g0]^(0)
            CALL MVRRp0g0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|g0]^(5)
            CALL MVRRd0g0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|g0]^(4)
            CALL MVRRd0g0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|g0]^(3)
            CALL MVRRd0g0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|g0]^(2)
            CALL MVRRd0g0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|g0]^(1)
            CALL MVRRd0g0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|g0]^(0)
            CALL MVRRd0g0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|g0]^(4)
            CALL MVRRf0g0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|g0]^(3)
            CALL MVRRf0g0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|g0]^(2)
            CALL MVRRf0g0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|g0]^(1)
            CALL MVRRf0g0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|g0]^(0)
            CALL MVRRf0g0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|g0]^(3)
            CALL MVRRg0g0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|g0]^(2)
            CALL MVRRg0g0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|g0]^(1)
            CALL MVRRg0g0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|g0]^(0)
            CALL MVRRg0g0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|g0]^(2)
            CALL MVRRh0g0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|g0]^(1)
            CALL MVRRh0g0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|g0]^(0)
            CALL MVRRh0g0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|g0]^(1)
            CALL MVRRi0g0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|g0]^(0)
            CALL MVRRi0g0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|h0]^(6)
            CALL MVRRs0h0(2,84,56,VRRS(1,1,6,2),VRRS(1,1,7,2),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|h0]^(5)
            CALL MVRRs0h0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|h0]^(4)
            CALL MVRRs0h0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|h0]^(3)
            CALL MVRRs0h0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|h0]^(2)
            CALL MVRRs0h0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|h0]^(1)
            CALL MVRRs0h0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|h0]^(0)
            CALL MVRRs0h0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|h0]^(5)
            CALL MVRRp0h0(2,84,56,VRRS(1,1,5,2),VRRS(1,1,6,2),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|h0]^(4)
            CALL MVRRp0h0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|h0]^(3)
            CALL MVRRp0h0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|h0]^(2)
            CALL MVRRp0h0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|h0]^(1)
            CALL MVRRp0h0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|h0]^(0)
            CALL MVRRp0h0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|h0]^(4)
            CALL MVRRd0h0(2,84,56,VRRS(1,1,4,2),VRRS(1,1,5,2),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|h0]^(3)
            CALL MVRRd0h0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|h0]^(2)
            CALL MVRRd0h0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|h0]^(1)
            CALL MVRRd0h0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|h0]^(0)
            CALL MVRRd0h0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|h0]^(3)
            CALL MVRRf0h0(2,84,56,VRRS(1,1,3,2),VRRS(1,1,4,2),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|h0]^(2)
            CALL MVRRf0h0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|h0]^(1)
            CALL MVRRf0h0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|h0]^(0)
            CALL MVRRf0h0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|h0]^(2)
            CALL MVRRg0h0(2,84,56,VRRS(1,1,2,2),VRRS(1,1,3,2),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|h0]^(1)
            CALL MVRRg0h0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|h0]^(0)
            CALL MVRRg0h0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|h0]^(1)
            CALL MVRRh0h0(2,84,56,VRRS(1,1,1,2),VRRS(1,1,2,2),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|h0]^(0)
            CALL MVRRh0h0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|h0]^(0)
            CALL MVRRi0h0(2,84,56,VRRS(1,1,0,2),VRRS(1,1,1,2),120,84,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(8)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,8,3),VRRS(1,1,9,3),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [f0|s0]^(7)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [f0|s0]^(6)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|s0]^(5)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(7)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [g0|s0]^(6)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [g0|s0]^(5)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|s0]^(4)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|s0]^(6)
            CALL MVRRh0s0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [h0|s0]^(5)
            CALL MVRRh0s0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [h0|s0]^(4)
            CALL MVRRh0s0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|s0]^(3)
            CALL MVRRh0s0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|s0]^(2)
            CALL MVRRh0s0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|s0]^(1)
            CALL MVRRh0s0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|s0]^(0)
            CALL MVRRh0s0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|s0]^(5)
            CALL MVRRi0s0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [i0|s0]^(4)
            CALL MVRRi0s0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [i0|s0]^(3)
            CALL MVRRi0s0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|s0]^(2)
            CALL MVRRi0s0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|s0]^(1)
            CALL MVRRi0s0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|s0]^(0)
            CALL MVRRi0s0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(10)
            ...
            ! MIC-VRR: Generating [d0|p0]^(8)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,8,3),VRRS(1,1,9,3),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [d0|p0]^(7)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [d0|p0]^(6)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|p0]^(5)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(7)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [f0|p0]^(6)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|p0]^(5)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|p0]^(4)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(6)
            CALL MVRRg0p0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [g0|p0]^(5)
            CALL MVRRg0p0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|p0]^(4)
            CALL MVRRg0p0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|p0]^(3)
            CALL MVRRg0p0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|p0]^(5)
            CALL MVRRh0p0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [h0|p0]^(4)
            CALL MVRRh0p0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|p0]^(3)
            CALL MVRRh0p0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|p0]^(2)
            CALL MVRRh0p0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|p0]^(1)
            CALL MVRRh0p0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|p0]^(0)
            CALL MVRRh0p0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|p0]^(4)
            CALL MVRRi0p0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [i0|p0]^(3)
            CALL MVRRi0p0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|p0]^(2)
            CALL MVRRi0p0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|p0]^(1)
            CALL MVRRi0p0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|p0]^(0)
            CALL MVRRi0p0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(9)
            ...
            ! MIC-VRR: Generating [p0|d0]^(8)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,8,3),VRRS(1,1,9,3),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [p0|d0]^(7)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [p0|d0]^(6)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|d0]^(5)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(7)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [d0|d0]^(6)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|d0]^(5)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|d0]^(4)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(6)
            CALL MVRRf0d0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|d0]^(5)
            CALL MVRRf0d0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|d0]^(4)
            CALL MVRRf0d0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|d0]^(3)
            CALL MVRRf0d0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(5)
            CALL MVRRg0d0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|d0]^(4)
            CALL MVRRg0d0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|d0]^(3)
            CALL MVRRg0d0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|d0]^(2)
            CALL MVRRg0d0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|d0]^(4)
            CALL MVRRh0d0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|d0]^(3)
            CALL MVRRh0d0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|d0]^(2)
            CALL MVRRh0d0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|d0]^(1)
            CALL MVRRh0d0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|d0]^(0)
            CALL MVRRh0d0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|d0]^(3)
            CALL MVRRi0d0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|d0]^(2)
            CALL MVRRi0d0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|d0]^(1)
            CALL MVRRi0d0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|d0]^(0)
            CALL MVRRi0d0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(8)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,8,3),VRRS(1,1,9,3),120,84,VRR(1,1,9))
            ! MIC-VRR: Generating [s0|f0]^(7)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [s0|f0]^(6)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|f0]^(5)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(7)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [p0|f0]^(6)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|f0]^(5)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|f0]^(4)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(6)
            CALL MVRRd0f0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|f0]^(5)
            CALL MVRRd0f0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|f0]^(4)
            CALL MVRRd0f0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|f0]^(3)
            CALL MVRRd0f0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(5)
            CALL MVRRf0f0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|f0]^(4)
            CALL MVRRf0f0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|f0]^(3)
            CALL MVRRf0f0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|f0]^(2)
            CALL MVRRf0f0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(4)
            CALL MVRRg0f0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|f0]^(3)
            CALL MVRRg0f0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|f0]^(2)
            CALL MVRRg0f0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|f0]^(1)
            CALL MVRRg0f0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|f0]^(3)
            CALL MVRRh0f0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|f0]^(2)
            CALL MVRRh0f0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|f0]^(1)
            CALL MVRRh0f0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|f0]^(0)
            CALL MVRRh0f0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|f0]^(2)
            CALL MVRRi0f0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|f0]^(1)
            CALL MVRRi0f0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|f0]^(0)
            CALL MVRRi0f0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|g0]^(7)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,7,3),VRRS(1,1,8,3),120,84,VRR(1,1,8))
            ! MIC-VRR: Generating [s0|g0]^(6)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|g0]^(5)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|g0]^(4)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|g0]^(3)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|g0]^(2)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|g0]^(1)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|g0]^(0)
            CALL MVRRs0g0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|g0]^(6)
            CALL MVRRp0g0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|g0]^(5)
            CALL MVRRp0g0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|g0]^(4)
            CALL MVRRp0g0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|g0]^(3)
            CALL MVRRp0g0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|g0]^(2)
            CALL MVRRp0g0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|g0]^(1)
            CALL MVRRp0g0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|g0]^(0)
            CALL MVRRp0g0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|g0]^(5)
            CALL MVRRd0g0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|g0]^(4)
            CALL MVRRd0g0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|g0]^(3)
            CALL MVRRd0g0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|g0]^(2)
            CALL MVRRd0g0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|g0]^(1)
            CALL MVRRd0g0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|g0]^(0)
            CALL MVRRd0g0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|g0]^(4)
            CALL MVRRf0g0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|g0]^(3)
            CALL MVRRf0g0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|g0]^(2)
            CALL MVRRf0g0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|g0]^(1)
            CALL MVRRf0g0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|g0]^(0)
            CALL MVRRf0g0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|g0]^(3)
            CALL MVRRg0g0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|g0]^(2)
            CALL MVRRg0g0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|g0]^(1)
            CALL MVRRg0g0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|g0]^(0)
            CALL MVRRg0g0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|g0]^(2)
            CALL MVRRh0g0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|g0]^(1)
            CALL MVRRh0g0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|g0]^(0)
            CALL MVRRh0g0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|g0]^(1)
            CALL MVRRi0g0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|g0]^(0)
            CALL MVRRi0g0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|h0]^(6)
            CALL MVRRs0h0(3,84,56,VRRS(1,1,6,3),VRRS(1,1,7,3),120,84,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|h0]^(5)
            CALL MVRRs0h0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|h0]^(4)
            CALL MVRRs0h0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|h0]^(3)
            CALL MVRRs0h0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|h0]^(2)
            CALL MVRRs0h0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|h0]^(1)
            CALL MVRRs0h0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|h0]^(0)
            CALL MVRRs0h0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|h0]^(5)
            CALL MVRRp0h0(3,84,56,VRRS(1,1,5,3),VRRS(1,1,6,3),120,84,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|h0]^(4)
            CALL MVRRp0h0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|h0]^(3)
            CALL MVRRp0h0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|h0]^(2)
            CALL MVRRp0h0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|h0]^(1)
            CALL MVRRp0h0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|h0]^(0)
            CALL MVRRp0h0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|h0]^(4)
            CALL MVRRd0h0(3,84,56,VRRS(1,1,4,3),VRRS(1,1,5,3),120,84,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|h0]^(3)
            CALL MVRRd0h0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|h0]^(2)
            CALL MVRRd0h0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|h0]^(1)
            CALL MVRRd0h0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|h0]^(0)
            CALL MVRRd0h0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|h0]^(3)
            CALL MVRRf0h0(3,84,56,VRRS(1,1,3,3),VRRS(1,1,4,3),120,84,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|h0]^(2)
            CALL MVRRf0h0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|h0]^(1)
            CALL MVRRf0h0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|h0]^(0)
            CALL MVRRf0h0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|h0]^(2)
            CALL MVRRg0h0(3,84,56,VRRS(1,1,2,3),VRRS(1,1,3,3),120,84,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|h0]^(1)
            CALL MVRRg0h0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|h0]^(0)
            CALL MVRRg0h0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|h0]^(1)
            CALL MVRRh0h0(3,84,56,VRRS(1,1,1,3),VRRS(1,1,2,3),120,84,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|h0]^(0)
            CALL MVRRh0h0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|h0]^(0)
            CALL MVRRi0h0(3,84,56,VRRS(1,1,0,3),VRRS(1,1,1,3),120,84,VRR(1,1,1))
            ENDIF
            ! Contracting ...
            CALL CNTRCTG1010106(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (i,0|f,d)
      CALL KetHRR106(84,HRR)
      ! Generating (j,0|f,d)^a
      CALL KetHRR106(120,HRRA)
      ! Generating (j,0|f,d)^b
      CALL KetHRR106(120,HRRB)
      ! Generating (i,0|g,d)^c
      CALL KetHRR156(84,HRRC)
      ! Stress: Generating [f,0|f,d]
      DO IJ=1,9
        CALL KetHRR106(84,HRRS(1,1,1,IJ))
      ENDDO
      DO L=5,10
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10101006
    SUBROUTINE CNTRCTG1010106(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(120,84,0:12)
      REAL(DOUBLE)  :: VRRS(84,56,0:11,3)
      REAL(DOUBLE)  :: HRRS(84,56,10,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,56
