...
SUBROUTINE dIntB2010101(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      ! Generating (sp,0|s,s)
      CALL KetHRR11(5,HRR) 
      ! Generating (spd,0|s,s)^a
      CALL KetHRR11(5,HRRA) 
      ! Generating (spd,0|s,s)^b
      CALL KetHRR11(5,HRRB) 
      ! Generating (sp,0|p,s)^c
