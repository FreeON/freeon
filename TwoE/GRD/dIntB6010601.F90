...
SUBROUTINE dIntB6010601(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      CALL InitDbl(9*1*10*10,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      ! Stress: No need to generate [d,0|d,s]
      DO L=1,1
   ...
   END SUBROUTINE dIntB6010601
    SUBROUTINE CNTRCTG6161(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(20,20,0:5)
      REAL(DOUBLE)  :: VRRS(10,10,0:4,3)
      REAL(DOUBLE)  :: HRRS(10,10,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,10
