...
SUBROUTINE dIntB6020303(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      CALL InitDbl(9*4*26*10,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO IJ=1,9
        CALL KetHRR33(26,HRRS(1,1,1,IJ)) 
      ENDDO
      DO L=2,4
   ...
   END SUBROUTINE dIntB6020303
    SUBROUTINE CNTRCTG6233(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(35,20,0:6)
      REAL(DOUBLE)  :: VRRS(26,10,0:5,3)
      REAL(DOUBLE)  :: HRRS(26,10,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,10
