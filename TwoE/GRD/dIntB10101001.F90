...
! ----------------------------------------------------------
SUBROUTINE dIntB10101001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(84,20,1) :: HRR
      REAL(DOUBLE), DIMENSION(120,20,1) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(84,35,1) :: HRRC
      REAL(DOUBLE)  :: VRR(120,35,0:10)
      REAL(DOUBLE)  :: VRRS(84,20,0:9,3)
      REAL(DOUBLE)  :: HRRS(84,20,1,9)
      ...
      CALL InitDbl(120*20,HRRA(1,1,1))
      CALL InitDbl(120*20,HRRB(1,1,1))
      CALL InitDbl(84*35,HRRC(1,1,1))
      CALL InitDbl(9*1*84*20,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            CALL MVRRf0s0(1,84,20,VRRS(1,1,6,1),VRRS(1,1,7,1),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|s0]^(5)
            CALL MVRRf0s0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(5)
            CALL MVRRg0s0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|s0]^(4)
            CALL MVRRg0s0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|s0]^(4)
            CALL MVRRh0s0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|s0]^(3)
            CALL MVRRh0s0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|s0]^(2)
            CALL MVRRh0s0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|s0]^(1)
            CALL MVRRh0s0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|s0]^(0)
            CALL MVRRh0s0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|s0]^(3)
            CALL MVRRi0s0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|s0]^(2)
            CALL MVRRi0s0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|s0]^(1)
            CALL MVRRi0s0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|s0]^(0)
            CALL MVRRi0s0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ...
            CALL MVRRd0p0(1,84,20,VRRS(1,1,6,1),VRRS(1,1,7,1),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|p0]^(5)
            CALL MVRRd0p0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(5)
            CALL MVRRf0p0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|p0]^(4)
            CALL MVRRf0p0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(4)
            CALL MVRRg0p0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|p0]^(3)
            CALL MVRRg0p0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|p0]^(3)
            CALL MVRRh0p0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|p0]^(2)
            CALL MVRRh0p0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|p0]^(1)
            CALL MVRRh0p0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|p0]^(0)
            CALL MVRRh0p0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|p0]^(2)
            CALL MVRRi0p0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|p0]^(1)
            CALL MVRRi0p0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|p0]^(0)
            CALL MVRRi0p0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ...
            CALL MVRRp0d0(1,84,20,VRRS(1,1,6,1),VRRS(1,1,7,1),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|d0]^(5)
            CALL MVRRp0d0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(5)
            CALL MVRRd0d0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|d0]^(4)
            CALL MVRRd0d0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(4)
            CALL MVRRf0d0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|d0]^(3)
            CALL MVRRf0d0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(3)
            CALL MVRRg0d0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|d0]^(2)
            CALL MVRRg0d0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|d0]^(2)
            CALL MVRRh0d0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|d0]^(1)
            CALL MVRRh0d0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|d0]^(0)
            CALL MVRRh0d0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|d0]^(1)
            CALL MVRRi0d0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|d0]^(0)
            CALL MVRRi0d0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(6)
            CALL MVRRs0f0(1,84,20,VRRS(1,1,6,1),VRRS(1,1,7,1),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|f0]^(5)
            CALL MVRRs0f0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(5)
            CALL MVRRp0f0(1,84,20,VRRS(1,1,5,1),VRRS(1,1,6,1),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|f0]^(4)
            CALL MVRRp0f0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(4)
            CALL MVRRd0f0(1,84,20,VRRS(1,1,4,1),VRRS(1,1,5,1),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|f0]^(3)
            CALL MVRRd0f0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(3)
            CALL MVRRf0f0(1,84,20,VRRS(1,1,3,1),VRRS(1,1,4,1),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|f0]^(2)
            CALL MVRRf0f0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(2)
            CALL MVRRg0f0(1,84,20,VRRS(1,1,2,1),VRRS(1,1,3,1),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|f0]^(1)
            CALL MVRRg0f0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|f0]^(1)
            CALL MVRRh0f0(1,84,20,VRRS(1,1,1,1),VRRS(1,1,2,1),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|f0]^(0)
            CALL MVRRh0f0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|f0]^(0)
            CALL MVRRi0f0(1,84,20,VRRS(1,1,0,1),VRRS(1,1,1,1),120,35,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(6)
            CALL MVRRf0s0(2,84,20,VRRS(1,1,6,2),VRRS(1,1,7,2),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|s0]^(5)
            CALL MVRRf0s0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(5)
            CALL MVRRg0s0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|s0]^(4)
            CALL MVRRg0s0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|s0]^(4)
            CALL MVRRh0s0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|s0]^(3)
            CALL MVRRh0s0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|s0]^(2)
            CALL MVRRh0s0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|s0]^(1)
            CALL MVRRh0s0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|s0]^(0)
            CALL MVRRh0s0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|s0]^(3)
            CALL MVRRi0s0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|s0]^(2)
            CALL MVRRi0s0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|s0]^(1)
            CALL MVRRi0s0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|s0]^(0)
            CALL MVRRi0s0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(8)
            ...
            ! MIC-VRR: Generating [d0|p0]^(6)
            CALL MVRRd0p0(2,84,20,VRRS(1,1,6,2),VRRS(1,1,7,2),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|p0]^(5)
            CALL MVRRd0p0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(5)
            CALL MVRRf0p0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|p0]^(4)
            CALL MVRRf0p0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(4)
            CALL MVRRg0p0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|p0]^(3)
            CALL MVRRg0p0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|p0]^(3)
            CALL MVRRh0p0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|p0]^(2)
            CALL MVRRh0p0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|p0]^(1)
            CALL MVRRh0p0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|p0]^(0)
            CALL MVRRh0p0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|p0]^(2)
            CALL MVRRi0p0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|p0]^(1)
            CALL MVRRi0p0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|p0]^(0)
            CALL MVRRi0p0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(7)
            ...
            ! MIC-VRR: Generating [p0|d0]^(6)
            CALL MVRRp0d0(2,84,20,VRRS(1,1,6,2),VRRS(1,1,7,2),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|d0]^(5)
            CALL MVRRp0d0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(5)
            CALL MVRRd0d0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|d0]^(4)
            CALL MVRRd0d0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(4)
            CALL MVRRf0d0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|d0]^(3)
            CALL MVRRf0d0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(3)
            CALL MVRRg0d0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|d0]^(2)
            CALL MVRRg0d0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|d0]^(2)
            CALL MVRRh0d0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|d0]^(1)
            CALL MVRRh0d0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|d0]^(0)
            CALL MVRRh0d0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|d0]^(1)
            CALL MVRRi0d0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|d0]^(0)
            CALL MVRRi0d0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(6)
            CALL MVRRs0f0(2,84,20,VRRS(1,1,6,2),VRRS(1,1,7,2),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|f0]^(5)
            CALL MVRRs0f0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(5)
            CALL MVRRp0f0(2,84,20,VRRS(1,1,5,2),VRRS(1,1,6,2),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|f0]^(4)
            CALL MVRRp0f0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(4)
            CALL MVRRd0f0(2,84,20,VRRS(1,1,4,2),VRRS(1,1,5,2),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|f0]^(3)
            CALL MVRRd0f0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(3)
            CALL MVRRf0f0(2,84,20,VRRS(1,1,3,2),VRRS(1,1,4,2),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|f0]^(2)
            CALL MVRRf0f0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(2)
            CALL MVRRg0f0(2,84,20,VRRS(1,1,2,2),VRRS(1,1,3,2),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|f0]^(1)
            CALL MVRRg0f0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|f0]^(1)
            CALL MVRRh0f0(2,84,20,VRRS(1,1,1,2),VRRS(1,1,2,2),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|f0]^(0)
            CALL MVRRh0f0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|f0]^(0)
            CALL MVRRi0f0(2,84,20,VRRS(1,1,0,2),VRRS(1,1,1,2),120,35,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(6)
            CALL MVRRf0s0(3,84,20,VRRS(1,1,6,3),VRRS(1,1,7,3),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [f0|s0]^(5)
            CALL MVRRf0s0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|s0]^(4)
            CALL MVRRf0s0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(5)
            CALL MVRRg0s0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [g0|s0]^(4)
            CALL MVRRg0s0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|s0]^(3)
            CALL MVRRg0s0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|s0]^(4)
            CALL MVRRh0s0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [h0|s0]^(3)
            CALL MVRRh0s0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|s0]^(2)
            CALL MVRRh0s0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|s0]^(1)
            CALL MVRRh0s0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|s0]^(0)
            CALL MVRRh0s0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|s0]^(3)
            CALL MVRRi0s0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [i0|s0]^(2)
            CALL MVRRi0s0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|s0]^(1)
            CALL MVRRi0s0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|s0]^(0)
            CALL MVRRi0s0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(8)
            ...
            ! MIC-VRR: Generating [d0|p0]^(6)
            CALL MVRRd0p0(3,84,20,VRRS(1,1,6,3),VRRS(1,1,7,3),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [d0|p0]^(5)
            CALL MVRRd0p0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|p0]^(4)
            CALL MVRRd0p0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(5)
            CALL MVRRf0p0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [f0|p0]^(4)
            CALL MVRRf0p0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|p0]^(3)
            CALL MVRRf0p0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(4)
            CALL MVRRg0p0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [g0|p0]^(3)
            CALL MVRRg0p0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|p0]^(2)
            CALL MVRRg0p0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|p0]^(3)
            CALL MVRRh0p0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [h0|p0]^(2)
            CALL MVRRh0p0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|p0]^(1)
            CALL MVRRh0p0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|p0]^(0)
            CALL MVRRh0p0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|p0]^(2)
            CALL MVRRi0p0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [i0|p0]^(1)
            CALL MVRRi0p0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|p0]^(0)
            CALL MVRRi0p0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(7)
            ...
            ! MIC-VRR: Generating [p0|d0]^(6)
            CALL MVRRp0d0(3,84,20,VRRS(1,1,6,3),VRRS(1,1,7,3),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [p0|d0]^(5)
            CALL MVRRp0d0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|d0]^(4)
            CALL MVRRp0d0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(5)
            CALL MVRRd0d0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [d0|d0]^(4)
            CALL MVRRd0d0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|d0]^(3)
            CALL MVRRd0d0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(4)
            CALL MVRRf0d0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [f0|d0]^(3)
            CALL MVRRf0d0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|d0]^(2)
            CALL MVRRf0d0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(3)
            CALL MVRRg0d0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [g0|d0]^(2)
            CALL MVRRg0d0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|d0]^(1)
            CALL MVRRg0d0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|d0]^(2)
            CALL MVRRh0d0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [h0|d0]^(1)
            CALL MVRRh0d0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|d0]^(0)
            CALL MVRRh0d0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|d0]^(1)
            CALL MVRRi0d0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [i0|d0]^(0)
            CALL MVRRi0d0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|f0]^(6)
            CALL MVRRs0f0(3,84,20,VRRS(1,1,6,3),VRRS(1,1,7,3),120,35,VRR(1,1,7))
            ! MIC-VRR: Generating [s0|f0]^(5)
            CALL MVRRs0f0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [s0|f0]^(4)
            CALL MVRRs0f0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [s0|f0]^(3)
            CALL MVRRs0f0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [s0|f0]^(2)
            CALL MVRRs0f0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [s0|f0]^(1)
            CALL MVRRs0f0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [s0|f0]^(0)
            CALL MVRRs0f0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [p0|f0]^(5)
            CALL MVRRp0f0(3,84,20,VRRS(1,1,5,3),VRRS(1,1,6,3),120,35,VRR(1,1,6))
            ! MIC-VRR: Generating [p0|f0]^(4)
            CALL MVRRp0f0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [p0|f0]^(3)
            CALL MVRRp0f0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|f0]^(2)
            CALL MVRRp0f0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|f0]^(1)
            CALL MVRRp0f0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|f0]^(0)
            CALL MVRRp0f0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|f0]^(4)
            CALL MVRRd0f0(3,84,20,VRRS(1,1,4,3),VRRS(1,1,5,3),120,35,VRR(1,1,5))
            ! MIC-VRR: Generating [d0|f0]^(3)
            CALL MVRRd0f0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|f0]^(2)
            CALL MVRRd0f0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|f0]^(1)
            CALL MVRRd0f0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|f0]^(0)
            CALL MVRRd0f0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|f0]^(3)
            CALL MVRRf0f0(3,84,20,VRRS(1,1,3,3),VRRS(1,1,4,3),120,35,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|f0]^(2)
            CALL MVRRf0f0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|f0]^(1)
            CALL MVRRf0f0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|f0]^(0)
            CALL MVRRf0f0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|f0]^(2)
            CALL MVRRg0f0(3,84,20,VRRS(1,1,2,3),VRRS(1,1,3,3),120,35,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|f0]^(1)
            CALL MVRRg0f0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|f0]^(0)
            CALL MVRRg0f0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [h0|f0]^(1)
            CALL MVRRh0f0(3,84,20,VRRS(1,1,1,3),VRRS(1,1,2,3),120,35,VRR(1,1,2))
            ! MIC-VRR: Generating [h0|f0]^(0)
            CALL MVRRh0f0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ! MIC-VRR: Generating [i0|f0]^(0)
            CALL MVRRi0f0(3,84,20,VRRS(1,1,0,3),VRRS(1,1,1,3),120,35,VRR(1,1,1))
            ENDIF
            ! Contracting ...
            CALL CNTRCTG1010101(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Dont need to generate (i,0|f,s)
      ! Dont need to generate (j,0|f,s)^a
      ! Dont need to generate (j,0|f,s)^b
      ! Dont need to generate (i,0|g,s)^c
      ! Stress: No need to generate [f,0|f,s]
      DO L=1,1
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10101001
    SUBROUTINE CNTRCTG1010101(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(120,35,0:10)
      REAL(DOUBLE)  :: VRRS(84,20,0:9,3)
      REAL(DOUBLE)  :: HRRS(84,20,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,20
