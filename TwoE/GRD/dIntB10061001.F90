...
! ----------------------------------------------------------
SUBROUTINE dIntB10061001(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(56,20,1) :: HRR
      REAL(DOUBLE), DIMENSION(84,20,1) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(56,35,1) :: HRRC
      REAL(DOUBLE)  :: VRR(84,35,0:9)
      REAL(DOUBLE)  :: VRRS(56,20,0:8,3)
      REAL(DOUBLE)  :: HRRS(56,20,1,9)
      ...
      CALL InitDbl(9*1*56*20,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ENDIF
            ! Contracting ...
            CALL CNTRCTG106101(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Dont need to generate (h,0|f,s)
      ! Dont need to generate (i,0|f,s)^a
      ! Dont need to generate (i,0|f,s)^b
      ! Dont need to generate (h,0|g,s)^c
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10061001
    SUBROUTINE CNTRCTG106101(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(84,35,0:9)
      REAL(DOUBLE)  :: VRRS(56,20,0:8,3)
      REAL(DOUBLE)  :: HRRS(56,20,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,20
