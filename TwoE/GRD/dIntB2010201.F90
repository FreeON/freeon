...
SUBROUTINE dIntB2010201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (sp,0|sp,s)
      CALL KetHRR21(5,HRR) 
      ! Generating (spd,0|sp,s)^a
      CALL KetHRR21(5,HRRA) 
      ! Generating (spd,0|sp,s)^b
      CALL KetHRR21(5,HRRB) 
      ! Generating (sp,0|spd,s)^c
