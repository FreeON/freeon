! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f sp|d sp) 
! ---------------------------------------------------------- 
SUBROUTINE dIntB10020602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS)
      ...
      REAL(DOUBLE), DIMENSION(45,26,4) :: HRR 
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ! Contracting ... 
            CALL CNTRCTG10262(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC)
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (<>CType[11]<>,0|d,sp)
      CALL KetHRR62(45,HRR) 
      ! Generating (<>CType[16]<>,0|d,sp)^a
      CALL KetHRR62(56,HRRA) 
      ! Generating (<>CType[16]<>,0|d,sp)^b
      CALL KetHRR62(56,HRRB) 
      ! Generating (<>CType[11]<>,0|f,sp)^c
      CALL KetHRR102(45,HRRC) 
      DO L=1,4
         ...
         CALL BraHRR102cd(NINT,LDA,LDB,OA,OB,GOA,GOB,GOC,GOD,CDOffSet,2,HRRTmp,GRADIENTS(1,1))
      ENDDO 
    END SUBROUTINE dIntB10020602
    SUBROUTINE CNTRCTG10262(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC)
      USE DerivedTypes
      USE VScratchB
      REAL(DOUBLE)  :: Alpha,Beta,Gamma
      REAL(DOUBLE), DIMENSION(45,26,4) :: HRR 
