...
SUBROUTINE dIntB10020602(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(45,26,0:7,3)
      REAL(DOUBLE)  :: HRRS(45,26,4,9)
      ...
      CALL InitDbl(9*4*45*26,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO IJ=1,9
        CALL KetHRR62(45,HRRS(1,1,1,IJ)) 
      ENDDO
      DO L=1,4
   ...
   END SUBROUTINE dIntB10020602
    SUBROUTINE CNTRCTG10262(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,35,0:8)
      REAL(DOUBLE)  :: VRRS(45,26,0:7,3)
      REAL(DOUBLE)  :: HRRS(45,26,4,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,20
