...
!------------------------------------------------------------------------------
! ----------------------------------------------------------
! COMPUTES THE INTEGRAL CLASS (f f|d d)
! ----------------------------------------------------------
SUBROUTINE dIntB10100606(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE), DIMENSION(84,35,10) :: HRR
      REAL(DOUBLE), DIMENSION(120,35,10) :: HRRA,HRRB
      REAL(DOUBLE), DIMENSION(84,56,10) :: HRRC
      REAL(DOUBLE)  :: VRR(120,56,0:11)
      REAL(DOUBLE)  :: VRRS(84,35,0:10,3)
      REAL(DOUBLE)  :: HRRS(84,35,10,9)
      ...
      CALL InitDbl(9*10*84*35,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop
            ...
            ENDIF
            ! Contracting ...
            CALL CNTRCTG101066(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                       VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Generating (i,0|d,d)
      CALL KetHRR66(84,HRR)
      ! Generating (j,0|d,d)^a
      CALL KetHRR66(120,HRRA)
      ! Generating (j,0|d,d)^b
      CALL KetHRR66(120,HRRB)
      ! Generating (i,0|f,d)^c
      CALL KetHRR106(84,HRRC)
      ! Stress: Generating [f,0|d,d]
      DO IJ=1,9
        CALL KetHRR66(84,HRRS(1,1,1,IJ))
      ENDDO
      DO L=5,10
      ...
      ENDDO
      ENDDO
   END SUBROUTINE dIntB10100606
    SUBROUTINE CNTRCTG101066(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(120,56,0:11)
      REAL(DOUBLE)  :: VRRS(84,35,0:10,3)
      REAL(DOUBLE)  :: HRRS(84,35,10,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,35
