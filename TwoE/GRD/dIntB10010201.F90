...
! ---------------------------------------------------------- 
SUBROUTINE dIntB10010201(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      REAL(DOUBLE)  :: VRRS(20,5,0:4,3)
      REAL(DOUBLE)  :: HRRS(20,5,1,9)
      ...
      CALL InitDbl(9*1*20*5,HRRS(1,1,1,1))
      Ax=ACInfo%Atm1X
      Ay=ACInfo%Atm1Y
      Az=ACInfo%Atm1Z
      Bx=ACInfo%Atm2X
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            ENDIF
            ! Contracting ... 
            CALL CNTRCTG10121(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
      ...
      ENDDO 
      ENDDO 
   END SUBROUTINE dIntB10010201
    SUBROUTINE CNTRCTG10121(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(35,10,0:5)
      REAL(DOUBLE)  :: VRRS(20,5,0:4,3)
      REAL(DOUBLE)  :: HRRS(20,5,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
