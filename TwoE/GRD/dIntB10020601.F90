! ---------------------------------------------------------- 
! COMPUTES THE INTEGRAL CLASS (f sp|d s) 
! ---------------------------------------------------------- 
SUBROUTINE dIntB10020601(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, &
 OA,LDA,OB,LDB,OC,LDC,OD,LDD,GOA,GOB,GOC,GOD,NINT,PBC,GRADIENTS,STRESS)
      ...
      DO J=1,LKet ! K^2 VRR |N0) loop 
         ...
         DO K=1,LBra ! K^2 VRR (M0| loop 
            ...
            CALL MVRRf0s0(1,35,10,VRRS(1,1,3,1),VRRS(1,1,4,1),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(1,35,10,VRRS(1,1,2,1),VRRS(1,1,3,1),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(1,35,10,VRRS(1,1,2,1),VRRS(1,1,3,1),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ...
            CALL MVRRd0p0(1,35,10,VRRS(1,1,3,1),VRRS(1,1,4,1),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(1,35,10,VRRS(1,1,2,1),VRRS(1,1,3,1),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(1,35,10,VRRS(1,1,2,1),VRRS(1,1,3,1),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ...
            CALL MVRRp0d0(1,35,10,VRRS(1,1,3,1),VRRS(1,1,4,1),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(1,35,10,VRRS(1,1,2,1),VRRS(1,1,3,1),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(1,35,10,VRRS(1,1,2,1),VRRS(1,1,3,1),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(1,35,10,VRRS(1,1,1,1),VRRS(1,1,2,1),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(1,35,10,VRRS(1,1,0,1),VRRS(1,1,1,1),56,20,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(2,35,10,VRRS(1,1,3,2),VRRS(1,1,4,2),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(2,35,10,VRRS(1,1,2,2),VRRS(1,1,3,2),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(2,35,10,VRRS(1,1,2,2),VRRS(1,1,3,2),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(5)
            ...
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(2,35,10,VRRS(1,1,3,2),VRRS(1,1,4,2),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(2,35,10,VRRS(1,1,2,2),VRRS(1,1,3,2),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(2,35,10,VRRS(1,1,2,2),VRRS(1,1,3,2),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(4)
            ...
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(2,35,10,VRRS(1,1,3,2),VRRS(1,1,4,2),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(2,35,10,VRRS(1,1,2,2),VRRS(1,1,3,2),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(2,35,10,VRRS(1,1,2,2),VRRS(1,1,3,2),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(2,35,10,VRRS(1,1,1,2),VRRS(1,1,2,2),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(2,35,10,VRRS(1,1,0,2),VRRS(1,1,1,2),56,20,VRR(1,1,1))
            ENDIF
            ...
            ! MIC-VRR: Generating [f0|s0]^(3)
            CALL MVRRf0s0(3,35,10,VRRS(1,1,3,3),VRRS(1,1,4,3),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [f0|s0]^(2)
            CALL MVRRf0s0(3,35,10,VRRS(1,1,2,3),VRRS(1,1,3,3),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|s0]^(1)
            CALL MVRRf0s0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|s0]^(0)
            CALL MVRRf0s0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|s0]^(2)
            CALL MVRRg0s0(3,35,10,VRRS(1,1,2,3),VRRS(1,1,3,3),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [g0|s0]^(1)
            CALL MVRRg0s0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|s0]^(0)
            CALL MVRRg0s0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|p0]^(5)
            ...
            ! MIC-VRR: Generating [d0|p0]^(3)
            CALL MVRRd0p0(3,35,10,VRRS(1,1,3,3),VRRS(1,1,4,3),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [d0|p0]^(2)
            CALL MVRRd0p0(3,35,10,VRRS(1,1,2,3),VRRS(1,1,3,3),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|p0]^(1)
            CALL MVRRd0p0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|p0]^(0)
            CALL MVRRd0p0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|p0]^(2)
            CALL MVRRf0p0(3,35,10,VRRS(1,1,2,3),VRRS(1,1,3,3),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [f0|p0]^(1)
            CALL MVRRf0p0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|p0]^(0)
            CALL MVRRf0p0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|p0]^(1)
            CALL MVRRg0p0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [g0|p0]^(0)
            CALL MVRRg0p0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [s0|d0]^(4)
            ...
            ! MIC-VRR: Generating [p0|d0]^(3)
            CALL MVRRp0d0(3,35,10,VRRS(1,1,3,3),VRRS(1,1,4,3),56,20,VRR(1,1,4))
            ! MIC-VRR: Generating [p0|d0]^(2)
            CALL MVRRp0d0(3,35,10,VRRS(1,1,2,3),VRRS(1,1,3,3),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [p0|d0]^(1)
            CALL MVRRp0d0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [p0|d0]^(0)
            CALL MVRRp0d0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [d0|d0]^(2)
            CALL MVRRd0d0(3,35,10,VRRS(1,1,2,3),VRRS(1,1,3,3),56,20,VRR(1,1,3))
            ! MIC-VRR: Generating [d0|d0]^(1)
            CALL MVRRd0d0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [d0|d0]^(0)
            CALL MVRRd0d0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [f0|d0]^(1)
            CALL MVRRf0d0(3,35,10,VRRS(1,1,1,3),VRRS(1,1,2,3),56,20,VRR(1,1,2))
            ! MIC-VRR: Generating [f0|d0]^(0)
            CALL MVRRf0d0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ! MIC-VRR: Generating [g0|d0]^(0)
            CALL MVRRg0d0(3,35,10,VRRS(1,1,0,3),VRRS(1,1,1,3),56,20,VRR(1,1,1))
            ENDIF
            ! Contracting ... 
            CALL CNTRCTG10261(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC, &
                     & VRRS,HRRS(1,1,1,1),PQJ(1),PBC%AutoW%I(1))
         ENDDO ! (M0| loop
      ENDDO ! |N0) loop
      ! Dont need to generate (<>CType[11]<>,0|d,s)
      ! Dont need to generate (<>CType[16]<>,0|d,s)^a
      ! Dont need to generate (<>CType[16]<>,0|d,s)^b
      ! Dont need to generate (<>CType[11]<>,0|f,s)^c
      ...
      ENDDO 
      ENDDO 
   END SUBROUTINE dIntB10020601
    SUBROUTINE CNTRCTG10261(VRR,HRR,Alpha,HRRA,Beta,HRRB,Gamma,HRRC,VRRS,HRRS,PQJ,IW)
      USE DerivedTypes
      USE VScratchB
      IMPLICIT NONE
      INTEGER :: K
      ...
      REAL(DOUBLE)  :: VRR(56,20,0:7)
      REAL(DOUBLE)  :: VRRS(45,10,0:6,3)
      REAL(DOUBLE)  :: HRRS(45,10,1,9),PQJ(3)
      INTEGER :: IJ,J,I,IW(3)
      DO K=1,10
