...
! ---------------------------------------------------------- 
   SUBROUTINE dInt3113(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      dI(OffSet,CrtSet1)=Ia5Bar2+V(2)+V(3)+V(4)
      dI(OffSet,CrtSet4)=Ib5Bar2+V(7)+V(8)
      dI(OffSet,CrtSet7)=Ic2Bar5+V(9)
      W1=I1Bar2-Ia5Bar2-Ib5Bar2-Ic2Bar5
      W2=V(1)-V(4)
      W3=-V(7)
      W4=-V(8)-V(9)
      dI(OffSet,CrtSet10)=W1+W2+W3+W4
      dI(OffSet,CrtSet2)=V(11)
      dI(OffSet,CrtSet5)=Ib6Bar2+V(12)+V(13)
      dI(OffSet,CrtSet8)=Ic2Bar6+V(14)
      W1=-V(12)-V(14)+V(15)
      W2=V(16)+V(17)+V(18)+V(19)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=V(21)
      dI(OffSet,CrtSet6)=Ib8Bar2+V(22)+V(23)
      dI(OffSet,CrtSet9)=Ic2Bar8+V(24)
      W1=-V(22)-V(24)+V(25)
      W2=V(26)+V(27)+V(28)+V(29)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+1)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(11)
      dI(OffSet,CrtSet4)=Ib6Bar2+V(13)+V(32)
      dI(OffSet,CrtSet7)=Ic3Bar5+V(33)
      W1=-Ic3Bar5+V(15)+V(16)
      W2=V(17)+V(18)
      W3=-V(32)-V(33)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia7Bar2+V(2)+V(3)+V(34)
      dI(OffSet,CrtSet5)=Ib7Bar2+V(35)+V(36)
      dI(OffSet,CrtSet8)=Ic3Bar6+V(37)
      W1=I1Bar2-Ia7Bar2-Ib7Bar2+V(1)
      W2=-V(34)-V(35)
      W3=-V(36)-V(37)+V(38)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=V(40)
      dI(OffSet,CrtSet6)=Ib9Bar2+V(41)+V(42)
      dI(OffSet,CrtSet9)=Ic3Bar8+V(43)
      W1=-V(41)-V(43)+V(44)
      W2=V(45)+V(46)+V(47)+V(48)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+2)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(21)
      dI(OffSet,CrtSet4)=Ib8Bar2+V(23)+V(51)
      dI(OffSet,CrtSet7)=Ic4Bar5+V(52)
      W1=-Ic4Bar5+V(25)+V(26)
      W2=V(27)+V(28)
      W3=-V(51)-V(52)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=V(40)
      dI(OffSet,CrtSet5)=Ib9Bar2+V(42)+V(53)
      dI(OffSet,CrtSet8)=Ic4Bar6+V(54)
      W1=V(44)+V(45)+V(46)
      W2=V(47)-V(53)
      W3=-V(54)+V(55)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia10Bar2+V(2)+V(3)+V(56)
      dI(OffSet,CrtSet6)=Ib10Bar2+V(57)+V(58)
      dI(OffSet,CrtSet9)=Ic4Bar8+V(59)
      W1=I1Bar2-Ia10Bar2-Ib10Bar2+V(1)
      W2=-V(56)-V(57)
      W3=-V(58)-V(59)+V(60)
      dI(OffSet,CrtSet12)=W1+W2+W3
      OffSet=(OA+0)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+1)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia5Bar3+V(62)+V(63)+V(64)
      dI(OffSet,CrtSet4)=Ib5Bar3+V(67)+V(68)
      dI(OffSet,CrtSet7)=Ic2Bar6+V(69)
      W1=I1Bar3-Ia5Bar3-Ib5Bar3+V(19)
      W2=V(61)-V(64)
      W3=-V(67)
      W4=-V(68)-V(69)
      dI(OffSet,CrtSet10)=W1+W2+W3+W4
      dI(OffSet,CrtSet2)=V(71)
      dI(OffSet,CrtSet5)=Ib6Bar3+V(72)+V(73)
      dI(OffSet,CrtSet8)=Ic2Bar7+V(74)
      W1=-Ic2Bar7-V(72)-V(74)
      W2=V(75)+V(76)+V(77)+V(78)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=V(80)
      dI(OffSet,CrtSet6)=Ib8Bar3+V(81)+V(82)
      dI(OffSet,CrtSet9)=Ic2Bar9+V(83)
      W1=-V(81)-V(83)+V(84)
      W2=V(85)+V(86)+V(87)+V(88)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+1)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+1)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(71)
      dI(OffSet,CrtSet4)=Ib6Bar3+V(73)+V(91)
      dI(OffSet,CrtSet7)=Ic3Bar6+V(92)
      W1=V(38)+V(75)+V(76)
      W2=V(77)+V(78)
      W3=-V(91)-V(92)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia7Bar3+V(62)+V(63)+V(93)
      dI(OffSet,CrtSet5)=Ib7Bar3+V(94)+V(95)
      dI(OffSet,CrtSet8)=Ic3Bar7+V(96)
      W1=I1Bar3-Ia7Bar3-Ib7Bar3-Ic3Bar7
      W2=V(61)-V(93)
      W3=-V(94)
      W4=-V(95)-V(96)
      dI(OffSet,CrtSet11)=W1+W2+W3+W4
      dI(OffSet,CrtSet3)=V(98)
      dI(OffSet,CrtSet6)=Ib9Bar3+V(99)+V(100)
      dI(OffSet,CrtSet9)=Ic3Bar9+V(101)
      W1=-V(99)-V(101)+V(102)
      W2=V(103)+V(104)+V(105)+V(106)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+2)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+1)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(80)
      dI(OffSet,CrtSet4)=Ib8Bar3+V(82)+V(109)
      dI(OffSet,CrtSet7)=Ic4Bar6+V(110)
      W1=V(55)+V(84)+V(85)
      W2=V(86)+V(87)
      W3=-V(109)-V(110)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=V(98)
      dI(OffSet,CrtSet5)=Ib9Bar3+V(100)+V(111)
      dI(OffSet,CrtSet8)=Ic4Bar7+V(112)
      W1=-Ic4Bar7+V(102)+V(103)
      W2=V(104)+V(105)
      W3=-V(111)-V(112)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia10Bar3+V(62)+V(63)+V(113)
      dI(OffSet,CrtSet6)=Ib10Bar3+V(114)+V(115)
      dI(OffSet,CrtSet9)=Ic4Bar9+V(116)
      W1=I1Bar3-Ia10Bar3-Ib10Bar3+V(61)
      W2=-V(113)-V(114)
      W3=-V(115)-V(116)+V(117)
      dI(OffSet,CrtSet12)=W1+W2+W3
      OffSet=(OA+0)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+2)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia5Bar4+V(119)+V(120)+V(121)
      dI(OffSet,CrtSet4)=Ib5Bar4+V(124)+V(125)
      dI(OffSet,CrtSet7)=Ic2Bar8+V(126)
      W1=I1Bar4-Ia5Bar4-Ib5Bar4+V(29)
      W2=V(118)-V(121)
      W3=-V(124)
      W4=-V(125)-V(126)
      dI(OffSet,CrtSet10)=W1+W2+W3+W4
      dI(OffSet,CrtSet2)=V(128)
      dI(OffSet,CrtSet5)=Ib6Bar4+V(129)+V(130)
      dI(OffSet,CrtSet8)=Ic2Bar9+V(131)
      W1=V(88)-V(129)-V(131)
      W2=V(132)+V(133)+V(134)+V(135)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=V(137)
      dI(OffSet,CrtSet6)=Ib8Bar4+V(138)+V(139)
      dI(OffSet,CrtSet9)=Ic2Bar10+V(140)
      W1=-Ic2Bar10-V(138)-V(140)
      W2=V(141)+V(142)+V(143)+V(144)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+1)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+2)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(128)
      dI(OffSet,CrtSet4)=Ib6Bar4+V(130)+V(147)
      dI(OffSet,CrtSet7)=Ic3Bar8+V(148)
      W1=V(48)+V(132)+V(133)
      W2=V(134)+V(135)
      W3=-V(147)-V(148)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia7Bar4+V(119)+V(120)+V(149)
      dI(OffSet,CrtSet5)=Ib7Bar4+V(150)+V(151)
      dI(OffSet,CrtSet8)=Ic3Bar9+V(152)
      W1=I1Bar4-Ia7Bar4-Ib7Bar4+V(106)
      W2=V(118)-V(149)
      W3=-V(150)
      W4=-V(151)-V(152)
      dI(OffSet,CrtSet11)=W1+W2+W3+W4
      dI(OffSet,CrtSet3)=V(154)
      dI(OffSet,CrtSet6)=Ib9Bar4+V(155)+V(156)
      dI(OffSet,CrtSet9)=Ic3Bar10+V(157)
      W1=-Ic3Bar10-V(155)-V(157)
      W2=V(158)+V(159)+V(160)+V(161)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+2)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+2)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(137)
      dI(OffSet,CrtSet4)=Ib8Bar4+V(139)+V(164)
      dI(OffSet,CrtSet7)=Ic4Bar8+V(165)
      W1=V(60)+V(141)+V(142)
      W2=V(143)+V(144)
      W3=-V(164)-V(165)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=V(154)
      dI(OffSet,CrtSet5)=Ib9Bar4+V(156)+V(166)
      dI(OffSet,CrtSet8)=Ic4Bar9+V(167)
      W1=V(117)+V(158)+V(159)
      W2=V(160)+V(161)
      W3=-V(166)-V(167)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia10Bar4+V(119)+V(120)+V(168)
      dI(OffSet,CrtSet6)=Ib10Bar4+V(169)+V(170)
      dI(OffSet,CrtSet9)=Ic4Bar10+V(171)
      W1=I1Bar4-Ia10Bar4-Ib10Bar4-Ic4Bar10
      W2=V(118)-V(168)
      W3=-V(169)
      W4=-V(170)-V(171)
