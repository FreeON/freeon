...
! ---------------------------------------------------------- 
   SUBROUTINE dInt1311(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      dI(OffSet,CrtSet1)=Ia5Bar1+V(1)
      dI(OffSet,CrtSet4)=Ib5Bar1+V(2)+V(3)+V(6)
      dI(OffSet,CrtSet7)=Ic2Bar2+V(7)
      W1=I1Bar1-Ia5Bar1-Ib5Bar1-Ic2Bar2
      W2=-V(1)-V(3)
      W3=-V(6)-V(7)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia6Bar1+V(8)
      dI(OffSet,CrtSet5)=V(13)
      dI(OffSet,CrtSet8)=Ic2Bar3+V(14)
      W1=-Ic2Bar3-V(8)-V(14)
      W2=V(15)+V(16)+V(17)+V(18)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia8Bar1+V(19)
      dI(OffSet,CrtSet6)=V(24)
      dI(OffSet,CrtSet9)=Ic2Bar4+V(25)
      W1=-Ic2Bar4-V(19)-V(25)
      W2=V(26)+V(27)+V(28)+V(29)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+0)*LDA+(OB+1)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia6Bar1+V(30)
      dI(OffSet,CrtSet4)=V(13)
      dI(OffSet,CrtSet7)=Ic3Bar2+V(31)
      W1=-Ic3Bar2+V(15)+V(16)
      W2=V(17)+V(18)
      W3=-V(30)-V(31)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia7Bar1+V(32)
      dI(OffSet,CrtSet5)=Ib7Bar1+V(2)+V(33)+V(34)
      dI(OffSet,CrtSet8)=Ic3Bar3+V(35)
      W1=I1Bar1-Ia7Bar1-Ib7Bar1-Ic3Bar3
      W2=-V(32)-V(33)
      W3=-V(34)-V(35)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia9Bar1+V(36)
      dI(OffSet,CrtSet6)=V(39)
      dI(OffSet,CrtSet9)=Ic3Bar4+V(40)
      W1=-Ic3Bar4-V(36)-V(40)
      W2=V(41)+V(42)+V(43)+V(44)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+0)*LDA+(OB+2)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia8Bar1+V(45)
      dI(OffSet,CrtSet4)=V(24)
      dI(OffSet,CrtSet7)=Ic4Bar2+V(46)
      W1=-Ic4Bar2+V(26)+V(27)
      W2=V(28)+V(29)
      W3=-V(45)-V(46)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia9Bar1+V(47)
      dI(OffSet,CrtSet5)=V(39)
      dI(OffSet,CrtSet8)=Ic4Bar3+V(48)
      W1=-Ic4Bar3+V(41)+V(42)
      W2=V(43)+V(44)
      W3=-V(47)-V(48)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia10Bar1+V(49)
      dI(OffSet,CrtSet6)=Ib10Bar1+V(2)+V(50)+V(51)
      dI(OffSet,CrtSet9)=Ic4Bar4+V(52)
