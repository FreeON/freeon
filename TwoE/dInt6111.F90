...
! ---------------------------------------------------------- 
   SUBROUTINE dInt6111(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      dI(OffSet,CrtSet1)=-2.D0*I2Bar1+Ia11Bar1+dI(OffSet,CrtSet1)
      dI(OffSet,CrtSet4)=Ib11Bar1+dI(OffSet,CrtSet4)+V(1)
      dI(OffSet,CrtSet7)=Ic5Bar2+dI(OffSet,CrtSet7)
      W1=2.D0*I2Bar1-Ia11Bar1-Ib11Bar1
      W2=-Ic5Bar2+dI(OffSet,CrtSet10)-V(1)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia12Bar1+dI(OffSet,CrtSet2)
      dI(OffSet,CrtSet5)=Ib12Bar1+dI(OffSet,CrtSet5)+V(2)
      dI(OffSet,CrtSet8)=Ic5Bar3+dI(OffSet,CrtSet8)
      W1=-Ic5Bar3+dI(OffSet,CrtSet11)
      W2=-V(2)+V(3)+V(4)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia15Bar1+dI(OffSet,CrtSet3)
      dI(OffSet,CrtSet6)=Ib15Bar1+dI(OffSet,CrtSet6)+V(5)
      dI(OffSet,CrtSet9)=Ic5Bar4+dI(OffSet,CrtSet9)
      W1=-Ic5Bar4+dI(OffSet,CrtSet12)
      W2=-V(5)+V(6)+V(7)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+1)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia12Bar1+dI(OffSet,CrtSet1)+V(8)
      dI(OffSet,CrtSet4)=Ib12Bar1+dI(OffSet,CrtSet4)+V(9)
      dI(OffSet,CrtSet7)=Ic6Bar2+dI(OffSet,CrtSet7)
      W1=I3Bar1-Ic6Bar2+dI(OffSet,CrtSet10)
      W2=V(3)+V(4)-V(9)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia13Bar1+dI(OffSet,CrtSet2)+V(10)
      dI(OffSet,CrtSet5)=Ib13Bar1+dI(OffSet,CrtSet5)+V(11)
      dI(OffSet,CrtSet8)=Ic6Bar3+dI(OffSet,CrtSet8)
      W1=I2Bar1-Ic6Bar3+dI(OffSet,CrtSet11)
      W2=-V(11)+V(12)+V(13)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia16Bar1+dI(OffSet,CrtSet3)
      dI(OffSet,CrtSet6)=Ib16Bar1+dI(OffSet,CrtSet6)+V(14)
      dI(OffSet,CrtSet9)=Ic6Bar4+dI(OffSet,CrtSet9)
      W1=-Ic6Bar4+dI(OffSet,CrtSet12)
      W2=-V(14)+V(15)+V(16)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+2)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia13Bar1+dI(OffSet,CrtSet1)
      dI(OffSet,CrtSet4)=Ib13Bar1+dI(OffSet,CrtSet4)+V(17)
      dI(OffSet,CrtSet7)=Ic7Bar2+dI(OffSet,CrtSet7)
      W1=-Ic7Bar2+dI(OffSet,CrtSet10)
      W2=V(12)+V(13)-V(17)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=-2.D0*I3Bar1+Ia14Bar1+dI(OffSet,CrtSet2)
      dI(OffSet,CrtSet5)=Ib14Bar1+dI(OffSet,CrtSet5)+V(18)
      dI(OffSet,CrtSet8)=Ic7Bar3+dI(OffSet,CrtSet8)
      W1=2.D0*I3Bar1-Ia14Bar1-Ib14Bar1
      W2=-Ic7Bar3+dI(OffSet,CrtSet11)-V(18)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia17Bar1+dI(OffSet,CrtSet3)
      dI(OffSet,CrtSet6)=Ib17Bar1+dI(OffSet,CrtSet6)+V(19)
      dI(OffSet,CrtSet9)=Ic7Bar4+dI(OffSet,CrtSet9)
      W1=-Ic7Bar4+dI(OffSet,CrtSet12)
      W2=-V(19)+V(20)+V(21)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+3)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia15Bar1+dI(OffSet,CrtSet1)+V(22)
      dI(OffSet,CrtSet4)=Ib15Bar1+dI(OffSet,CrtSet4)+V(23)
      dI(OffSet,CrtSet7)=Ic8Bar2+dI(OffSet,CrtSet7)
      W1=I4Bar1-Ic8Bar2+dI(OffSet,CrtSet10)
      W2=V(6)+V(7)-V(23)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia16Bar1+dI(OffSet,CrtSet2)
      dI(OffSet,CrtSet5)=Ib16Bar1+dI(OffSet,CrtSet5)+V(24)
      dI(OffSet,CrtSet8)=Ic8Bar3+dI(OffSet,CrtSet8)
      W1=-Ic8Bar3+dI(OffSet,CrtSet11)
      W2=V(15)+V(16)-V(24)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia18Bar1+dI(OffSet,CrtSet3)+V(10)
      dI(OffSet,CrtSet6)=Ib18Bar1+dI(OffSet,CrtSet6)+V(25)
      dI(OffSet,CrtSet9)=Ic8Bar4+dI(OffSet,CrtSet9)
      W1=I2Bar1-Ic8Bar4+dI(OffSet,CrtSet12)
      W2=-V(25)+V(26)+V(27)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+4)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia16Bar1+dI(OffSet,CrtSet1)
      dI(OffSet,CrtSet4)=Ib16Bar1+dI(OffSet,CrtSet4)+V(28)
      dI(OffSet,CrtSet7)=Ic9Bar2+dI(OffSet,CrtSet7)
      W1=-Ic9Bar2+dI(OffSet,CrtSet10)
      W2=V(15)+V(16)-V(28)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia17Bar1+dI(OffSet,CrtSet2)+V(22)
      dI(OffSet,CrtSet5)=Ib17Bar1+dI(OffSet,CrtSet5)+V(29)
      dI(OffSet,CrtSet8)=Ic9Bar3+dI(OffSet,CrtSet8)
      W1=I4Bar1-Ic9Bar3+dI(OffSet,CrtSet11)
      W2=V(20)+V(21)-V(29)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia19Bar1+dI(OffSet,CrtSet3)+V(8)
      dI(OffSet,CrtSet6)=Ib19Bar1+dI(OffSet,CrtSet6)+V(30)
      dI(OffSet,CrtSet9)=Ic9Bar4+dI(OffSet,CrtSet9)
      W1=I3Bar1-Ic9Bar4+dI(OffSet,CrtSet12)
      W2=-V(30)+V(31)+V(32)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+5)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia18Bar1+dI(OffSet,CrtSet1)
      dI(OffSet,CrtSet4)=Ib18Bar1+dI(OffSet,CrtSet4)+V(33)
      dI(OffSet,CrtSet7)=Ic10Bar2+dI(OffSet,CrtSet7)
      W1=-Ic10Bar2+dI(OffSet,CrtSet10)
      W2=V(26)+V(27)-V(33)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia19Bar1+dI(OffSet,CrtSet2)
      dI(OffSet,CrtSet5)=Ib19Bar1+dI(OffSet,CrtSet5)+V(34)
      dI(OffSet,CrtSet8)=Ic10Bar3+dI(OffSet,CrtSet8)
      W1=-Ic10Bar3+dI(OffSet,CrtSet11)
      W2=V(31)+V(32)-V(34)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=-2.D0*I4Bar1+Ia20Bar1+dI(OffSet,CrtSet3)
      dI(OffSet,CrtSet6)=Ib20Bar1+dI(OffSet,CrtSet6)+V(35)
      dI(OffSet,CrtSet9)=Ic10Bar4+dI(OffSet,CrtSet9)
      W1=2.D0*I4Bar1-Ia20Bar1-Ib20Bar1
      W2=-Ic10Bar4+dI(OffSet,CrtSet12)-V(35)
      dI(OffSet,CrtSet12)=W1+W2
   END SUBROUTINE dInt6111
