...
! ---------------------------------------------------------- 
   SUBROUTINE dInt3131(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      RawI5Bar2=PAx*V(38)+V(45)+WPx*V(52)+V(59)
      ...
      RawI7Bar3=V(60)+PAy*V(91)+V(104)+WPy*V(107)
      ...
      RawI10Bar4=V(70)+PAz*V(122)+V(132)+WPz*V(138)
      I10Bar4=RawI10Bar4+I10Bar4
      RawI1Bar5=QCx*V(34)+WQx*V(55)+V(142)
      I1Bar5=RawI1Bar5+I1Bar5
      RawI2Bar5=QCx*V(38)+WQx*V(52)+HfxZpE*V(55)+V(146)
      ...
      RawI3Bar7=QCy*V(91)+WQy*V(107)+V(150)+V(155)
      ...
      RawI4Bar10=QCz*V(122)+WQz*V(138)+V(154)+V(156)
      ...
      dI(OffSet,CrtSet7)=Ic2Bar5+dI(OffSet,CrtSet7)+V(2)
      ...
      dI(OffSet,CrtSet7)=Ic3Bar5+dI(OffSet,CrtSet7)+V(3)
      ...
      dI(OffSet,CrtSet7)=Ic4Bar5+dI(OffSet,CrtSet7)+V(4)
      ...
      dI(OffSet,CrtSet1)=Ia5Bar3+dI(OffSet,CrtSet1)+V(5)
      ...
      dI(OffSet,CrtSet8)=Ic2Bar7+dI(OffSet,CrtSet8)+V(2)
      ...
      dI(OffSet,CrtSet7)=Ic3Bar6+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia7Bar3+dI(OffSet,CrtSet2)+V(5)
      dI(OffSet,CrtSet5)=ABy*Ib3Bar3+Ib7Bar3+dI(OffSet,CrtSet5)
      dI(OffSet,CrtSet8)=Ic3Bar7+dI(OffSet,CrtSet8)+V(3)
      ...
      dI(OffSet,CrtSet8)=Ic4Bar7+dI(OffSet,CrtSet8)+V(4)
            dI(OffSet,CrtSet3)=Ia10Bar3+dI(OffSet,CrtSet3)+V(5)
      ...
      dI(OffSet,CrtSet1)=Ia5Bar4+dI(OffSet,CrtSet1)+V(6)
      ...
      dI(OffSet,CrtSet9)=Ic2Bar10+dI(OffSet,CrtSet9)+V(2)
      ...
      dI(OffSet,CrtSet7)=Ic3Bar8+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia7Bar4+dI(OffSet,CrtSet2)+V(6)
      ...
      dI(OffSet,CrtSet9)=Ic3Bar10+dI(OffSet,CrtSet9)+V(3)
      ...
      dI(OffSet,CrtSet8)=Ic4Bar9+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=Ia10Bar4+dI(OffSet,CrtSet3)+V(6)
      dI(OffSet,CrtSet6)=Ib10Bar4+ABz*Ib4Bar4+dI(OffSet,CrtSet6)
      dI(OffSet,CrtSet9)=Ic4Bar10+dI(OffSet,CrtSet9)+V(4)
