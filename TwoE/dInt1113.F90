...
! ---------------------------------------------------------- 
   SUBROUTINE dInt1113(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      dI(OffSet,CrtSet1)=Ia2Bar2+V(1)
      dI(OffSet,CrtSet4)=Ib2Bar2+V(4)+V(5)
      dI(OffSet,CrtSet7)=Ic1Bar5+V(6)
      W1=-Ia2Bar2-Ib2Bar2-Ic1Bar5
      W2=-V(1)-V(4)
      W3=-V(5)-V(6)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia3Bar2+V(7)
      dI(OffSet,CrtSet5)=Ib3Bar2+V(8)+V(9)
      dI(OffSet,CrtSet8)=Ic1Bar6+V(10)
      W1=-Ia3Bar2-Ib3Bar2-V(7)
      W2=-V(8)-V(9)
      W3=-V(10)+V(11)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia4Bar2+V(12)
      dI(OffSet,CrtSet6)=Ib4Bar2+V(13)+V(14)
      dI(OffSet,CrtSet9)=Ic1Bar8+V(15)
      W1=-Ia4Bar2-Ib4Bar2-V(12)
      W2=-V(13)-V(14)
      W3=-V(15)+V(16)
      dI(OffSet,CrtSet12)=W1+W2+W3
      OffSet=(OA+0)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+1)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia2Bar3+V(17)
      dI(OffSet,CrtSet4)=Ib2Bar3+V(20)+V(21)
      dI(OffSet,CrtSet7)=Ic1Bar6+V(22)
      W1=-Ia2Bar3-Ib2Bar3+V(11)
      W2=-V(17)-V(20)
      W3=-V(21)-V(22)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia3Bar3+V(23)
      dI(OffSet,CrtSet5)=Ib3Bar3+V(24)+V(25)
      dI(OffSet,CrtSet8)=Ic1Bar7+V(26)
      W1=-Ia3Bar3-Ib3Bar3-Ic1Bar7
      W2=-V(23)-V(24)
      W3=-V(25)-V(26)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia4Bar3+V(27)
      dI(OffSet,CrtSet6)=Ib4Bar3+V(28)+V(29)
      dI(OffSet,CrtSet9)=Ic1Bar9+V(30)
      W1=-Ia4Bar3-Ib4Bar3-V(27)
      W2=-V(28)-V(29)
      W3=-V(30)+V(31)
      dI(OffSet,CrtSet12)=W1+W2+W3
      OffSet=(OA+0)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+2)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia2Bar4+V(32)
      dI(OffSet,CrtSet4)=Ib2Bar4+V(35)+V(36)
      dI(OffSet,CrtSet7)=Ic1Bar8+V(37)
      W1=-Ia2Bar4-Ib2Bar4+V(16)
      W2=-V(32)-V(35)
      W3=-V(36)-V(37)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia3Bar4+V(38)
      dI(OffSet,CrtSet5)=Ib3Bar4+V(39)+V(40)
      dI(OffSet,CrtSet8)=Ic1Bar9+V(41)
      W1=-Ia3Bar4-Ib3Bar4+V(31)
      W2=-V(38)-V(39)
      W3=-V(40)-V(41)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia4Bar4+V(42)
      dI(OffSet,CrtSet6)=Ib4Bar4+V(43)+V(44)
      dI(OffSet,CrtSet9)=Ic1Bar10+V(45)
      W1=-Ia4Bar4-Ib4Bar4-Ic1Bar10
      W2=-V(42)-V(43)
      W3=-V(44)-V(45)
      dI(OffSet,CrtSet12)=W1+W2+W3
