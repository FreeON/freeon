...
!------------------------------------------------------------------------------
   SUBROUTINE KetHRR62(LB,HRR)
      ...
      !=|6,1)
      HRR(1:LB,6,1)=HRR(1:LB,22,1)
      !=|7,1)
      HRR(1:LB,7,1)=HRR(1:LB,23,1)
      !=|8,1)
      HRR(1:LB,8,1)=HRR(1:LB,24,1)
      !=|9,1)
      HRR(1:LB,9,1)=HRR(1:LB,25,1)
      !=|10,1)
      HRR(1:LB,10,1)=HRR(1:LB,26,1)
      !=|2,1)
      HRR(1:LB,2,1)=HRR(1:LB,18,1)
      !=|3,1)
      HRR(1:LB,3,1)=HRR(1:LB,19,1)
      !=|4,1)
      HRR(1:LB,4,1)=HRR(1:LB,20,1)
      !=|1,1)
      HRR(1:LB,1,1)=HRR(1:LB,17,1)
