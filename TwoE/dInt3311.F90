...
! ---------------------------------------------------------- 
   SUBROUTINE dInt3311(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      dI(OffSet,CrtSet1)=Ia11Bar1+ABx*Ia5Bar1+dI(OffSet,CrtSet1)+V(2)+V(3)
      dI(OffSet,CrtSet4)=Ib11Bar1+ABx*Ib5Bar1+ABx*(ABx*Ib2Bar1+Ib5Bar1)+dI(OffSet,CrtSet4)+V(3)
      dI(OffSet,CrtSet7)=ABx*Ic2Bar2+Ic5Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia12Bar1+dI(OffSet,CrtSet2)+V(4)
      dI(OffSet,CrtSet5)=Ib12Bar1+dI(OffSet,CrtSet5)+V(5)+V(8)
      dI(OffSet,CrtSet8)=ABx*Ic2Bar3+Ic5Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=Ia15Bar1+dI(OffSet,CrtSet3)+V(9)
      dI(OffSet,CrtSet6)=Ib15Bar1+dI(OffSet,CrtSet6)+V(10)+V(13)
      dI(OffSet,CrtSet9)=ABx*Ic2Bar4+Ic5Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+1)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia12Bar1+dI(OffSet,CrtSet1)+V(4)
      dI(OffSet,CrtSet4)=Ib12Bar1+ABx*Ib6Bar1+ABx*(ABx*Ib3Bar1+Ib6Bar1)+dI(OffSet,CrtSet4)+V(14)
      dI(OffSet,CrtSet7)=ABx*Ic3Bar2+Ic6Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia13Bar1+ABx*Ia7Bar1+dI(OffSet,CrtSet2)+V(2)+V(3)
      dI(OffSet,CrtSet5)=Ib13Bar1+dI(OffSet,CrtSet5)+V(15)+V(18)
      dI(OffSet,CrtSet8)=ABx*Ic3Bar3+Ic6Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=Ia16Bar1+dI(OffSet,CrtSet3)+V(19)
      dI(OffSet,CrtSet6)=Ib16Bar1+dI(OffSet,CrtSet6)+V(20)+V(23)
      dI(OffSet,CrtSet9)=ABx*Ic3Bar4+Ic6Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+2)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia15Bar1+dI(OffSet,CrtSet1)+V(9)
      dI(OffSet,CrtSet4)=Ib15Bar1+ABx*Ib8Bar1+ABx*(ABx*Ib4Bar1+Ib8Bar1)+dI(OffSet,CrtSet4)+V(24)
      dI(OffSet,CrtSet7)=ABx*Ic4Bar2+Ic8Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia16Bar1+dI(OffSet,CrtSet2)+V(19)
      dI(OffSet,CrtSet5)=Ib16Bar1+dI(OffSet,CrtSet5)+V(25)+V(28)
      dI(OffSet,CrtSet8)=ABx*Ic4Bar3+Ic8Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=ABx*Ia10Bar1+Ia18Bar1+dI(OffSet,CrtSet3)+V(2)+V(3)
      dI(OffSet,CrtSet6)=Ib18Bar1+dI(OffSet,CrtSet6)+V(31)+V(32)
      dI(OffSet,CrtSet9)=ABx*Ic4Bar4+Ic8Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+0)*LDA+(OB+1)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia12Bar1+ABy*Ia5Bar1+dI(OffSet,CrtSet1)+V(14)+V(34)
      dI(OffSet,CrtSet4)=Ib12Bar1+dI(OffSet,CrtSet4)+V(5)+V(8)
      dI(OffSet,CrtSet7)=ABy*Ic2Bar2+Ic6Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia13Bar1+dI(OffSet,CrtSet2)+V(35)
      dI(OffSet,CrtSet5)=Ib13Bar1+dI(OffSet,CrtSet5)+V(3)+V(8)+V(15)
      dI(OffSet,CrtSet8)=ABy*Ic2Bar3+Ic6Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=Ia16Bar1+dI(OffSet,CrtSet3)+V(36)
      dI(OffSet,CrtSet6)=Ib16Bar1+dI(OffSet,CrtSet6)+V(13)+V(20)
      dI(OffSet,CrtSet9)=ABy*Ic2Bar4+Ic6Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+1)*LDA+(OB+1)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia13Bar1+dI(OffSet,CrtSet1)+V(35)
      dI(OffSet,CrtSet4)=Ib13Bar1+dI(OffSet,CrtSet4)+V(15)+V(18)
      dI(OffSet,CrtSet7)=ABy*Ic3Bar2+Ic7Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia14Bar1+ABy*Ia7Bar1+dI(OffSet,CrtSet2)+V(14)+V(34)
      dI(OffSet,CrtSet5)=Ib14Bar1+ABy*Ib7Bar1+dI(OffSet,CrtSet5)+V(14)+V(18)
      dI(OffSet,CrtSet8)=ABy*Ic3Bar3+Ic7Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=Ia17Bar1+dI(OffSet,CrtSet3)+V(37)
      dI(OffSet,CrtSet6)=Ib17Bar1+dI(OffSet,CrtSet6)+V(23)+V(38)
      dI(OffSet,CrtSet9)=ABy*Ic3Bar4+Ic7Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+2)*LDA+(OB+1)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia16Bar1+dI(OffSet,CrtSet1)+V(36)
      dI(OffSet,CrtSet4)=Ib16Bar1+dI(OffSet,CrtSet4)+V(25)+V(28)
      dI(OffSet,CrtSet7)=ABy*Ic4Bar2+Ic9Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia17Bar1+dI(OffSet,CrtSet2)+V(37)
      dI(OffSet,CrtSet5)=Ib17Bar1+ABy*Ib9Bar1+dI(OffSet,CrtSet5)+V(24)+V(28)
      dI(OffSet,CrtSet8)=ABy*Ic4Bar3+Ic9Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=ABy*Ia10Bar1+Ia19Bar1+dI(OffSet,CrtSet3)+V(14)+V(34)
      dI(OffSet,CrtSet6)=Ib19Bar1+dI(OffSet,CrtSet6)+V(31)+V(39)
      dI(OffSet,CrtSet9)=ABy*Ic4Bar4+Ic9Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+0)*LDA+(OB+2)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia15Bar1+ABz*Ia5Bar1+dI(OffSet,CrtSet1)+V(24)+V(41)
      dI(OffSet,CrtSet4)=Ib15Bar1+dI(OffSet,CrtSet4)+V(10)+V(13)
      dI(OffSet,CrtSet7)=ABz*Ic2Bar2+Ic8Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia16Bar1+dI(OffSet,CrtSet2)+V(42)
      dI(OffSet,CrtSet5)=Ib16Bar1+dI(OffSet,CrtSet5)+V(13)+V(20)
      dI(OffSet,CrtSet8)=ABz*Ic2Bar3+Ic8Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=Ia18Bar1+dI(OffSet,CrtSet3)+V(43)
      dI(OffSet,CrtSet6)=Ib18Bar1+dI(OffSet,CrtSet6)+V(3)+V(13)+V(32)
      dI(OffSet,CrtSet9)=ABz*Ic2Bar4+Ic8Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+1)*LDA+(OB+2)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia16Bar1+dI(OffSet,CrtSet1)+V(42)
      dI(OffSet,CrtSet4)=Ib16Bar1+dI(OffSet,CrtSet4)+V(20)+V(23)
      dI(OffSet,CrtSet7)=ABz*Ic3Bar2+Ic9Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia17Bar1+ABz*Ia7Bar1+dI(OffSet,CrtSet2)+V(24)+V(41)
      dI(OffSet,CrtSet5)=Ib17Bar1+dI(OffSet,CrtSet5)+V(23)+V(38)
      dI(OffSet,CrtSet8)=ABz*Ic3Bar3+Ic9Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=Ia19Bar1+dI(OffSet,CrtSet3)+V(44)
      dI(OffSet,CrtSet6)=Ib19Bar1+dI(OffSet,CrtSet6)+V(14)+V(23)+V(39)
      dI(OffSet,CrtSet9)=ABz*Ic3Bar4+Ic9Bar4+dI(OffSet,CrtSet9)
      OffSet=(OA+2)*LDA+(OB+2)*LDB+(OC+0)*LDC+(OD+0)*LDD
      dI(OffSet,CrtSet1)=Ia18Bar1+dI(OffSet,CrtSet1)+V(43)
      dI(OffSet,CrtSet4)=Ib18Bar1+dI(OffSet,CrtSet4)+V(31)+V(32)
      dI(OffSet,CrtSet7)=Ic10Bar2+ABz*Ic4Bar2+dI(OffSet,CrtSet7)
            dI(OffSet,CrtSet2)=Ia19Bar1+dI(OffSet,CrtSet2)+V(44)
      dI(OffSet,CrtSet5)=Ib19Bar1+dI(OffSet,CrtSet5)+V(31)+V(39)
      dI(OffSet,CrtSet8)=Ic10Bar3+ABz*Ic4Bar3+dI(OffSet,CrtSet8)
            dI(OffSet,CrtSet3)=ABz*Ia10Bar1+Ia20Bar1+dI(OffSet,CrtSet3)+V(24)+V(41)
      dI(OffSet,CrtSet6)=ABz*Ib10Bar1+Ib20Bar1+dI(OffSet,CrtSet6)+V(24)+V(31)
