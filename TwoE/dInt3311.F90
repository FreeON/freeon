...
! ---------------------------------------------------------- 
   SUBROUTINE dInt3311(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo, & 
      ...
      V(100)=ABy*Ic2Bar2
      V(101)=ABy*Ia6Bar1
      V(102)=Ia13Bar1+V(101)
      V(103)=ABy*V(14)
      V(104)=ABy*Ic2Bar3
      V(105)=-V(101)
      V(106)=ABy*Ia8Bar1
      V(107)=Ia16Bar1+V(106)
      V(108)=ABy*V(27)
      V(109)=Ib16Bar1+V(57)+V(108)
      V(110)=ABy*Ic2Bar4
      V(111)=-V(106)
      V(112)=-V(108)
      V(113)=ABy*Ic3Bar2
      ...
      V(117)=ABy*Ic3Bar3
      V(118)=ABy*Ia9Bar1
      V(119)=Ia17Bar1+V(118)
      V(120)=ABz*Ib7Bar1
      V(121)=ABy*V(59)
      V(122)=Ib17Bar1+V(120)+V(121)
      V(123)=ABy*Ic3Bar4
      V(124)=-Ia17Bar1
      V(125)=-V(118)
      V(126)=-Ib17Bar1
      ...
      V(148)=ABz*Ic2Bar2
      V(149)=ABz*Ia6Bar1
      V(150)=Ia16Bar1+V(149)
      V(151)=ABz*Ic2Bar3
      V(152)=-V(149)
      V(153)=ABz*Ia8Bar1
      V(154)=Ia18Bar1+V(153)
      V(155)=ABz*V(27)
      V(156)=ABz*Ic2Bar4
      V(157)=-V(153)
      V(158)=ABz*Ic3Bar2
      ...
      dI(OffSet,CrtSet1)=Ia11Bar1+V(2)+V(3)+V(4)
      dI(OffSet,CrtSet4)=Ib11Bar1+V(3)+V(5)+V(8)
      dI(OffSet,CrtSet7)=Ic5Bar2+V(9)
      ...
      dI(OffSet,CrtSet8)=Ic5Bar3+V(17)
      W1=-Ic5Bar3-V(17)+V(18)
      W2=V(19)+V(20)+V(21)+V(22)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=V(24)
      dI(OffSet,CrtSet6)=V(29)
      dI(OffSet,CrtSet9)=Ic5Bar4+V(30)
      W1=-Ic5Bar4-V(30)+V(31)
      W2=V(32)+V(33)+V(34)+V(35)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+1)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(11)
      dI(OffSet,CrtSet4)=Ib12Bar1+V(36)+V(37)+V(40)
      dI(OffSet,CrtSet7)=Ic6Bar2+V(41)
      W1=I3Bar1+V(18)+V(19)+V(20)
      W2=-V(37)-V(40)
      W3=-V(41)+V(42)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=Ia13Bar1+V(2)+V(3)+V(43)
      dI(OffSet,CrtSet5)=V(48)
      dI(OffSet,CrtSet8)=Ic6Bar3+V(49)
      W1=I2Bar1+V(1)-V(43)-V(49)
      W2=V(50)+V(51)+V(52)+V(53)+V(54)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=V(56)
      dI(OffSet,CrtSet6)=V(61)
      dI(OffSet,CrtSet9)=Ic6Bar4+V(62)
      W1=-V(62)+V(63)+V(64)
      W2=V(65)+V(66)+V(67)+V(68)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+2)*LDA+(OB+0)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(24)
      dI(OffSet,CrtSet4)=Ib15Bar1+V(69)+V(70)+V(73)
      dI(OffSet,CrtSet7)=Ic8Bar2+V(74)
      W1=I4Bar1+V(31)+V(32)+V(33)
      W2=-V(70)-V(73)
      W3=-V(74)+V(75)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=V(56)
      dI(OffSet,CrtSet5)=V(80)
      dI(OffSet,CrtSet8)=Ic8Bar3+V(81)
      W1=V(63)+V(64)+V(65)
      W2=-V(81)+V(82)+V(83)+V(84)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia18Bar1+V(2)+V(3)+V(85)
      dI(OffSet,CrtSet6)=V(90)
      dI(OffSet,CrtSet9)=Ic8Bar4+V(91)
      W1=I2Bar1+V(1)-V(85)-V(91)
      W2=V(92)+V(93)+V(94)+V(95)+V(96)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+0)*LDA+(OB+1)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia12Bar1+V(36)+V(98)+V(99)
      dI(OffSet,CrtSet4)=V(16)
      dI(OffSet,CrtSet7)=Ic6Bar2+V(100)
      W1=I3Bar1+V(18)+V(20)+V(21)
      W2=V(22)+V(42)
      W3=V(97)-V(99)-V(100)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=V(102)
      dI(OffSet,CrtSet5)=Ib13Bar1+V(3)+V(44)+V(103)
      dI(OffSet,CrtSet8)=Ic6Bar3+V(104)
      W1=I2Bar1+V(50)+V(51)+V(52)
      W2=V(54)-V(103)
      W3=-V(104)+V(105)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=V(107)
      dI(OffSet,CrtSet6)=V(109)
      dI(OffSet,CrtSet9)=Ic6Bar4+V(110)
      W1=V(63)+V(65)+V(66)
      W2=V(68)-V(110)+V(111)+V(112)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+1)*LDA+(OB+1)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(102)
      dI(OffSet,CrtSet4)=V(48)
      dI(OffSet,CrtSet7)=Ic7Bar2+V(113)
      W1=-Ic7Bar2+V(50)+V(51)
      W2=V(52)+V(53)+V(105)-V(113)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia14Bar1+V(36)+V(98)+V(114)
      dI(OffSet,CrtSet5)=Ib14Bar1+V(36)+V(115)+V(116)
      dI(OffSet,CrtSet8)=Ic7Bar3+V(117)
      ...
      dI(OffSet,CrtSet3)=V(119)
      dI(OffSet,CrtSet6)=V(122)
      dI(OffSet,CrtSet9)=Ic7Bar4+V(123)
      W1=-Ic7Bar4-V(123)+V(124)
      W2=V(125)+V(126)+V(127)+V(128)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+2)*LDA+(OB+1)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(107)
      dI(OffSet,CrtSet4)=V(80)
      dI(OffSet,CrtSet7)=Ic9Bar2+V(129)
      W1=V(63)+V(65)+V(82)
      W2=V(83)+V(111)-V(129)+V(130)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=V(119)
      dI(OffSet,CrtSet5)=Ib17Bar1+V(69)+V(131)+V(132)
      dI(OffSet,CrtSet8)=Ic9Bar3+V(133)
      W1=I4Bar1+V(124)+V(125)+V(126)
      W2=-V(131)-V(132)
      W3=-V(133)+V(134)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=Ia19Bar1+V(36)+V(98)+V(135)
      dI(OffSet,CrtSet6)=V(138)
      dI(OffSet,CrtSet9)=Ic9Bar4+V(139)
      W1=I3Bar1+V(97)-V(135)-V(139)
      W2=V(140)+V(141)+V(142)+V(143)+V(144)
      dI(OffSet,CrtSet12)=W1+W2
      OffSet=(OA+0)*LDA+(OB+2)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=Ia15Bar1+V(69)+V(146)+V(147)
      dI(OffSet,CrtSet4)=V(29)
      dI(OffSet,CrtSet7)=Ic8Bar2+V(148)
      W1=I4Bar1+V(31)+V(33)+V(34)
      W2=V(35)+V(75)
      W3=V(145)-V(147)-V(148)
      dI(OffSet,CrtSet10)=W1+W2+W3
      dI(OffSet,CrtSet2)=V(150)
      dI(OffSet,CrtSet5)=V(109)
      dI(OffSet,CrtSet8)=Ic8Bar3+V(151)
      W1=V(63)+V(65)+V(66)
      W2=V(84)+V(112)-V(151)+V(152)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=V(154)
      dI(OffSet,CrtSet6)=Ib18Bar1+V(3)+V(89)+V(155)
      dI(OffSet,CrtSet9)=Ic8Bar4+V(156)
      W1=I2Bar1+V(92)+V(93)+V(95)
      W2=V(96)-V(155)
      W3=-V(156)+V(157)
      dI(OffSet,CrtSet12)=W1+W2+W3
      OffSet=(OA+1)*LDA+(OB+2)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(150)
      dI(OffSet,CrtSet4)=V(61)
      dI(OffSet,CrtSet7)=Ic9Bar2+V(158)
      W1=V(63)+V(65)+V(66)
      W2=V(67)+V(130)+V(152)-V(158)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=Ia17Bar1+V(69)+V(146)+V(159)
      dI(OffSet,CrtSet5)=V(122)
      dI(OffSet,CrtSet8)=Ic9Bar3+V(160)
      W1=I4Bar1+V(124)+V(126)+V(127)
      W2=V(128)+V(134)
      W3=V(145)-V(159)-V(160)
      dI(OffSet,CrtSet11)=W1+W2+W3
      dI(OffSet,CrtSet3)=V(162)
      dI(OffSet,CrtSet6)=Ib19Bar1+V(36)+V(137)+V(163)
      dI(OffSet,CrtSet9)=Ic9Bar4+V(164)
      W1=I3Bar1+V(140)+V(141)+V(143)
      W2=V(144)-V(163)
      W3=-V(164)+V(165)
      dI(OffSet,CrtSet12)=W1+W2+W3
      OffSet=(OA+2)*LDA+(OB+2)*LDB+(OC+0)*LDC+(OD+0)*LDD !=ZippyForPres
      dI(OffSet,CrtSet1)=V(154)
      dI(OffSet,CrtSet4)=V(90)
      dI(OffSet,CrtSet7)=Ic10Bar2+V(166)
      W1=-Ic10Bar2+V(92)+V(93)
      W2=V(94)+V(95)+V(157)-V(166)
      dI(OffSet,CrtSet10)=W1+W2
      dI(OffSet,CrtSet2)=V(162)
      dI(OffSet,CrtSet5)=V(138)
      dI(OffSet,CrtSet8)=Ic10Bar3+V(167)
      W1=-Ic10Bar3+V(140)+V(141)
      W2=V(142)+V(143)+V(165)-V(167)
      dI(OffSet,CrtSet11)=W1+W2
      dI(OffSet,CrtSet3)=Ia20Bar1+V(69)+V(146)+V(168)
      dI(OffSet,CrtSet6)=Ib20Bar1+V(69)+V(169)+V(170)
      dI(OffSet,CrtSet9)=Ic10Bar4+V(171)
      W1=2.D0*I4Bar1-Ia20Bar1
      W2=-Ib20Bar1-Ic10Bar4
      W3=V(145)-V(168)
      W4=-V(169)
      W5=-V(170)-V(171)
