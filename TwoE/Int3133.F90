...
! ---------------------------------------------------------- 
   SUBROUTINE Int3133(Ax,Ay,Az,Bx,By,Bz,Cx,Cy,Cz, &  
      ...
      ENDDO ! |N0) loop
      ! HRR 
      I(2,1,2,2)=MBarN(5,5)+MBarN(5,2)*CDx+(MBarN(2,5)+MBarN(2,2)*CDx)*ABx+I(2,1,2,2)
      I(3,1,2,2)=MBarN(6,5)+MBarN(6,2)*CDx+(MBarN(3,5)+MBarN(3,2)*CDx)*ABx+I(3,1,2,2)
      I(4,1,2,2)=MBarN(8,5)+MBarN(8,2)*CDx+(MBarN(4,5)+MBarN(4,2)*CDx)*ABx+I(4,1,2,2)
      I(2,1,3,2)=MBarN(5,6)+MBarN(5,3)*CDx+(MBarN(2,6)+MBarN(2,3)*CDx)*ABx+I(2,1,3,2)
      I(3,1,3,2)=MBarN(6,6)+MBarN(6,3)*CDx+(MBarN(3,6)+MBarN(3,3)*CDx)*ABx+I(3,1,3,2)
      I(4,1,3,2)=MBarN(8,6)+MBarN(8,3)*CDx+(MBarN(4,6)+MBarN(4,3)*CDx)*ABx+I(4,1,3,2)
      I(2,1,4,2)=MBarN(5,8)+MBarN(5,4)*CDx+(MBarN(2,8)+MBarN(2,4)*CDx)*ABx+I(2,1,4,2)
      I(3,1,4,2)=MBarN(6,8)+MBarN(6,4)*CDx+(MBarN(3,8)+MBarN(3,4)*CDx)*ABx+I(3,1,4,2)
      I(4,1,4,2)=MBarN(8,8)+MBarN(8,4)*CDx+(MBarN(4,8)+MBarN(4,4)*CDx)*ABx+I(4,1,4,2)
      I(2,1,2,3)=MBarN(5,6)+MBarN(5,2)*CDy+ABx*(MBarN(2,6)+MBarN(2,2)*CDy)+I(2,1,2,3)
      I(3,1,2,3)=MBarN(6,6)+MBarN(6,2)*CDy+ABx*(MBarN(3,6)+MBarN(3,2)*CDy)+I(3,1,2,3)
      I(4,1,2,3)=MBarN(8,6)+MBarN(8,2)*CDy+ABx*(MBarN(4,6)+MBarN(4,2)*CDy)+I(4,1,2,3)
      I(2,1,3,3)=MBarN(5,7)+MBarN(5,3)*CDy+ABx*(MBarN(2,7)+MBarN(2,3)*CDy)+I(2,1,3,3)
      I(3,1,3,3)=MBarN(6,7)+MBarN(6,3)*CDy+ABx*(MBarN(3,7)+MBarN(3,3)*CDy)+I(3,1,3,3)
      I(4,1,3,3)=MBarN(8,7)+MBarN(8,3)*CDy+ABx*(MBarN(4,7)+MBarN(4,3)*CDy)+I(4,1,3,3)
      I(2,1,4,3)=MBarN(5,9)+MBarN(5,4)*CDy+ABx*(MBarN(2,9)+MBarN(2,4)*CDy)+I(2,1,4,3)
      I(3,1,4,3)=MBarN(6,9)+MBarN(6,4)*CDy+ABx*(MBarN(3,9)+MBarN(3,4)*CDy)+I(3,1,4,3)
      I(4,1,4,3)=MBarN(8,9)+MBarN(8,4)*CDy+ABx*(MBarN(4,9)+MBarN(4,4)*CDy)+I(4,1,4,3)
      I(2,1,2,4)=MBarN(5,8)+MBarN(5,2)*CDz+ABx*(MBarN(2,8)+MBarN(2,2)*CDz)+I(2,1,2,4)
      I(3,1,2,4)=MBarN(6,8)+MBarN(6,2)*CDz+ABx*(MBarN(3,8)+MBarN(3,2)*CDz)+I(3,1,2,4)
      I(4,1,2,4)=MBarN(8,8)+MBarN(8,2)*CDz+ABx*(MBarN(4,8)+MBarN(4,2)*CDz)+I(4,1,2,4)
      I(2,1,3,4)=MBarN(5,9)+MBarN(5,3)*CDz+ABx*(MBarN(2,9)+MBarN(2,3)*CDz)+I(2,1,3,4)
      I(3,1,3,4)=MBarN(6,9)+MBarN(6,3)*CDz+ABx*(MBarN(3,9)+MBarN(3,3)*CDz)+I(3,1,3,4)
      I(4,1,3,4)=MBarN(8,9)+MBarN(8,3)*CDz+ABx*(MBarN(4,9)+MBarN(4,3)*CDz)+I(4,1,3,4)
      I(2,1,4,4)=MBarN(5,10)+MBarN(5,4)*CDz+ABx*(MBarN(2,10)+MBarN(2,4)*CDz)+I(2,1,4,4)
      I(3,1,4,4)=MBarN(6,10)+MBarN(6,4)*CDz+ABx*(MBarN(3,10)+MBarN(3,4)*CDz)+I(3,1,4,4)
      I(4,1,4,4)=MBarN(8,10)+MBarN(8,4)*CDz+ABx*(MBarN(4,10)+MBarN(4,4)*CDz)+I(4,1,4,4)
