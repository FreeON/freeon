...
! ---------------------------------------------------------- 
   SUBROUTINE Int3113(PrmBufB,LBra,PrmBufK,LKet,ACInfo,BDInfo,I) 
      ...
      ENDDO ! |N0) loop
      ! HRR 
      I(2,1,1,2)=CDx*I2Bar1+I2Bar2
      I(3,1,1,2)=CDx*I3Bar1+I3Bar2
      I(4,1,1,2)=CDx*I4Bar1+I4Bar2
      I(2,1,1,3)=CDy*I2Bar1+I2Bar3
      I(3,1,1,3)=CDy*I3Bar1+I3Bar3
      I(4,1,1,3)=CDy*I4Bar1+I4Bar3
      I(2,1,1,4)=CDz*I2Bar1+I2Bar4
      I(3,1,1,4)=CDz*I3Bar1+I3Bar4
      I(4,1,1,4)=CDz*I4Bar1+I4Bar4
