...
!
  ...
  SPVck(1)=  BlkTrace_2(Pair%NB,Pair%NA,W,GXP(1,1))
  SPVck(2)=  BlkTrace_2(Pair%NB,Pair%NA,W,GYP(1,1))
  SPVck(3)=  BlkTrace_2(Pair%NB,Pair%NA,W,GZP(1,1))
END FUNCTION GradSBlok
END MODULE GradSBlock
