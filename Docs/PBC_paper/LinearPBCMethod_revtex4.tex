...
quantum chemistry code {\sc MondoSCF}\cite{MondoSCF}.
...
\cite{Bentley79}. All {\sc MondoSCF} calculations are done at the gamma-point.
This is because the main focus of the {\sc MondoSCF} linear scaling quantum chemistry
code is large systems, where for insulators k-space integrations become unnecessary 
\cite{Nunes94}.


To demonstrate and validate the capabilities of {\sc MondoSCF}, we show results for 
...
Gaussian code {\sc CRYSTAL} \cite{Crystal98}. Next we demonstrate that
the code achieves {\it true} linear scaling for the dense periodic diamond system 
up to 512 atoms in the unit cell.
%
% Example system
%
%To show the full capabilities of {\sc MondoSCF} we calculate the surface reconstruction
%of the Silicon (111) surface with a step.
%
Finally we give some conclusion concerning the accuracy and utility of {\sc MondoSCF}
