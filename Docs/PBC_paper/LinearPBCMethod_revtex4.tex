...
validation test condensed phase systems, Sodium Chloride, Magnesium Oxide 
...
reference \cite{MChallacombe03A}. 
...
summation. In \cite{PFFTensorMake} we describe an efficient method which allows
...
\label{Q} 
\end{eqnarray}
are the dipole and quadrapole moments. In appendix \ref{DipC} we give a short
