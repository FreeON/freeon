...
%
\vskip 0.07 in
\noindent{\bf Keywords}: Self-consistent-field, linear-scaling,tree-code, Gaussian-orbital
%
\end{abstract}
...
\footnotetext[4]{Preprint LA-UR-03-7723.}
...
important symmetries is to set ${\bf k}=0$ but to use a larger supercell created through 
replication 
