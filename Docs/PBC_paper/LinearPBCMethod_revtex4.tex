...
development \cite{Goedecker94,Challacombe96,Canning96,Briggs96,Hernandex96,Scuseria99,ANiklasson02}. 
...
\end{equation}
and the exchange correaltion potential can be calculated from several approximated functionals
\cite{Hertwig97,Bauschlicher95,Adamo00}
...
\begin{equation}
\Phi _{Ew}\left( \mathbf{x}\right) =\Phi _{ss}\left( \mathbf{x}\right) -\frac{4\pi }{3V}
{\left( \mathbf{x}-\mathbf{R}_{0}\right) \cdot \mathbf{D}}+\frac{2\pi }{3V}Q
\label{EW_pot}
\end{equation}
...
\right) \left\{ \frac{2\pi }{3V}Q-\frac{4\pi }{3V}\left( \mathbf{x}-\mathbf{R}_{0}\right) \cdot 
\mathbf{D}\right\}
\nonumber\\
...
and the Crystal98 basis set 8-511G, and two different theory levels, 
...
with Crystal98 results inwhich we do k-space integration. 
...
for the matrix build commences very early. 
...
for the dense diamond periodic system for the Crysral98 basis set 6-31G*/BLYP}
...
of a 512 atom diamond system using the 6-21G*/BLYP basis-set/theory}
