...
achieving linear scaling through the use of modern data structures.  With these developments, convergence of the $\Gamma$-point 
supercell approximation to the $\bf k$-space integration limit is demonstrated for MgO and NaCl.    Linear scaling 
construction of the Fockian and control of error is demonstrated for RBLYP/6-21G* diamond up to 512 atoms.  \\
...
pentaerythritol tetranitrate \cite{CGan04A} at the RPBE/6-31G** level of theory, with a {\tt GOOD} accuracy level.
...
direction.  {\bf USING A WHAT KIND OF METHOD??}, we are able to obtain  $\sim 8-10$ digit accuracy 
in the two-dimensional  \( {\cal M} \).
