...
\begin{equation}
\Phi _{\rm Ew}\left( \mathbf{r}\right) =\Phi _{\rm SS}\left( \mathbf{r}\right) + \frac{2\pi }
...
8-511/BLYP level of theory at a {\it tight} accuracy level. The lattice coordinates for 
...
and BLYP functional \cite{DFT_LYP:88,BLYP:88}, while in Table~\ref{NaClGammaPt} convergence of the supercell 
...
Demonstrating perfect linear scaling at the outset,  Fig.~\ref{Scaling_Matrix_Build} shows the CPU time for 
$\bf J$ and $\bf K_{\rm xc}$
