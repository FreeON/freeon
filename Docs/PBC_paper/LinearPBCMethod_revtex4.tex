...
replication 
and translation of the primitive unit cell.  This is the supercell $\Gamma$-point approximation, used
...
error estimates that depend on the magnitude and extent of both bra and ket \cite{CTymczak03c} 
...
condition that is easily transformed to Ewald boundary conditions.
In order to achieve linear scaling of the local Coulomb field, a Quantum
Chemical Tree Code (QCTC) is implimented. 
%
...
%
Filally, we demonstrated that \textbf{MondoSCF} achieves {\it true} linear scaling
