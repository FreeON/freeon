...
to achieve a linear scaling cost with system size for insulating systems.  Secondly,  almost all one and two electron integrals 
involving GTAOs are analytic, enabling the 
rapid evaluation of expectation values involving complicated operators often involved in response properties \cite{}.
...
The use of hybrid methods in the condensed phase has been pioneered by the {\sc CRYSTAL} group \cite{},
demonstrating blah gnu snort for difficult problems \cite{}.
