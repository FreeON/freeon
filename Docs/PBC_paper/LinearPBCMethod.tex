...
\title{Linear scaling computation of the Fock matrix VI. \\
       Periodic boundary conditions and pure Density Functional Theory}
...
\keywords{self-consistent-field,linear-scaling,tree-code,adaptive numerical integration,Gaussian-orbital}
