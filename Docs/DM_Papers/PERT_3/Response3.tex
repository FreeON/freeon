...
The third order energy correction is given in an othogonal representation
by
\begin{equation}
...
A similar epression can be derived for the fourth order
\begin{equation}
  \begin{split}
  ...
  \end{split}
\end{equation}
 This relation may seem to be very expansive to compute. After further
inspections, we see that the correction along the same direction e.g. $E^{aaaa}$,
...
relation (ref{}) simplifies to only 12 terms (108 matrix multiplications 
{\bf CAN BE REDUCED WITH THE TRACE}).
\begin{equation}
