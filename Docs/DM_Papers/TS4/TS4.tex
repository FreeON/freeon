...
density matrix scale as $\tau \Delta g^{-1}$ at worst, where $\Delta g$ is the gap at 
...
Trace Re-Setting method is quite general.  We note, for example, that a higher order
...
and $\gamma \in [0,1]$. 
%
If the re-deistribution step of the spectral projection SP2 is removed and if
...
small dense matrix-matrix multiplies ({\tt DGEMM}s) that have been written in highly optimized on
