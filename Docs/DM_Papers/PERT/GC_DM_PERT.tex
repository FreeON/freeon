...
%The technique allows treatment of embedded quantum subsystems 
%with a computational cost scaling linearly with the size of the perturbed 
...
%It also allows direct computation of the density matrix response 
