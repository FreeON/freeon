...
complex and disordered systems such as liquides, low concentation defects, adsorption of 
...
To analyze the convergence of the $\Gamma$-point energy to the ${\bf k}$-space limit
...
theory. The basis set is the same as in Ref~\cite{RDovesi90}.
For the sake of comparison, we have also fully optimized a tetragonal lattice
...
The reason for this disagrement can be found in the different atomic basis set used.
...
quantitaive way, we have performed gas phase geometry optimizations 
(using the {\sc Gamess}~\cite{gamess} package) at the RHF/6-21G* level 
...
%     1    -3581.5628751397
    ...
    $a_0$           & 5.613 & & 5.524 \\
    $c_0$           & 4.653 & & 4.642 \\                    
    $E/n$           & $-$223.8476797 & &$-$223.84161 \\%-223.7964330646-6D  -223.7884474840-5D
%                                         -447.6736050476
%                                         -447.6741364066 4x4x4
%
    &\multicolumn{3}{c}{Bond lengths} \\
    C$=$O           & 1.246 & & 1.246 \\
    C$-$N           & 1.334 & & 1.332 \\
    N$-$H$_1$       & 1.002 & & 1.000 \\%cis-O
    N$-$H$_2$       & 1.001 & & 0.999 \\%trans-O
    &\multicolumn{3}{c}{Bond angles} \\
    OCN             & 121.5 & & 121.5 \\
    CNH$_1$         & 119.5 & & 119.1 \\%cis-O
