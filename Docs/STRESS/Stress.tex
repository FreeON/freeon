...
$\mathbf{f}_A,\mathbf{f}_B,\ldots$ as $\{\mathbf{f}_A\}$.
...
$abcd$ over the basis functions, $P=P(\{\mathbf{f}_A\},M)$ is the density matrix 
and the ERIs are written in the chemist notation.
%\begin{equation}
%  \begin{split}
%    (ac^\mathbf{m}|bd^\mathbf{n})=
...
\begin{equation*}
 \frac{\partial E^x}{\partial f_{Gj}}=\sum_{i=x,y,z}M_{ij}\frac{\partial E^x}{\partial G_i},
\end{equation*}
where $\partial E^x/\partial G_i$ is the exchange energy gradient wrt atomic position and
is given by
