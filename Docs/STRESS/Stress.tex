...
{\sc Crystal03}~\cite{Crystal03} package (last column of Table~\ref{Tab:Urea}), 
...
while {\sc MondoSCF} pure Cartesian basis functions i.e.~6 atomic orbitals 
...
as what we could observe
for gas phase calculations. We conclude that the differences observed for the energy
...
fractional coordinates of the oxygen computed
...
The smallest system (MgO)$_4$ shows a large discrepantcy of the cell parameter, energy and 
...
and the energy systematical converges while the system grows.
\begin{table}[t]
  \centering
  \caption{\protect
