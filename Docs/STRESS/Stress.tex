...
The $\Gamma$-point approache opens the capabilities of studing very large 
complexe and disordered systems such as liquides,....
...
Note that the discountinuty arising from the use of the nearest 
integer function (See Eq.~\ref{Eq:MIC}) disapares in the limit of a
...
%    $n$ is the number of MgO units in the (super)cell.
  ...
  \hline
    ...
    & 108 & 4.192 & $-$274.664299 \\%12.575-274.664299043364FullOpt
...
large unphysical gradients which reflets 
