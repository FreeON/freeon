...
\begin{abstract}
We derive an exact error bound for the multipole approximation as it is used in both multipole tree-codes
and also the fast multipole method (FMM). We show how this exact error bound can be incorporated into
multipole tree-code. Tree-codes are used both in large scale astrophysical 
...
when our new error bound is used, and that we can achieve significant speedups for the tolerance $\tau < 10^-4$, 
