...
% the most widely used communication tools.
 ...
 This contrast with the $\mathcal{O}(N)$ computation of the exact exchange matrix and the $\mathcal{O}(N)$
 communication required to distribute and collect the density and exchange matrices, respectively.
