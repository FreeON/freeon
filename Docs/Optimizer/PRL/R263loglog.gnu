...
set xlabel "log_{10}(E_{i}-E_{opt})" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [-6 : 1 ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "log_{10}(E_{i+1}-E_{opt})" 0.000000,0.000000  font ""
set y2label "" 0.000000,0.000000  font ""
set yrange [-6 : 1 ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
...
set loadpath 
set fontpath 
plot "log-log" u 4:5 w linespoints notitle lw 2 ps 2,-0.049802798+1.001111083*x notitle lw 2
#    EOF
