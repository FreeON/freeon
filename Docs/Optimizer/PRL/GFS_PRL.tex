...
would be quadratically convergent, as long as the normal modes
...
for quadratic convergence, as long as the rate of vibrational
...
\end{figure}
The curves-fitting happens through 
...
the Optimization through Gradient Curve Fitting
technique in a forthcoming paper \cite{bisect-paper}.
