...
the value of $0.5$ a.u. for stretches, $0.2$ a.u. 
for bendings, linear bending 
and out-of-planes and $0.1$ a.u. for torsions. These values equal
to those used to provide an initial guess for the Hessian in
