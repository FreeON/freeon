...
unset grid
set key title ""
set key -7.0, -5, 0 Right noreverse enhanced box linetype -2 linewidth 1.000 samplen 4 spacing 1 width 0 height 0 autotitles
unset label
unset arrow
unset style line
unset style arrow
...
set loadpath 
set fontpath 
plot "T27logdata2" u 6:7 w linespoints notitle lw 2 ps 2, x lw 2 title "y=x"
#    EOF
