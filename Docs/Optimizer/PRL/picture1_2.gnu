...
unset key
unset label
set label 1 "#1" at 119.162, 0.0137771, 0 centre norotate back nopoint
set label 2 "#2" at 117.075, 0.029745, 0 centre norotate back nopoint
set label 3 "#3" at 112.988, 0.0271256, 0 centre norotate back nopoint
set label 4 "#4" at 106.814, 0.016734, 0 centre norotate back nopoint
set label 5 "#5" at 100.64, 0.00266387, 0 centre norotate back nopoint
unset arrow
unset style line
unset style arrow
unset logscale
...
set ytics border mirror norotate 0.00000,0.01
...
set yrange [ -0.00500000 : 0.0350000 ] noreverse nowriteback
...
set loadpath 
set fontpath 
plot "1_5_6_Data" u 2:3 w points pointtype 4 pointsize 3,-0.20506391638932736088+0.00202490479729797038*x lw 2, "1_5_6_Pred" u 1:2 w points pointtype 3 pointsize 3
#    EOF
