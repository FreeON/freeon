...
followed by forward and backward substitution, as described in Ref.~[\onlinecite{KNemeth00B}].  
Linear scaling factorization of ${\bf B}^t \bf B$ may be achieved, as the upper left-hand 
$3 N_a \times 3 N_a$ block is 
%hyper-sparse
{\bf
extremely sparse, as discussed in Ref.~\onlinecite{KNemeth00B},
}
leading also to  
%a hyper-sparse 
...
%Here, we are using a still experimental algorithm, 
...
topological distance is $10$ or greater.
The goal
...
Refs.~[\onlinecite{PPulay77}] and [\onlinecite{KNemeth00B,KNemeth01}].
...
\begin{figure}[h]
\witheps{\resizebox*{3.5in}{!}{\includegraphics{figure2.eps}}}
\withpdf{\resizebox*{3.5in}{!}{\includegraphics{figure2.pdf}}}
...
Here, we make direct contact with these works, Refs.[\onlinecite{TBucko05,KKudin01,BCivalleri01}].
...
Also, the performance of internal coordinate methods on molecular
crystals depends a lot on the choice of the internal coordinates.
While Bu\v{c}ko {\em et.~} used $5/R$ type coordinates to describe
intermolecular bonds, we used simple stretches that may be less 
efficient for molecular crytals. Nevertheless, 
the method of Bu\v{c}ko {\em et.~al} converges in only 6 optimization 
steps. We expect that a more similar choice of the internal coordinates
on a similar potential energy surface would bring QUICCA close
to this performance, and will investigate this point in a later study.
}
...
\witheps{\resizebox*{5in}{!}{\includegraphics[angle=-90.00]{figure2.eps}}}
\withpdf{\resizebox*{5in}{!}{\includegraphics[angle=-90.00]{figure2.pdf}}}
\end{center}
