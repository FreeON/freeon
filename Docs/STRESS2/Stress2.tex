...
%   \widetilde{P}_{l}^{m}\frac{\partial\phi_{\mathbf{G}}}{\partial M_{ij}}e^{im\phi_{\mathbf{G}}},
  \end{split}
\end{equation*}
The derivative of the associate Legendre polynomial is
\begin{equation*}
...
Derivation of ${\cal G}_{l}$ and ${\cal F}_{l}$ are
\begin{equation*}
  \begin{split}
    \frac{\partial{\cal G}_{l}}{\partial M_{ij}}&=
    \frac{-1}{\Gamma(l+1/2)R^{l+1}}\\
    &\bigg(2(\beta R)^{2l}e^{-\beta^2R^2}
    \frac{\partial(R\beta)}{\partial M_{ij}}
    +\frac{l+1}{R}\frac{\partial R}{\partial M_{ij}}  \bigg),
  \end{split}
\end{equation*}
and 
\begin{equation*}
  \begin{split}
    \frac{\partial{\cal F}_{l}}{\partial M_{ij}}&=
    \frac{1}{\Gamma(l+1/2)R^{l+1}}\\
    &\bigg(2(\beta R)^{2l}e^{-\beta^2R^2}
    \frac{\partial (R\beta)}{\partial M_{ij}}
    -\frac{l+1}{R}\frac{\partial R}{\partial M_{ij}} \bigg).
