...
%Because PETN has a number of soft modes and we are attempting to resolve 
%energy differences at the milihartree level, a ``good'' level of numerical 
%thresholding was used throughout, achieving a relative accuracy of 6-7 digits 
%in the total energy.  
