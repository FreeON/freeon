...
chemistry.}}
\commentoutB{
For the first time, we propose measurement based load balancing (Equal
Time partitioning) for domain decomposition in quantum chemistry.}
...
largest dimension.  [{\bf NOTE THAT THE LOWER RIGHT BOX IMPLIES
CUTTING THE SHORTEST DIMENSION FIRST!}]  }
\label{fig:shiftline}
\end{figure}
% END FIGURE
}
...
MondoSCF}.
%When this is accomplished, we will be able to go to larger
%systems on larger platforms, where doubtless other considerations may arise!
