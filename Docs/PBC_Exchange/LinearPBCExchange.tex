...
And two, the permutational symmetry of the exchange integral kernal, 
\begin{eqnarray}
\sum _{\bf H G}
\left(
      \phi_a    
...
\section{Integral Kernal Permutational Symmetry (IKPS)}

For small systems, the permutatioanl non-invariance of Eq. (\ref{PermSym}) can create problems 
with the Optinal Damping Algorithm (ODA) \cite{ECances00} we use to converge the SCF. The Optimal Damping
...
electrostatic energy; ${\bf P}_0$, ${\bf F}_0$ and $E^{0}_{nuc}$ are the present density matrix, fockian 
and nuclear electrostatic energy; and  ${\bf T}$ is the kinectic energy matrix. 
...
{\hskip 0.330in}$^h$Did not converge (See Ref.~\onlinecite{BCivalleri02}) \\
...
the integral kernal permutaional symmetry (IKPS) is violated. Which for small systems is at the
level of about $10^-3$ going rapidly to numerical zero as the unit cell becomes larger then the
...
\toprule
Program             & $N_{\rm H_20}$ & Energy (au)    & Energy/$N_{\rm H_2O}$ & IKPS\\ 
\colrule
{\sc MondoSCF}$^a$  & 2              &  -152.03025  &  -76.01512  & $2.5 \times 10^{-3}$\\
                    & 16             &  -1216.3003  &  -76.01877  & $2.8 \times 10^{-4}$ \\
                    & 54             &  -4105.0163  &  -76.01882  & $2.7 \times 10^{-5}$ \\
                    & 128            &  -9730.4090  &  -76.01882  & $10^0$ \\
                    & 250            &  -19004.705  &  -76.01882  & $10^0$ \\ 
\hline
...
5-11G${^*}$ basis for Hydrogen.  The {\sc MondoSCF} {\it good} option was used, delivering 
