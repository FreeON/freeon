...
Such basis set localization effects have recieved considerable attention from the
{\sc SIESTA} \cite{} and {\sc PLATO} \cite{} communities, leading to radial basis 
functions that yeild both linear scaling and high quality properties. {\bf CJ, PLEASE ADD SOME
CITATIONS HERE}
