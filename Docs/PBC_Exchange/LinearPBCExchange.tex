...
integral kernal, $\Lambda_{{\bf ac,bd}}$,  is violated. 
...
\section{Integral Kernal Permutational Symmetry}
...
\colrule
{\sc MondoSCF}$^a$  & 2    &  -152.03025  &  -76.01512  & $10^0$ \\
                    & 16   &  -1216.3003  &  -76.01877  & $10^0$ \\
                    & 54   &  -4105.0163  &  -76.01882  & $10^0$ \\
...
the  experimental value for diamond calculated at zero Kelvin is ${\rm a}_0 = 3.567$ 
...
\end{tabular}\\}
\raggedright{
{\hskip 0.35in}$^a \Gamma$-point\\
{\hskip 0.35in}$^b$ [\onlinecite{ROrlando90}]\\}
\end{table}
