...
Ref.~\onlinecite{CTymczak04a}.   The linear scaling, Quartic Trace-ReSetting ({\sc TRS4}) density 
...
primarily basis sets designed for the condensed phase.  See Ref.~\onlinecite{MTowlerLib} and references 
