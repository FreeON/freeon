...
With periodic boundary conditions, the exact Hartree-Fock exchange matrix in real space is \cite{MCausa88}
\begin{equation}
K_{ab} [{\bf G}]= - \frac{1}{2}
...
\label{CryEq}
\end{equation}
where the integrations over the Billion Zones has been already been taken, and 
the two-electron integrals have been written in the notation:
\begin{eqnarray}
\left(
      \phi        _a  
      \phi^{\bf H}_c  
