...
symmetric in the limit of infinite summation, has been truncated.  This truncation leads to an energy expression 
\begin{equation}
...
\toprule
Program         & $N_{\rm at}$              & Energy (au)    & Energy/$N_{\rm 
at}$\\ 
\colrule
...
Despite differences between {\sc MondoSCF} and {\sc CRYSTAL98}, including the use of fitting functions
and $\bf k$-space integration by {\sc CRYSTAL98} and the use of approximate ${\cal O}(N)$ scaling algorithms and 
the $\Gamma$-point approximation by $\sc MondoSCF$, we have achieved a very close agreement between the two 
methods.    
...
ability to achieve linear scaling for three-dimensional systems.  While 
