...
\cite{MCraig04} and to energetic organic materials \cite{} {\bf MORE HERE??} demonstrate the 
ability of these $N$-scaling algorithms to make valuable contributions well beyond the domain of 
...
\toprule
Program             & $N_{\rm at}$ & Basis      &  HF     & PBE0 \\
\colrule
{\sc MondoSCF}$^a$  &  64          & sto-3g     & ~3.587~ &  ~3.601    \\
                    &  64          & 6-31g      & ~3.575~ &  ~3.500    \\
\\
                    & 216          & sto-3g     & ~3.500~ &  ~3.500    \\
                    & 216          & 6-31g      & ~3.500~ &  ~3.500    \\
\colrule
{\sc Crystal98}$^b$ &   8          & sto-3g     & ~3.500~ &  ~3.500    \\
                    &   8          & 6-31g      & ~3.500~ &  ~3.500    \\
\botrule
\end{tabular}\\}
\raggedright{
