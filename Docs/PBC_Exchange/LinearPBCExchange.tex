...
All developments  were implemented in  {\sc MondoSCF} v1.0$\alpha$9, a suite of 
...
reference [\onlinecite{ROrlando90}].  The result achieved using the 216 atom $3 \times 3 \times 3$ 
