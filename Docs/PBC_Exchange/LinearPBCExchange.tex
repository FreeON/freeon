\documentclass[prb,aps,nobibnotes,twocolumn,doublespace,twocolumngrid,superbib,showpacs]{revtex4}
...
\title{Linear scaling computation of the Fock matrix. \\ VIII.  
       Periodic, exact exchange at the $\Gamma$-point.$^1$ }
...
\footnotetext[1]{\tt Preprint LA-UR 03-9043}
...
which ensures that interactions are always calculated between nearest periodic images.
...
algorithm able to achieve scalable parallelism.
...
and the primitive cubic and triclinic cell coordinates used for this system are given in Ref.~[\onlinecite{PBCCoordinates}].   
The values controlling accuracy of the {\sc CRYSTAL98} program were 
...
compared to the experimental, $T=0$K result of $a_0=3.567$\AA.  While this result is preliminary, 
...
Localization of the  basis set  has received attention \cite{SKenny00,JJunquera01,EAnglada02},
