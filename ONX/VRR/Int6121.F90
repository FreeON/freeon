SUBROUTINE Int6121(N,IntCode,CBra,CKet,DisBufB,PrmBufB,DB,IB,SB,C,U)
  USE DerivedTypes
  USE GlobalScalars
  USE PrettyPrint
  USE GammaF3
...
!--------------------------------------------------------------------------------
  ...
  ELSEIF(IntCode.EQ.06010301) THEN
  ...
  ELSE
    CALL Halt('Illegal IntCode in Int6121')
  ENDIF
END SUBROUTINE Int6121
