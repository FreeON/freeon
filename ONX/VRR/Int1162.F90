SUBROUTINE Int1162(N,IntCode,CBra,CKet,DisBufB,PrmBufB,DB,IB,SB,C,U,PBC)
 USE DerivedTypes
 USE GlobalScalars
 USE PrettyPrint
 USE InvExp
...
!
 ...
 U(5)=QBx*U(2)+WQx*U(13)+r1x2E*(U(1)-rpxE*U(11))                                           
 U(6)=QBx*U(3)+WQx*U(14)                                          
 U(7)=QBy*U(3)+WQy*U(14)+r1x2E*(U(1)-rpxE*U(11))                                           
 U(8)=QBx*U(4)+WQx*U(16)                                          
 U(9)=QBy*U(4)+WQy*U(16)                                          
 U(10)=QBz*U(4)+WQz*U(16)+r1x2E*(U(1)-rpxE*U(11))                                          
 U(19)=QBx*U(13)+WQx*U(15)+r1x2E*(U(11)-rpxE*U(12))                                        
 U(20)=QBx*U(14)+WQx*U(17)                                        
 U(21)=QBy*U(14)+WQy*U(17)+r1x2E*(U(11)-rpxE*U(12))                                        
 U(22)=QBx*U(16)+WQx*U(18)                                        
 U(23)=QBy*U(16)+WQy*U(18)                                        
 U(24)=QBz*U(16)+WQz*U(18)+r1x2E*(U(11)-rpxE*U(12))                                        
 ...
 ENDDO
 ENDDO
 ELSEIF(IntCode.EQ. 1010603) THEN
 DO I=1,N
 I0 = SB%SLPrm%I(I)
 I2 = SB%SLDis%I(I)-4
 DO J=1,CKet
