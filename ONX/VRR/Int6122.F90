SUBROUTINE Int6122(N,IntCode,CBra,CKet,DisBufB,PrmBufB,DB,IB,SB,C,U,PBC)
 USE DerivedTypes
 USE GlobalScalars
 USE PrettyPrint
 USE InvExp
...
!
 ...
 ENDDO
 ENDDO
 ELSEIF(IntCode.EQ. 6010302) THEN
 DO I=1,N
 I0 = SB%SLPrm%I(I)
 I2 = SB%SLDis%I(I)-4
 DO J=1,CKet
...
!
 ...
 ENDDO
 ENDDO
 ELSEIF(IntCode.EQ. 6010303) THEN
 DO I=1,N
 I0 = SB%SLPrm%I(I)
 I2 = SB%SLDis%I(I)-4
 DO J=1,CKet
