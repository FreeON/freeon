SUBROUTINE Int6122(N,IntCode,CBra,CKet,DisBufB,PrmBufB,DB,IB,SB,C,U)
  USE DerivedTypes
  USE GlobalScalars
  USE PrettyPrint
  USE GammaF4
...
!--------------------------------------------------------------------------------
  ...
  DO I=1,N
    ...
    DO J=1,CKet
      ...
      C(I,18)=C(I,18)+U(22)*cq3
      C(I,19)=C(I,19)+U(23)*cq3
      C(I,20)=C(I,20)+U(24)*cq3
      C(I,21)=C(I,21)+U(25)*cq3
      C(I,22)=C(I,22)+U(26)*cq3
      C(I,23)=C(I,23)+U(27)*cq3
      ...
      C(I,69)=C(I,69)+U(22)*cq2
      C(I,70)=C(I,70)+U(23)*cq2
      C(I,71)=C(I,71)+U(24)*cq2
      C(I,72)=C(I,72)+U(25)*cq2
      C(I,73)=C(I,73)+U(26)*cq2
      C(I,74)=C(I,74)+U(27)*cq2
      C(I,86)=C(I,86)+U(73)
      C(I,87)=C(I,87)+U(74)
      C(I,88)=C(I,88)+U(75)
      C(I,89)=C(I,89)+U(76)
      C(I,90)=C(I,90)+U(77)
      C(I,91)=C(I,91)+U(78)
      C(I,103)=C(I,103)+U(5)*cq3
      C(I,104)=C(I,104)+U(6)*cq3
      C(I,105)=C(I,105)+U(7)*cq3
      C(I,106)=C(I,106)+U(8)*cq3
      C(I,107)=C(I,107)+U(9)*cq3
      C(I,108)=C(I,108)+U(10)*cq3
      C(I,120)=C(I,120)+U(22)
      C(I,121)=C(I,121)+U(23)
      C(I,122)=C(I,122)+U(24)
      C(I,123)=C(I,123)+U(25)
      C(I,124)=C(I,124)+U(26)
      C(I,125)=C(I,125)+U(27)
      C(I,137)=C(I,137)+U(39)*cq2
      C(I,138)=C(I,138)+U(40)*cq2
      C(I,139)=C(I,139)+U(41)*cq2
      C(I,140)=C(I,140)+U(42)*cq2
      C(I,141)=C(I,141)+U(43)*cq2
      C(I,142)=C(I,142)+U(44)*cq2
      C(I,154)=C(I,154)+U(90)
      C(I,155)=C(I,155)+U(91)
      C(I,156)=C(I,156)+U(92)
      C(I,157)=C(I,157)+U(93)
      C(I,158)=C(I,158)+U(94)
      C(I,159)=C(I,159)+U(95)
      C(I,171)=C(I,171)+U(107)
      C(I,172)=C(I,172)+U(108)
      C(I,173)=C(I,173)+U(109)
      C(I,174)=C(I,174)+U(110)
      C(I,175)=C(I,175)+U(111)
      C(I,176)=C(I,176)+U(112)
      C(I,188)=C(I,188)+U(39)
      C(I,189)=C(I,189)+U(40)
      C(I,190)=C(I,190)+U(41)
      C(I,191)=C(I,191)+U(42)
      C(I,192)=C(I,192)+U(43)
      C(I,193)=C(I,193)+U(44)
      C(I,205)=C(I,205)+U(56)*cq2
      C(I,206)=C(I,206)+U(57)*cq2
      C(I,207)=C(I,207)+U(58)*cq2
      C(I,208)=C(I,208)+U(59)*cq2
      C(I,209)=C(I,209)+U(60)*cq2
      C(I,210)=C(I,210)+U(61)*cq2
      C(I,222)=C(I,222)+U(124)
      C(I,223)=C(I,223)+U(125)
      C(I,224)=C(I,224)+U(126)
      C(I,225)=C(I,225)+U(127)
      C(I,226)=C(I,226)+U(128)
      C(I,227)=C(I,227)+U(129)
      C(I,239)=C(I,239)+U(141)
      C(I,240)=C(I,240)+U(142)
      C(I,241)=C(I,241)+U(143)
      C(I,242)=C(I,242)+U(144)
      C(I,243)=C(I,243)+U(145)
      C(I,244)=C(I,244)+U(146)
      C(I,256)=C(I,256)+U(158)
      C(I,257)=C(I,257)+U(159)
      C(I,258)=C(I,258)+U(160)
      C(I,259)=C(I,259)+U(161)
      C(I,260)=C(I,260)+U(162)
      C(I,261)=C(I,261)+U(163)
      C(I,273)=C(I,273)+U(56)
      C(I,274)=C(I,274)+U(57)
      C(I,275)=C(I,275)+U(58)
      C(I,276)=C(I,276)+U(59)
      C(I,277)=C(I,277)+U(60)
      C(I,278)=C(I,278)+U(61)
  ...
  ELSE
    CALL Halt('Illegal IntCode in Int6122')
  ENDIF
END SUBROUTINE Int6122
