...
!--------------------------------------------------------------------------------
  ...
  !DB%DisPtr%I(:,:,:,:) =-9999999999
!#ifdef PARALLEL_ONX                !vw
!  DO AtC=Beg%I(MyID),End%I(MyID)   !vw
!       ri=AtC-Beg%I(MyID)+1        !vw
!  IF (NameBuf%I(ri)==1) THEN       !vw
!#else                              !vw
!    DO AtC=1,NAtoms                !vw
!#endif
...
!vw
!!$        write(*,*) ' DB%DisPtr%I:'
!!$        write(*,*) 'PutDis BOUND:',lbound(DB%DisPtr%I(:,:,:,:),1),ubound(DB%DisPtr%I(:,:,:,:),1)
!!$        write(*,*) 'PutDis BOUND:',lbound(DB%DisPtr%I(:,:,:,:),2),ubound(DB%DisPtr%I(:,:,:,:),2)
!!$        write(*,*) 'PutDis BOUND:',lbound(DB%DisPtr%I(:,:,:,:),3),ubound(DB%DisPtr%I(:,:,:,:),3)
!!$        write(*,*) 'PutDis BOUND:',lbound(DB%DisPtr%I(:,:,:,:),4),ubound(DB%DisPtr%I(:,:,:,:),4)
!!$        write(*,*) ' '
!!$        write(*,*) ' DB%DisBuf%D:'
!!$        write(*,*) 'PutDis BOUND:',lbound(DB%DisBuf%D(:)),ubound(DB%DisBuf%D(:))
!!$        write(*,*) ' '
!vw
...
!!$#endif
       ...
       !write(*,*) 'AtC',AtC,' DB%LenCC',DB%LenCC,' DB%LenTC',DB%LenTC
