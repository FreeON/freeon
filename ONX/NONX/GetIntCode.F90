...
!
    ...
    IF (IntCodeC.eq.03020301) Explicit=.FALSE.
    IF (IntCodeC.eq.03030301) Explicit=.FALSE.
    IF (IntCodeC.eq.03020201) Explicit=.FALSE.
    IF (IntCodeC.eq.03030201) Explicit=.FALSE.
    IF (IntCodeC.eq.02020301) Explicit=.FALSE.
    IF (IntCodeC.eq.03010302) Explicit=.FALSE.
    IF (IntCodeC.eq.02010303) Explicit=.FALSE.
    IF (IntCodeC.eq.03010303) Explicit=.FALSE.
    IF (IntCodeC.eq.03010202) Explicit=.FALSE.
    IF (IntCodeC.eq.02010302) Explicit=.FALSE.
    IF (IntCodeC.eq.06030101) Explicit=.FALSE.
    IF (IntCodeC.eq.01010603) Explicit=.FALSE.
    IF (IntCodeC.eq.06010301) Explicit=.FALSE.
    IF (IntCodeC.eq.03010601) Explicit=.FALSE.
!
! L=4 exceptions
!
