...
/* G1 */
    ...
    sprintf(FileName,"%s/ONX/GDrivers/G1.%sx%s.ascii",DriverHome,SB,SK);
    ...
    fclose(InFile);
    sprintf(FileName,"%s/ONX/GDrivers/G1.%sx%s.binary",DriverHome,SB,SK);
    Mode="wb";
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
...
/* G2 */
    ...
    Mode="r";
    sprintf(FileName,"%s/ONX/GDrivers/G2.%sx%s.ascii",DriverHome,SB,SK);
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Could not find the gradient contraction driver. \n");
       exit( EXIT_FAILURE );
    ...
    fclose(InFile);
    sprintf(FileName,"%s/ONX/GDrivers/G2.%sx%s.binary",DriverHome,SB,SK);
    Mode="wb";
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Error trying to create the gradient contraction driver\n");
...
/* G3 */
    ...
    Mode="r";
    sprintf(FileName,"%s/ONX/GDrivers/G3.%sx%s.ascii",DriverHome,SB,SK);
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Could not find the gradient contraction driver. \n");
       exit( EXIT_FAILURE );
    ...
    fclose(InFile);
    sprintf(FileName,"%s/ONX/GDrivers/G3.%sx%s.binary",DriverHome,SB,SK);
    Mode="wb";
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Error trying to create the gradient contraction driver\n");
...
/* G4 */
    ...
    Mode="r";
    sprintf(FileName,"%s/ONX/GDrivers/G4.%sx%s.ascii",DriverHome,SB,SK);
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Could not find the gradient contraction driver. \n");
       exit( EXIT_FAILURE );
    ...
    fclose(InFile);
    sprintf(FileName,"%s/ONX/GDrivers/G4.%sx%s.binary",DriverHome,SB,SK);
    Mode="wb";
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Error trying to create the gradient contraction driver\n");
...
/* G5 */
    ...
    Mode="r";
    sprintf(FileName,"%s/ONX/GDrivers/G5.%sx%s.ascii",DriverHome,SB,SK);
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Could not find the gradient contraction driver. \n");
       exit( EXIT_FAILURE );
    ...
    fclose(InFile);
    sprintf(FileName,"%s/ONX/GDrivers/G5.%sx%s.binary",DriverHome,SB,SK);
    Mode="wb";
    if ((InFile = fopen(FileName,Mode)) == NULL) {
       printf(" %s\n",FileName);
       printf(" Error trying to create the gradient contraction driver\n");
