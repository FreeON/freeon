...
PROGRAM JForce
  ...
  WRITE(*,*)' ClusterSize used in JForce = ',ClusterSize
  WRITE(*,*)' Multipole Expansion used in JForce = ',MaxPoleEll
  ...
  CALL PBCFarFuckingFieldSetUp(GM,Rho,MaxPFFFEll,E_PFF,LatFrc_J)
