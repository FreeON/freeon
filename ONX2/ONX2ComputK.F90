...
!!$if(AtBList%SqrtInt(BDR)*AtAList%SqrtInt(ACR)* &
!!$     & GetAbsD(D%MTrix%D(iPtrD),NBFC,NBFD, &
!!$     & BS%LStrt%I(CFC,KC),BS%LStop%I(CFC,KC), &
!!$     & BS%LStrt%I(CFD,KD),BS%LStop%I(CFD,KD)) &
!!$     & .LE.ThresholdTwoE) goto 9999
