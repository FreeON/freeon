...
![HOMO of N<sub>2</sub>O ](N2O_HOMO.png "fig:HOMO of N2O ") ![LUMO of N<sub>2</sub>O ](N2O_LUMO.png "fig:LUMO of N2O ")

Nitrous oxide
-------------

This example will run an RHF calculation on [Nitrous oxide](http://en.wikipedia.org/wiki/Nitrous_oxide) (HN<sub>2</sub>) using [FreeON](http://freeon.org) ]]
