...
101 CONTINUE
    ...
    ! Print MondoSCF banner and authorship (try figlet to mod)
...
!
    ...
    CALL MondoLogPlain('Matt Challacombe, Nicolas Bock, C.J. Tymczak,        ')
    CALL MondoLogPlain('Karoly Nemeth, Anders Niklasson, Valery Weber,       ')
    CALL MondoLogPlain('Chee Kwan Gan,  Eric Schwegler, and Graeme Henkelman ')
    CALL MondoLogPlain("")
