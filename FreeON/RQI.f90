...
MODULE RayleighQuotientIteration
  ...
  ! 3-21G/RPA/p10
  !  REAL(DOUBLE) :: E_RPA=0.2818477234542058D+01 ! Very Tight
  !  REAL(DOUBLE) :: E_RPA=0.2818477233888569D+01 ! Tight

  ! 3-21G/RPA/p20

  !  REAL(DOUBLE) :: E_RPA=0.2627492448465417D+01 ! VeryTight
  !  REAL(DOUBLE) :: E_RPA=0.2627616552183385D+01  ! Tight
