...
!       -------------------------------- Lp=6, Mp = 0-------------------------------------
        COne=Cpq(21)*Q%C(0)+Cpq(28)*Q%C(1)+Cpq(36)*Q%C(3)+Cpq(45)*Q%C(6)
        W(1)=Cpq(29)*Q%C(2)+Cpq(37)*Q%C(4)+Cpq(38)*Q%C(5)
        W(2)=Cpq(46)*Q%C(7)+Cpq(47)*Q%C(8)+Cpq(48)*Q%C(9)
        W(3)=Spq(29)*Q%S(2)+Spq(37)*Q%S(4)+Spq(38)*Q%S(5)
        W(4)=Spq(46)*Q%S(7)+Spq(47)*Q%S(8)+Spq(48)*Q%S(9)
        CTwo=W(1)+W(2)+W(3)+W(4)
...
!       -------------------------------- Lp=6, Mp = 1-------------------------------------
        ...
        W(3)=Cpq(46)*Q%C(6)+(-Cpq(45)+Cpq(47))*Q%C(7)
        W(4)=(-Cpq(46)+Cpq(48))*Q%C(8)+(-Cpq(47)+Cpq(49))*Q%C(9)
        W(5)=Spq(30)*Q%S(2)+Spq(38)*Q%S(4)
        W(6)=(-Spq(37)+Spq(39))*Q%S(5)+Spq(47)*Q%S(7)
        W(7)=(-Spq(46)+Spq(48))*Q%S(8)+(-Spq(47)+Spq(49))*Q%S(9)
        CTwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
        W(1)=Q%C(0)*Spq(22)+Q%C(1)*Spq(29)+Q%C(2)*Spq(30)+Q%C(3)*Spq(37)
        W(2)=Q%C(4)*Spq(38)+Q%C(5)*(Spq(37)+Spq(39))+Q%C(6)*Spq(46)+Q%C(7)*Spq(47)
        W(3)=Q%C(8)*(Spq(46)+Spq(48))+Q%C(9)*(Spq(47)+Spq(49))
        W(4)=-((Cpq(28)+Cpq(30))*Q%S(2))-(Cpq(36)+Cpq(38))*Q%S(4)
        W(5)=-((Cpq(37)+Cpq(39))*Q%S(5))-(Cpq(45)+Cpq(47))*Q%S(7)
        W(6)=-((Cpq(46)+Cpq(48))*Q%S(8))-(Cpq(47)+Cpq(49))*Q%S(9)
        STwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)
...
!       -------------------------------- Lp=6, Mp = 2-------------------------------------
        ...
        W(3)=Cpq(47)*Q%C(6)+(-Cpq(46)+Cpq(48))*Q%C(7)
        W(4)=(Cpq(45)+Cpq(49))*Q%C(8)+(Cpq(46)+Cpq(50))*Q%C(9)
        W(5)=(Spq(29)+Spq(31))*Q%S(2)+(Spq(37)+Spq(39))*Q%S(4)
        W(6)=Spq(40)*Q%S(5)+(Spq(46)+Spq(48))*Q%S(7)+Spq(49)*Q%S(8)+(Spq(46)+Spq(50))*Q%S(9)
        CTwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)
        W(1)=Q%C(0)*Spq(23)+Q%C(1)*Spq(30)+Q%C(2)*(-Spq(29)+Spq(31))+Q%C(3)*Spq(38)
        W(2)=Q%C(4)*(-Spq(37)+Spq(39))+Q%C(5)*Spq(40)
        W(3)=Q%C(6)*Spq(47)+Q%C(7)*(-Spq(46)+Spq(48))
        W(4)=Q%C(8)*Spq(49)+Q%C(9)*(-Spq(46)+Spq(50))
        W(5)=-((Cpq(29)+Cpq(31))*Q%S(2))-(Cpq(37)+Cpq(39))*Q%S(4)
        W(6)=(Cpq(36)-Cpq(40))*Q%S(5)-(Cpq(46)+Cpq(48))*Q%S(7)
        W(7)=(Cpq(45)-Cpq(49))*Q%S(8)+(Cpq(46)-Cpq(50))*Q%S(9)
        STwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
...
!       -------------------------------- Lp=6, Mp = 3-------------------------------------
        ...
        W(3)=Cpq(48)*Q%C(6)+(-Cpq(47)+Cpq(49))*Q%C(7)
        W(4)=(Cpq(46)+Cpq(50))*Q%C(8)+(-Cpq(45)+Cpq(51))*Q%C(9)
        W(5)=(Spq(30)+Spq(32))*Q%S(2)+(Spq(38)+Spq(40))*Q%S(4)
        W(6)=(-Spq(37)+Spq(41))*Q%S(5)+(Spq(47)+Spq(49))*Q%S(7)
        W(7)=(-Spq(46)+Spq(50))*Q%S(8)+Spq(51)*Q%S(9)
        CTwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
        W(1)=Q%C(0)*Spq(24)+Q%C(1)*Spq(31)+Q%C(2)*(-Spq(30)+Spq(32))+Q%C(3)*Spq(39)
        W(2)=Q%C(4)*(-Spq(38)+Spq(40))+Q%C(5)*(Spq(37)+Spq(41))
        W(3)=Q%C(6)*Spq(48)+Q%C(7)*(-Spq(47)+Spq(49))
        W(4)=Q%C(8)*(Spq(46)+Spq(50))+Q%C(9)*Spq(51)
        W(5)=-((Cpq(30)+Cpq(32))*Q%S(2))-(Cpq(38)+Cpq(40))*Q%S(4)
        W(6)=(Cpq(37)-Cpq(41))*Q%S(5)-(Cpq(47)+Cpq(49))*Q%S(7)
        W(7)=(Cpq(46)-Cpq(50))*Q%S(8)-(Cpq(45)+Cpq(51))*Q%S(9)
        STwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
...
!       -------------------------------- Lp=6, Mp = 4-------------------------------------
        ...
        W(3)=Cpq(49)*Q%C(6)+(-Cpq(48)+Cpq(50))*Q%C(7)
        W(4)=(Cpq(47)+Cpq(51))*Q%C(8)+(-Cpq(46)+Cpq(52))*Q%C(9)
        W(5)=(Spq(31)+Spq(33))*Q%S(2)+(Spq(39)+Spq(41))*Q%S(4)
        W(6)=(-Spq(38)+Spq(42))*Q%S(5)+(Spq(48)+Spq(50))*Q%S(7)
        W(7)=(-Spq(47)+Spq(51))*Q%S(8)+(Spq(46)+Spq(52))*Q%S(9)
        CTwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
        W(1)=Q%C(0)*Spq(25)+Q%C(1)*Spq(32)+Q%C(2)*(-Spq(31)+Spq(33))+Q%C(3)*Spq(40)
        W(2)=Q%C(4)*(-Spq(39)+Spq(41))+Q%C(5)*(Spq(38)+Spq(42))
        W(3)=Q%C(6)*Spq(49)+Q%C(7)*(-Spq(48)+Spq(50))
        W(4)=Q%C(8)*(Spq(47)+Spq(51))+Q%C(9)*(-Spq(46)+Spq(52))
        W(5)=-((Cpq(31)+Cpq(33))*Q%S(2))-(Cpq(39)+Cpq(41))*Q%S(4)
        W(6)=(Cpq(38)-Cpq(42))*Q%S(5)-(Cpq(48)+Cpq(50))*Q%S(7)
        W(7)=(Cpq(47)-Cpq(51))*Q%S(8)-(Cpq(46)+Cpq(52))*Q%S(9)
        STwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
...
!       -------------------------------- Lp=6, Mp = 5-------------------------------------
        ...
        W(3)=Cpq(50)*Q%C(6)+(-Cpq(49)+Cpq(51))*Q%C(7)
        W(4)=(Cpq(48)+Cpq(52))*Q%C(8)+(-Cpq(47)+Cpq(53))*Q%C(9)
        W(5)=(Spq(32)+Spq(34))*Q%S(2)+(Spq(40)+Spq(42))*Q%S(4)
        W(6)=(-Spq(39)+Spq(43))*Q%S(5)+(Spq(49)+Spq(51))*Q%S(7)
        W(7)=(-Spq(48)+Spq(52))*Q%S(8)+(Spq(47)+Spq(53))*Q%S(9)
        CTwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
        W(1)=Q%C(0)*Spq(26)+Q%C(1)*Spq(33)+Q%C(2)*(-Spq(32)+Spq(34))+Q%C(3)*Spq(41)
        W(2)=Q%C(4)*(-Spq(40)+Spq(42))+Q%C(5)*(Spq(39)+Spq(43))
        W(3)=Q%C(6)*Spq(50)+Q%C(7)*(-Spq(49)+Spq(51))
        W(4)=Q%C(8)*(Spq(48)+Spq(52))+Q%C(9)*(-Spq(47)+Spq(53))
        W(5)=-((Cpq(32)+Cpq(34))*Q%S(2))-(Cpq(40)+Cpq(42))*Q%S(4)
        W(6)=(Cpq(39)-Cpq(43))*Q%S(5)-(Cpq(49)+Cpq(51))*Q%S(7)
        W(7)=(Cpq(48)-Cpq(52))*Q%S(8)-(Cpq(47)+Cpq(53))*Q%S(9)
        STwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
...
!       -------------------------------- Lp=6, Mp = 6-------------------------------------
        ...
        W(3)=Cpq(51)*Q%C(6)+(-Cpq(50)+Cpq(52))*Q%C(7)
        W(4)=(Cpq(49)+Cpq(53))*Q%C(8)+(-Cpq(48)+Cpq(54))*Q%C(9)
        W(5)=(Spq(33)+Spq(35))*Q%S(2)+(Spq(41)+Spq(43))*Q%S(4)
        W(6)=(-Spq(40)+Spq(44))*Q%S(5)+(Spq(50)+Spq(52))*Q%S(7)
        W(7)=(-Spq(49)+Spq(53))*Q%S(8)+(Spq(48)+Spq(54))*Q%S(9)
        CTwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
        W(1)=Q%C(0)*Spq(27)+Q%C(1)*Spq(34)+Q%C(2)*(-Spq(33)+Spq(35))+Q%C(3)*Spq(42)
        W(2)=Q%C(4)*(-Spq(41)+Spq(43))+Q%C(5)*(Spq(40)+Spq(44))
        W(3)=Q%C(6)*Spq(51)+Q%C(7)*(-Spq(50)+Spq(52))
        W(4)=Q%C(8)*(Spq(49)+Spq(53))+Q%C(9)*(-Spq(48)+Spq(54))
        W(5)=-((Cpq(33)+Cpq(35))*Q%S(2))-(Cpq(41)+Cpq(43))*Q%S(4)
        W(6)=(Cpq(40)-Cpq(44))*Q%S(5)-(Cpq(50)+Cpq(52))*Q%S(7)
        W(7)=(Cpq(49)-Cpq(53))*Q%S(8)-(Cpq(48)+Cpq(54))*Q%S(9)
        STwo=W(1)+W(2)+W(3)+W(4)+W(5)+W(6)+W(7)
        SPKetC(27)=SPKetC(27)+CTwo*Two
        SPKetS(27)=SPKetS(27)+STwo*Two
      END SUBROUTINE CTraX603
