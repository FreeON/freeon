---
layout: default
title: Restricted-O2.inp
---

![This example will run an RHF calculation on the O<sub>2</sub> molecule using [FreeON](http://freeon.org) ](O2.png "This example will run an RHF calculation on the O2 molecule using FreeON ")

Molecular Oxygen (O<sub>2</sub>)
--------------------------------

This example runs a calculation on molecular [Oxygen](http://en.wikipedia.org/wiki/Oxygen) using [FreeON](http://freeon.org) ]]
